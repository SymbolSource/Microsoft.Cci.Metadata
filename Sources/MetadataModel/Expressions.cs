...
namespace Microsoft.Cci
{
	...
	public interface IMetadataCreateArray : IMetadataExpression
	{
		...
		/// </summary>
		IEnumerable<IMetadataExpression> Initializers { get; }
	...
	public abstract class IMetadataNamedArgumentContract : IMetadataNamedArgument
	{
		...
		public object ResolvedDefinition {
			get {
				Contract.Ensures(Contract.Result<object>() == null || (this.IsField && Contract.Result<object>() is IFieldDefinition) || (!this.IsField && Contract.Result<object>() is IPropertyDefinition));
				throw new NotImplementedException();
			}
		}
