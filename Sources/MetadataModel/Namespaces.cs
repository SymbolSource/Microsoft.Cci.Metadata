...
namespace Microsoft.Cci
{
	...
	public abstract class INamespaceMemberContract : INamespaceMember
	{
	...
	public interface INamespaceRootOwner
	{
		...
		/// </summary>
		INamespaceDefinition NamespaceRoot { get; }
		//^ ensures result.RootOwner == this;
	}

	[ContractClassFor(typeof(INamespaceRootOwner))]
	public abstract class INamespaceRootOwnerContract : INamespaceRootOwner
	{
	...
	public abstract class INestedUnitNamespaceContract : INestedUnitNamespace
	{
	...
	public abstract class INestedUnitNamespaceReferenceContract : INestedUnitNamespaceReference
	{
	...
	public abstract class INestedUnitSetNamespaceContract : INestedUnitSetNamespace
	{
	...
	public interface INamespaceDefinition : IContainer<INamespaceMember>, IDefinition, INamedEntity, IScope<INamespaceMember>
	{
		...
		/// </summary>
		INamespaceRootOwner RootOwner { get; }

		/// <summary>
		/// The collection of member objects comprising the namespaces.
		/// </summary>
		new IEnumerable<INamespaceMember> Members { get; }
	}

	[ContractClassFor(typeof(INamespaceDefinition))]
	public abstract class INamespaceDefinitionContract : INamespaceDefinition
	{
		public INamespaceRootOwner RootOwner {
			get {
	...
	public abstract class IUnitNamespaceContract : IUnitNamespace
	{
		public IUnit Unit {
			get {
	...
	public abstract class IUnitNamespaceReferenceContract : IUnitNamespaceReference
	{
		public IUnitReference Unit {
			get {
	...
	public abstract class IUnitSetNamespaceContract : IUnitSetNamespace
	{
		public IUnitSet UnitSet {
			get {
