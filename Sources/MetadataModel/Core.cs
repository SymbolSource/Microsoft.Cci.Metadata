...
namespace Microsoft.Cci
{
	...
	/// </summary>
	unsafe public interface IBinaryDocumentMemoryBlock
	{
		/// <summary>
	...
	public interface IMetadataHost
	{
		...
		/// </summary>
		IEnumerable<IUnit> LoadedUnits { get; }
	...
	public abstract class IMetadataHostContract : IMetadataHost
	{
	...
	public interface IContainer<MemberType> where MemberType : class
	{
		/// <summary>
	...
	public abstract class IContainerContract<MemberType> : IContainer<MemberType> where MemberType : class
	{
	...
	public abstract class IContainerMemberContract<ContainerType> : IContainerMember<ContainerType>
	{
	...
	public abstract class IReferenceContract : IReference
	{
	...
	public interface IScope<MemberType> where MemberType : class, INamedEntity
	{
	...
	public abstract class ISCopeContract<MemberType> : IScope<MemberType> where MemberType : class, INamedEntity
	{
		...
		public IEnumerable<MemberType> GetMatchingMembersNamed(IName name, bool ignoreCase, Function<MemberType, bool> predicate)
		{
			...
			Contract.Ensures(Contract.ForAll(Contract.Result<IEnumerable<MemberType>>(), x => ignoreCase ? x.Name.UniqueKeyIgnoringCase == x.Name.UniqueKeyIgnoringCase : x.Name == name));
	...
	public abstract class IObjectWithLocationsContract : IObjectWithLocations
	{
		public IEnumerable<ILocation> Locations {
			get {
	...
	public abstract class IInternFactoryContract : IInternFactory
	{
