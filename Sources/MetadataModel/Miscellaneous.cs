...
namespace Microsoft.Cci
{
	...
	public static class Enumerable<T>
	{
		...
		public sealed class EmptyEnumerable : IEnumerable<T>, IEnumerator<T>
		{
	...
	public static class IteratorHelper
	{
		...
		public static IEnumerable<T> GetReadonly<T>(		/*?*/			/*?*/T[] array		)
		{
			...
			if (array == null)
				return null;
			if (array.Length == 1)
				return IteratorHelper.GetSingletonEnumerable(array[0]);
			return new ReaonlyOnlyArrayWrapper<T>(array);
		}

		public sealed class ReaonlyOnlyArrayWrapper<T> : ICollection<T>
		{

			public ReaonlyOnlyArrayWrapper(T[] array)
			{
				this.array = array;
			}
		...
		/// </summary>
		/// <returns></returns>
		public static IEnumerable<TargetType> GetFilterEnumerable<SourceType, TargetType>(IEnumerable<SourceType> sourceEnumeration) where SourceType : class where TargetType : class
		{
			foreach (SourceType s in sourceEnumeration) {
		...
		{
			if (enumerable == null || enumerable == Enumerable<T>.Empty)
				return false;
			var collection = enumerable as ICollection<T>;
			if (collection != null)
		...
		public static bool EnumerableContains<T>(IEnumerable<T> enumerable		, T element) where T : class
		{
			if (enumerable == null)
				return false;
			...
			/*?*/		public static bool EnumerableHasLength<T>(IEnumerable<T> enumerable		, ulong length)
		{
			...
			var collection = enumerable as ICollection<T>;
			if (collection != null)
				return length == (ulong)collection.Count;
			IEnumerator<T> enumerator = enumerable.GetEnumerator();
			while (length > 0) {
	...
	public interface ICustomAttribute
	{
		...
		/// </summary>
		ushort NumberOfNamedArguments { get; }
	...
	public interface IResource : IResourceReference
	{
		...
		/// </summary>
		IFileReference ExternalFile { get; }
	...
	public abstract class IResourceReferenceContract : IResourceReference
	{
	...
	public interface IMarshallingInformation
	{
		...
		/// </summary>
		ITypeReference CustomMarshaller { get; }
		...
		/// </summary>
		System.Runtime.InteropServices.VarEnum SafeArrayElementSubtype { get; }
		...
		/// </summary>
		ITypeReference SafeArrayElementUserDefinedSubtype { get; }
		//^ requires this.UnmanagedType == System.Runtime.InteropServices.UnmanagedType.SafeArray;
	...
	public abstract class INamedEntityContract : INamedEntity
	{
		public IName Name {
			get {
				Contract.Ensures(Contract.Result<IName>() != null);
	...
	public abstract class INameTableContract : INameTable
	{
	...
	public abstract class IPlatformInvokeInformationContract : IPlatformInvokeInformation
	{
	...
	public abstract class IPESectionContract : IPESection
	{
	...
	public enum PESectionCharacteristics
	{
		...
		/// </summary>
		IsWritable = unchecked((int)0x80000000u)
	}
