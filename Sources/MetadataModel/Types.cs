...
namespace Microsoft.Cci
{
	...
	public interface IAliasForType : IContainer<IAliasMember>, IDefinition, IScope<IAliasMember>
	{
		...
		/// </summary>
		new IEnumerable<IAliasMember> Members { get; }
		//TODO: this seems to actually be a collection of INestedAliasForType objects.
	}

	[ContractClassFor(typeof(IAliasForType))]
	public abstract class IAliasForTypeContract : IAliasForType
	{
	...
	{
		//TODO: expose element type custom modifiers
		/// <summary>
		...
		/// </summary>
		IEnumerable<ulong> Sizes { get; }
		// ^ ensures count(result) <= Rank;

	}

	[ContractClassFor(typeof(IArrayTypeReference))]
	public abstract class IArrayTypeReferenceContract : IArrayTypeReference
	{
	...
	public abstract class IParameterTypeInformationContract : IParameterTypeInformation
	{
	...
	public abstract class IFunctionPointerTypeReferenceContract : IFunctionPointerTypeReference
	{
	...
	public abstract class IGenericParameterContract : IGenericParameter
	{
	...
	public abstract class IGenericMethodParameterContract : IGenericMethodParameter
	{
	...
	public abstract class IGenericMethodParameterReferenceContract : IGenericMethodParameterReference
	{
	...
	public interface IGenericTypeInstanceReference : ITypeReference
	{
		...
		/// </summary>
		IEnumerable<ITypeReference> GenericArguments { get; }
		...
		/// </summary>
		INamedTypeReference GenericType { get; }
	...
	public abstract class IGenericTypeInstanceReferenceContract : IGenericTypeInstanceReference
	{
	...
	public abstract class IGenericTypeParameterReferenceContract : IGenericTypeParameterReference
	{
	...
	public interface INamedTypeReference : ITypeReference, INamedEntity
	{
		...
		/// </summary>
		new INamedTypeDefinition ResolvedType { get; }
	...
	public abstract class INamespaceTypeDefinitionContract : INamespaceTypeDefinition
	{
	...
	public abstract class INamespaceTypeReferenceContract : INamespaceTypeReference
	{
	...
	public abstract class INestedTypeReferenceContract : INestedTypeReference
	{
		public ushort GenericParameterCount {
			get {
				throw new NotImplementedException();
	...
	public interface ISpecializedNestedTypeDefinition : INestedTypeDefinition, ISpecializedNestedTypeReference
	{
		...
		/// </summary>
		new INestedTypeDefinition UnspecializedVersion { get; }
			/*!*/
			}
	...
	public interface ISpecializedNestedTypeReference : INestedTypeReference
	{
		...
		/// corresponds to a definition that is not obtained via specialization.)
		/// </summary>
		INestedTypeReference UnspecializedVersion { get; }

	}

	[ContractClassFor(typeof(ISpecializedNestedTypeReference))]
	public abstract class ISpecializedNestedTypeReferenceContract : ISpecializedNestedTypeReference
	{
	...
	public abstract class IMethodImplementationContract : IMethodImplementation
	{
	...
	public abstract class IModifiedTypeReferenceContract : IModifiedTypeReference
	{
		public IEnumerable<ICustomModifier> CustomModifiers {
			get {
				Contract.Ensures(Contract.Result<IEnumerable<ICustomModifier>>() != null);
	...
	public abstract class IPlatformTypeContract : IPlatformType
	{
	...
	public abstract class IPointerTypeReferenceContract : IPointerTypeReference
	{
	...
	public abstract class IManagedPointerTypeReferenceContract : IManagedPointerTypeReference
	{
		public ITypeReference TargetType {
			get {
				Contract.Ensures(Contract.Result<ITypeReference>() != null);
	...
	public interface ITypeDefinition : IContainer<ITypeDefinitionMember>, IDefinition, IScope<ITypeDefinitionMember>, ITypeReference
	{
		...
		/// </summary>
		IEnumerable<ITypeReference> BaseClasses { get; }
		...
		/// </summary>
		IGenericTypeInstanceReference InstanceType { get; }
		//^ requires this.IsGeneric;
		...
		/// </summary>
		new IEnumerable<ITypeDefinitionMember> Members { get; }
		...
		/// </summary>
		ITypeReference UnderlyingType { get; }
		//^ requires this.IsEnum;

	}

	[ContractClassFor(typeof(ITypeDefinition))]
	public abstract class ITypeDefinitionContract : ITypeDefinition
	{
		public ushort Alignment {
			get {
				throw new NotImplementedException();
	...
	public abstract class ITypeReferenceContract : ITypeReference
	{
