...
namespace Microsoft.Cci
{
	...
	public interface IAssembly : IModule, IAssemblyReference
	{
		...
		//TODO: shouldn't these be just namespace type aliases?
	...
	public abstract class IAssemblyContract : IAssembly
	{
	...
	public abstract class IAssemblyReferenceContract : IAssemblyReference
	{
		public IEnumerable<IName> Aliases {
			get {
	...
	public abstract class IModuleContract : IModule
	{
	...
	public abstract class IUnitContract : IUnit
	{
		public AssemblyIdentity ContractAssemblySymbolicIdentity {
			get {
				Contract.Ensures(Contract.Result<AssemblyIdentity>() != null);
	...
	public abstract class IUnitReferenceContract : IUnitReference
	{
		#region IUnitReference Members
	...
	public interface IUnitSet : INamespaceRootOwner
	{
		...
		/// </summary>
		IUnitSetNamespace UnitSetNamespaceRoot { get; }
	...
	public abstract class UnitIdentity
	{
		...
		public UnitIdentity(IName name, string location)
		{
	...
	public sealed class AssemblyIdentity : ModuleIdentity
	{
		...
		public AssemblyIdentity(IName name, string culture, Version version, IEnumerable<byte> publicKeyToken, string location) : base(name, location)
		{
			Contract.Requires(name != null);
		...
		public AssemblyIdentity(AssemblyIdentity template, string location) : base(template.Name, location)
		{
		...
		/// </summary>
		public override sealed int ComputeHashCode()
		{
	...
	public class ModuleIdentity : UnitIdentity
	{
		...
		public ModuleIdentity(IName name, string location) : base(name, location)
		{
			Contract.Requires(name != null);
			Contract.Requires(location != null);
		}
		...
		/// <param name="containingAssembly">The identifier of the assembly to which the identified module belongs. May be null.</param>
			/*?*/		public ModuleIdentity(IName name, string location, AssemblyIdentity containingAssembly		) : base(name, location)
		{
			Contract.Requires(name != null);
			Contract.Requires(location != null);
		...
		public override int ComputeHashCode()
		{
			int hash = this.Name.UniqueKeyIgnoringCase;
			if (this.ContainingAssembly != null)
				hash = (hash << 4) ^ this.ContainingAssembly.GetHashCode(); else if (this.Location.Length > 0)
