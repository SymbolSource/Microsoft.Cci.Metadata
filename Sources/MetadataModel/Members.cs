...
namespace Microsoft.Cci
{
	...
	public interface IFieldDefinition : ITypeDefinitionMember, IFieldReference, IMetadataConstantContainer
	{
		...
		/// </summary>
		ISectionBlock FieldMapping { get; }
	...
	public abstract class IFieldDefinitionContract : IFieldDefinition
	{
	...
	public abstract class IFieldReferenceContract : IFieldReference
	{
		public IEnumerable<ICustomModifier> CustomModifiers {
			get {
	...
	public abstract class IOperationExceptionInformationContract : IOperationExceptionInformation
	{
	...
	public abstract class ILocalDefinitionContract : ILocalDefinition
	{
		public IMetadataConstant CompileTimeValue {
			get {
	...
	public abstract class IMethodBodyContract : IMethodBody
	{
	...
	public abstract class IMethodDefinitionContract : IMethodDefinition
	{
	...
	public interface IParameterDefinition : IDefinition, INamedEntity, IParameterTypeInformation, IMetadataConstantContainer
	{
		...
		/// </summary>
		ITypeReference ParamArrayElementType { get; }
	...
	public abstract class IPropertyDefinitionContract : IPropertyDefinition
	{
	...
	public interface ISignature
	{
		...
		/// </summary>
		IEnumerable<ICustomModifier> ReturnValueCustomModifiers { get; }
	...
	public abstract class ISignatureContract : ISignature
	{
		public CallingConvention CallingConvention {
			get {
				throw new NotImplementedException();
	...
	public abstract class ITypeDefinitionMemberContract : ITypeDefinitionMember
	{
		public ITypeDefinition ContainingTypeDefinition {
			get {
	...
	public abstract class ITypeMemberReferenceContract : ITypeMemberReference
	{
		public ITypeReference ContainingType {
			get {
				Contract.Ensures(Contract.Result<ITypeReference>() != null);
	...
	public interface ISpecializedFieldDefinition : IFieldDefinition, ISpecializedFieldReference
	{
		...
		/// corresponds to a definition that is not obtained via specialization.)
		/// </summary>
		new IFieldDefinition UnspecializedVersion { get; }
			/*!*/
			}
	...
	public abstract class ISpecializedFieldReferenceContract : ISpecializedFieldReference
	{
	...
	public interface ISpecializedMethodDefinition : IMethodDefinition, ISpecializedMethodReference
	{
		...
		/// corresponds to a definition that is not obtained via specialization.)
		/// </summary>
		new IMethodDefinition UnspecializedVersion { get; }
			/*!*/
			}

	#region ISpecializedMethodDefinition contract binding
	[ContractClassFor(typeof(ISpecializedMethodDefinition))]
	public abstract class ISpecializedMethodDefinitionContract : ISpecializedMethodDefinition
	{
	...
	public interface IMethodReference : ISignature, ITypeMemberReference
	{
		...
		/// </summary>
		IMethodDefinition ResolvedMethod { get; }
	...
	public abstract class IMethodReferenceContract : IMethodReference
	{
		public bool AcceptsExtraArguments {
			get {
				throw new NotImplementedException();
	...
	public abstract class IGenericMethodInstanceReferenceContract : IGenericMethodInstanceReference
	{
