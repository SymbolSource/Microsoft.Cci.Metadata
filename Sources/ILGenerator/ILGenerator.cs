...
namespace Microsoft.Cci
{
	...
	public sealed class ILGenerator
	{
			...
			/*?*/		public void AddExceptionHandlerInformation(HandlerKind kind, ITypeReference exceptionType, ILGeneratorLabel tryStart, ILGeneratorLabel tryEnd, ILGeneratorLabel handlerStart, ILGeneratorLabel handlerEnd, ILGeneratorLabel filterStart		)
		{
			var handler = new ExceptionHandler {
				...
				FilterDecisionStart = filterStart
			};
				...
				for (int i = 0, n = this.operations.Count; i < n; i++) {
					...
					if (label != null) {
						...
						if (shortOffsetOk) {
							...
							//A short branch was specified for an offset that is long.
		...
		//^ requires InTryBody;
		public ExceptionHandler BeginHandler(HandlerKind kind)
		{
			ILGeneratorLabel handlerStart = new ILGeneratorLabel(false);
			this.MarkLabel(handlerStart);
			...
			if (currentTryBody.end == null)
				currentTryBody.end = handlerStart; else if (this.handlers.Count > 0) {
		...
		public void Emit(OperationCode opcode, object value)
		{
			switch (System.Convert.GetTypeCode(value)) {
				case TypeCode.Byte:
					this.Emit(opcode, (byte)value);
					break;
				case TypeCode.Double:
					this.Emit(opcode, (double)value);
					break;
				case TypeCode.Single:
					this.Emit(opcode, (float)value);
					break;
				case TypeCode.Int32:
					this.Emit(opcode, (int)value);
					break;
				case TypeCode.Int64:
					this.Emit(opcode, (long)value);
					break;
				case TypeCode.SByte:
					this.Emit(opcode, (sbyte)value);
					break;
				case TypeCode.Int16:
					this.Emit(opcode, (short)value);
					break;
				case TypeCode.String:
					this.Emit(opcode, (string)value);
					break;
				case TypeCode.Empty:
					this.Emit(opcode);
					break;
		...
		public void Emit(OperationCode opcode, ILocalDefinition local)
		{
			...
			if (opcode == OperationCode.Ldloc_S || opcode == OperationCode.Ldloca_S || opcode == OperationCode.Stloc_S)
				this.offset += 1; else if (opcode == OperationCode.Ldloc || opcode == OperationCode.Ldloca || opcode == OperationCode.Stloc)
				this.offset += 2;
		}
		...
		public void Emit(OperationCode opcode, IParameterDefinition parameter)
		{
			...
			if (opcode == OperationCode.Ldarg_S || opcode == OperationCode.Ldarga_S || opcode == OperationCode.Starg_S)
				this.offset += 1; else if (opcode == OperationCode.Ldarg || opcode == OperationCode.Ldarga || opcode == OperationCode.Starg)
				this.offset += 2;
		}
		...
		public ILocation GetCurrentSequencePoint()
		{
		...
		public static OperationCode LongVersionOf(OperationCode operationCode)
		{
			switch (operationCode) {
				...
				case OperationCode.Bge_S:
					return OperationCode.Bge;
				case OperationCode.Bge_Un_S:
					return OperationCode.Bge_Un;
				case OperationCode.Bgt_S:
					return OperationCode.Bgt;
				case OperationCode.Bgt_Un_S:
					return OperationCode.Bgt_Un;
				case OperationCode.Ble_S:
					return OperationCode.Ble;
				case OperationCode.Ble_Un_S:
					return OperationCode.Ble_Un;
				case OperationCode.Blt_S:
					return OperationCode.Blt;
				case OperationCode.Blt_Un_S:
					return OperationCode.Blt_Un;
				case OperationCode.Bne_Un_S:
					return OperationCode.Bne_Un;
				case OperationCode.Br_S:
					return OperationCode.Br;
				case OperationCode.Brfalse_S:
					return OperationCode.Brfalse;
				case OperationCode.Brtrue_S:
					return OperationCode.Brtrue;
				case OperationCode.Leave_S:
					return OperationCode.Leave;
				default:
		...
		public static OperationCode ShortVersionOf(OperationCode operationCode)
		{
			switch (operationCode) {
				case OperationCode.Beq:
					return OperationCode.Beq_S;
				case OperationCode.Bge:
					return OperationCode.Bge_S;
				case OperationCode.Bge_Un:
					return OperationCode.Bge_Un_S;
				case OperationCode.Bgt:
					return OperationCode.Bgt_S;
				case OperationCode.Bgt_Un:
					return OperationCode.Bgt_Un_S;
				case OperationCode.Ble:
					return OperationCode.Ble_S;
				case OperationCode.Ble_Un:
					return OperationCode.Ble_Un_S;
				case OperationCode.Blt:
					return OperationCode.Blt_S;
				case OperationCode.Blt_Un:
					return OperationCode.Blt_Un_S;
				case OperationCode.Bne_Un:
					return OperationCode.Bne_Un_S;
				case OperationCode.Br:
					return OperationCode.Br_S;
				case OperationCode.Brfalse:
					return OperationCode.Brfalse_S;
				case OperationCode.Brtrue:
					return OperationCode.Brtrue_S;
				case OperationCode.Leave:
					return OperationCode.Leave_S;
				default:
					return operationCode;
			}
		}

		public static uint SizeOfOffset(OperationCode opcode)
		{
			switch (opcode) {
				case OperationCode.Beq_S:
				case OperationCode.Bge_S:
		...
		public static uint SizeOfOperationCode(OperationCode opcode)
		{
			if (((int)opcode) > 0xff && (opcode < OperationCode.Array_Create))
				return 2;
			return 1;
		}
		...
		public class LocalScopeProvider : ILocalScopeProvider
		{
			...
			public IEnumerable<ILocalScope> GetIteratorScopes(IMethodBody methodBody)
			{
				...
				if (sourceMethodBody == null)
					return this.originalLocalScopeProvider.GetIteratorScopes(methodBody);
			...
			public IEnumerable<ILocalScope> GetLocalScopes(IMethodBody methodBody)
			{
				var sourceMethodBody = methodBody as ILGeneratorMethodBody;
				if (sourceMethodBody == null)
					return this.originalLocalScopeProvider.GetLocalScopes(methodBody);
			...
			public IEnumerable<INamespaceScope> GetNamespaceScopes(IMethodBody methodBody)
			{
				var sourceMethodBody = methodBody as ILGeneratorMethodBody;
				if (sourceMethodBody == null)
					return this.originalLocalScopeProvider.GetNamespaceScopes(methodBody);
			...
			public bool IsIterator(IMethodBody methodBody)
			{
				var sourceMethodBody = methodBody as ILGeneratorMethodBody;
				if (sourceMethodBody == null)
					return this.originalLocalScopeProvider.IsIterator(methodBody);
				return false;
			}
	...
	public class TryBody
	{
		...
		public TryBody(ILGeneratorLabel start)
		{
			this.start = start;
		}

		public readonly ILGeneratorLabel start;
		public ILGeneratorLabel 		/*?*/end;
	}

	public class ExceptionHandler : IOperationExceptionInformation
	{
		...
		public ExceptionHandler(HandlerKind kind, TryBody tryBlock, ILGeneratorLabel handlerStart)
		{
		...
		public ILGeneratorLabel 		/*?*/TryStart;
		public ILGeneratorLabel 		/*?*/TryEnd;
		public ILGeneratorLabel HandlerEnd;
		public ILGeneratorLabel HandlerStart;
		public ILGeneratorLabel 		/*?*/FilterDecisionStart;
		TryBody 		/*?*/tryBlock;
		...
		uint IOperationExceptionInformation.FilterDecisionStartOffset {
			get {
				if (this.FilterDecisionStart == null)
					return 0;
	...
	public sealed class ILGeneratorLabel
	{
		...
		public ILGeneratorLabel(bool mayAlias)
		{
		...
		/// </summary>
		public ILocation 		/*?*/locationOfReturnInstruction;
	}
	...
	public class ILGeneratorScope : ILocalScope, INamespaceScope
	{
		...
		public ILGeneratorScope(ILGeneratorLabel startLabel, INameTable nameTable, IMethodDefinition containingMethod)
		{
		...
		public void CloseScope(ILGeneratorLabel endLabel)
		{
		...
		public readonly List<ILocalDefinition> constants = new List<ILocalDefinition>();
		...
		public readonly List<ILocalDefinition> locals = new List<ILocalDefinition>();
		...
		public readonly List<string> usedNamespaces = new List<string>(0);
	...
	public class Operation : IOperation
	{
			...
			/*?*/		public Operation(OperationCode operationCode, uint offset, ILocation location, object value		)
		{
	...
	/// </summary>
	public class UsedNamespace : IUsedNamespace
	{
		...
		public UsedNamespace(IName namespaceName)
		{
