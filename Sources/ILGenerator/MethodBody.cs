...
namespace Microsoft.Cci
{
	...
	public class ILGeneratorMethodBody : IMethodBody
	{
		...
		public ILGeneratorMethodBody(ILGenerator generator, bool localsAreZeroed, ushort maxStack, IMethodDefinition methodDefinition, IEnumerable<ILocalDefinition> localVariables, IEnumerable<ITypeDefinition> privateHelperTypes)
		{
	...
	public class ILGeneratorSourceInformationProvider : ILocalScopeProvider, ISourceLocationProvider
	{
		...
		public virtual string GetSourceNameFor(ILocalDefinition localDefinition, out bool isCompilerGenerated)
		{
			...
			if (generatorLocal != null)
				isCompilerGenerated = generatorLocal.IsCompilerGenerated;
