...
namespace Microsoft.Cci
{
	...
	public class ControlFlowInferencer<BasicBlock, Instruction> where BasicBlock : Microsoft.Cci.BasicBlock<Instruction>, new() where Instruction : Microsoft.Cci.Instruction, new()
	{
		...
		public ControlFlowInferencer(IMetadataHost host, IMethodBody methodBody, ILocalScopeProvider localScopeProvider = 		/*?*/null)
		{
		...
		/// 
		/// </summary>
		public static ControlAndDataFlowGraph<BasicBlock, Instruction> SetupControlFlow(IMetadataHost host, IMethodBody methodBody, ILocalScopeProvider localScopeProvider = 		/*?*/null)
		{
			Contract.Requires(host != null);
			Contract.Requires(methodBody != null);
		...
		public ControlAndDataFlowGraph<BasicBlock, Instruction> CreateBlocksAndEdges()
		{
			Contract.Ensures(Contract.Result<ControlAndDataFlowGraph<BasicBlock, Instruction>>() != null);
		...
		public void CreateBlocksForLocalScopes()
		{
		...
		public void CreateBlocksForBranchTargetsAndFallthroughs()
		{
		...
		public void CreateBlocksForExceptionHandlers()
		{
		...
		public BasicBlock CreateBlock(uint targetAddress)
		{
		...
		public void CreateEdges(BasicBlock currentBlock)
		{
			...
			foreach (var ilOperation in this.methodBody.Operations) {
				Contract.Assume(ilOperation != null);
				//This is formally specified in the Metadata model, but the checker does not yet understand it well enough to prove this.
				Contract.Assume(startingInstruction <= instructions.Count);
				//due to the limitations of the contract language and checker
				Contract.Assume(startingEdge <= edges.Count);
				//due to the limitations of the contract language and checker
		...
		public static void AddToSuccessorListIfNotAlreadyInIt(List<BasicBlock> edges, int startingEdge, BasicBlock target)
		{
		...
		public Instruction GetInstruction(IOperation ilOperation, List<BasicBlock> edges, out bool isUnconditionalTransfer)
		{
		...
		public void AddEdgesForSwitch(IOperation ilOperation, List<BasicBlock> edges, Instruction instruction)
		{
			Contract.Requires(ilOperation != null);
