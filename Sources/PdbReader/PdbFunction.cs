...
namespace Microsoft.Cci.Pdb
{
	...
	{
		public static readonly Guid msilMetaData = new Guid(0xc6ea3fc9u, 0x59b3, 0x49d6, 0xbc, 0x25, 0x9, 0x2, 0xbb, 0xab, 0xb4,
		0x60);
		...
		public static PdbFunction[] LoadManagedFunctions(		/*string module,*/BitAccess bits, uint limit, bool readStrings)
		{
		...
		public PdbFunction(		/*string module, */ManProcSym proc, BitAccess bits)
		{
			...
			public int Compare(Object x, Object y)
			{
				...
				if (fx.segment < fy.segment) {
					...
					if (fx.token < fy.token)
						return -1; else if (fx.token > fy.token)
						return 1;
					else
						return 0;
				}
