...
namespace Microsoft.Cci
{
	...
	public sealed class AggregatingSourceLocationProvider : ISourceLocationProvider, IDisposable
	{
		...
		public ISourceLocationProvider GetProvider(		/*?*/			/*?*/IILLocation mbLocation		)
		{
			if (mbLocation == null)
				return null;
		...
		public ISourceLocationProvider GetProvider(		/*?*/ILocalDefinition localDefinition)
		{
			return this.GetProvider(localDefinition.MethodDefinition);
		}

			/*?*/		public IEnumerable<IPrimarySourceLocation>		 MapLocationToSourceLocations(ILocation location)
		{
	...
	public sealed class AggregatingLocalScopeProvider : ILocalScopeProvider, IDisposable
	{
		...
		public ILocalScopeProvider GetProvider(		/*?*/			/*?*/IILLocation mbLocation		)
		{
			if (mbLocation == null)
				return null;
			return this.GetProvider(mbLocation.MethodDefinition);
		...
		public ILocalScopeProvider GetProvider(		/*?*/ILocalDefinition localDefinition)
		{
			return this.GetProvider(localDefinition.MethodDefinition);
		}
