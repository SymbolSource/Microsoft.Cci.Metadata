...
namespace Microsoft.Cci
{
	...
	public interface IDerivedSourceLocation : ISourceLocation
	{
		...
		/// </summary>
		IDerivedSourceDocument DerivedSourceDocument { get; }
	...
	public interface IEditDescriptor
	{
		...
		/// </summary>
		IDefinition AffectedDefinition { get; }
		...
		/// </summary>
		ISourceDocument ModifiedSourceDocument { get; }
		...
		/// </summary>
		IDefinition OriginalParent { get; }
	...
	public interface IPrimarySourceLocation : ISourceLocation
	{
		...
		/// </summary>
		IPrimarySourceDocument PrimarySourceDocument { get; }
	...
	public interface ISourceDocumentEdit
	{
		...
		/// </summary>
		ISourceDocument SourceDocumentAfterEdit { get; }
	...
	public interface ISourceLocation : ILocation
	{
		...
		/// The document containing the source text of which this location is a subrange.
		/// </summary>
		ISourceDocument SourceDocument { get; }
	...
	public abstract class ILocalScopeProviderContract : ILocalScopeProvider
	{
