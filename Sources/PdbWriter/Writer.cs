...
namespace Microsoft.Cci
{
	...
	public sealed class PdbWriter : IUnmanagedPdbWriter
	{
		...
		unsafe public void DefineCustomMetadata(string name, byte[] metadata)
		{
		...
		/// </summary>
		public void DefineSequencePointsForCurrentDocument()
		{
		...
		public ISymUnmanagedDocumentWriter GetDocumentWriterFor(IPrimarySourceDocument document)
		{
		...
		unsafe public PeDebugDirectory GetDebugDirectory()
		{
		...
		public ISymUnmanagedWriter2 SymWriter {
//^ assume this.symWriter != null;
			get { return this.symWriter; }
		}
