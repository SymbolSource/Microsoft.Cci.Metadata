...
namespace Microsoft.Cci.Immutable
{
	...
	public sealed class DummyArrayMethodReference : IMethodReference
	{
		...
		public DummyArrayMethodReference(IArrayTypeReference arrayType, OperationCode arrayOperation, IMetadataHost host)
		{
			...
			Contract.Requires(arrayOperation == OperationCode.Array_Addr || arrayOperation == OperationCode.Array_Create || arrayOperation == OperationCode.Array_Create_WithLowerBound || arrayOperation == OperationCode.Array_Get || arrayOperation == OperationCode.Array_Set);
	...
	public class GenericMethodInstance : IGenericMethodInstance
	{
		...
		{
			return MemberHelper.GetMethodSignature(this, NameFormattingOptions.ReturnType | NameFormattingOptions.Signature | NameFormattingOptions.ParameterModifiers | NameFormattingOptions.ParameterName);
		}
		...
		public TypeMemberVisibility Visibility {
			get { return TypeHelper.GenericInstanceVisibilityAsTypeMemberVisibility(this.GenericMethod.Visibility, this.GenericArguments); }
		}
...
//^ ensures result == false;
	...
	public class GenericMethodParameterReference : IGenericMethodParameterReference
	{
		...
		public void Resolve()
		{
			...
			if (!definingMethodDefinition.IsGeneric || this.index >= definingMethodDefinition.GenericParameterCount)
				return;
			foreach (var genericParameter in definingMethodDefinition.GenericParameters) {
				if (genericParameter.Index == this.index) {
					this.resolvedType = genericParameter;
					return;
				}
			}
		}
	...
	public class SpecializedEventDefinition : SpecializedTypeDefinitionMember<IEventDefinition>, ISpecializedEventDefinition
	{
		...
		public SpecializedEventDefinition(IEventDefinition unspecializedVersion, IEventDefinition partiallySpecializedVersion, ITypeDefinition containingTypeDefinition, GenericTypeInstance containingGenericTypeInstance) : base(unspecializedVersion, containingTypeDefinition, containingGenericTypeInstance)
		{
				...
				if (this.accessors == null) {
					lock (GlobalLock.LockingObject) {
						if (this.accessors == null) {
							...
							acc.Add(adder);
							akey = this.partiallySpecializedVersion.Adder.InternedKey;
							uint ckey = 0;
							var caller = this.Caller;
							if (caller != null) {
								acc.Add(caller);
								ckey = this.partiallySpecializedVersion.Caller.InternedKey;
							}
							uint rkey = 0;
							var remover = this.Remover;
							acc.Add(remover);
							rkey = this.partiallySpecializedVersion.Remover.InternedKey;
							foreach (IMethodReference accessor in this.partiallySpecializedVersion.Accessors) {
								var key = accessor.InternedKey;
								if (key == akey || key == ckey || key == rkey)
									continue;
		...
		public ITypeReference SpecializeIfConstructed(ITypeReference partiallySpecializedTypeReference)
		{
	...
	public class SpecializedFieldDefinition : SpecializedTypeDefinitionMember<IFieldDefinition>, ISpecializedFieldDefinition, ISpecializedFieldReference
	{
		...
		/// <param name="containingTypeDefinition"></param>
		/// <param name="containingGenericTypeInstance"></param>
		public SpecializedFieldDefinition(IFieldDefinition unspecializedVersion, IFieldDefinition partiallySpecializedVersion, ITypeDefinition containingTypeDefinition, GenericTypeInstance containingGenericTypeInstance) : base(unspecializedVersion, containingTypeDefinition, containingGenericTypeInstance)
		{
			this.partiallySpecializedVersion = partiallySpecializedVersion;
		}
...
//^ assume this.ContainingTypeDefinition.Layout == this.UnspecializedVersion.ContainingTypeDefinition.Layout;
			get { return this.UnspecializedVersion.Offset; }
		}
	...
	public class SpecializedGenericMethodParameter : SpecializedGenericParameter<IGenericMethodParameter>, IGenericMethodParameter
	{
		...
		/// <param name="definingMethod"></param>
		public SpecializedGenericMethodParameter(IGenericMethodParameter partiallySpecializedParameter, SpecializedMethodDefinition definingMethod) : base(partiallySpecializedParameter, definingMethod.ContainingGenericTypeInstance.InternFactory)
		{
			this.definingMethod = definingMethod;
		}
		...
		public ITypeReference CopyAndSpecialize(ITypeReference partiallySpecializedTypeReference)
		{
			partiallySpecializedTypeReference = TypeDefinition.DeepCopyTypeReferenceWRTSpecializedMethod(partiallySpecializedTypeReference, this.DefiningMethod, this.DefiningMethod.ContainingGenericTypeInstance.InternFactory);
	...
	public class SpecializedGenericMethodParameterReference : IGenericMethodParameterReference
	{

		public SpecializedGenericMethodParameterReference(IMethodReference definingMethod, IGenericMethodParameterReference unspecializedVersion, IInternFactory internFactory)
		{
			this.definingMethod = definingMethod;
			this.unspecializedVersion = unspecializedVersion;
			this.internFactory = internFactory;
		...
		public void Resolve()
		{
			...
			if (!definingMethodDef.IsGeneric || index >= definingMethodDef.GenericParameterCount)
				return;
			foreach (IGenericMethodParameter genericParameter in definingMethodDef.GenericParameters) {
				if (genericParameter.Index == index) {
					this.resolvedType = genericParameter;
					return;
				}
			}
	...
	public class SpecializedLocalDefinition : ILocalDefinition
	{

		public SpecializedLocalDefinition(ILocalDefinition unspecializedLocal, IMethodDefinition containingMethod, ITypeReference type)
		{
	...
	public class SpecializedMethodBody : IMethodBody
	{

		public SpecializedMethodBody(IMethodBody unspecializedBody, IMethodDefinition containingMethod, IInternFactory internFactory)
		{
		...
		public ITypeReference Specialize(ITypeReference unspecializedType, Dictionary<object, object> map)
		{
			object cachedResult;
			if (map.TryGetValue(unspecializedType, out cachedResult))
				return (ITypeReference)cachedResult;
		...
		public object Specialize(object unspecialized, Dictionary<object, object> map)
		{
			if (unspecialized == null)
				return null;
			object specialized;
			if (map.TryGetValue(unspecialized, out specialized))
				return specialized;
	...
	public class SpecializedMethodDefinition : SpecializedTypeDefinitionMember<IMethodDefinition>, ISpecializedMethodDefinition
	{
		...
		/// <param name="containingTypeDefinition"></param>
		/// <param name="containingGenericTypeInstance"></param>
		public SpecializedMethodDefinition(IMethodDefinition unspecializedVersion, IMethodDefinition partiallySpecializedVersion, ITypeDefinition containingTypeDefinition, GenericTypeInstance containingGenericTypeInstance) : base(unspecializedVersion, containingTypeDefinition, containingGenericTypeInstance)
		{
			this.partiallySpecializedVersion = partiallySpecializedVersion;
		}
		...
		public IMethodDefinition PartiallySpecializedVersion {
			get { return partiallySpecializedVersion; }
		}
		...
		public IMethodReference ImplementedMethod {
			get {
				if (this.implementedMethod == null) {
					var containingTypeForImplemented = TypeHelper.SpecializeTypeReference(this.unspecializedVersion.ImplementedMethod.ContainingType, this.ContainingType, this.internFactory);
					...
					if (specializedImplemented != null)
						unspecializedImplemented = specializedImplemented.UnspecializedVersion;
	...
	public class SpecializedMethodReference : ISpecializedMethodReference
	{
		...
		public override string ToString()
		{
			return MemberHelper.GetMethodSignature(this, NameFormattingOptions.ReturnType | NameFormattingOptions.Signature | NameFormattingOptions.TypeParameters | NameFormattingOptions.TypeConstraints);
		}
	}

	public class SpecializedOperation : IOperation
	{

		public SpecializedOperation(IOperation unspecializedOperation, object specializedValue)
		{
	...
	public class SpecializedOperationExceptionInformation : IOperationExceptionInformation
	{

		public SpecializedOperationExceptionInformation(IOperationExceptionInformation unspecializedVersion, ITypeReference specialziedExceptionType)
		{
			this.unspecializedVersion = unspecializedVersion;
	...
	public class SpecializedParameterDefinition : IParameterDefinition
	{
		...
		/// <param name="internFactory"></param>
		public SpecializedParameterDefinition(IParameterDefinition partiallySpecializedParameter, IGenericMethodInstanceReference containingSignature, IInternFactory internFactory)
		{
		...
		/// <param name="containingSignature"></param>
		/// <param name="internFactory"></param>
		public SpecializedParameterDefinition(IParameterDefinition partiallySpecializedParameter, SpecializedMethodDefinition containingSignature, IInternFactory internFactory)
		{
			this.partiallySpecializedParameter = partiallySpecializedParameter;
			this.containingSignature = containingSignature;
			this.internFactory = internFactory;
		...
		/// <param name="containingSignature"></param>
		/// <param name="internFactory"></param>
		public SpecializedParameterDefinition(IParameterDefinition partiallySpecializedParameter, SpecializedPropertyDefinition containingSignature, IInternFactory internFactory)
		{
			this.partiallySpecializedParameter = partiallySpecializedParameter;
			this.containingSignature = containingSignature;
			this.internFactory = internFactory;
...
//^ ensures result is IGenericMethodInstance || result is SpecializedMethodDefinition || result is SpecializedPropertyDefinition;
		...
		public IParameterDefinition PartiallySpecializedParameter {
			get { return this.partiallySpecializedParameter; }
		}
		...
		/// </remarks>
		public ITypeReference CopyAndSpecialize(ITypeReference partiallySpecializedType)
		{
...
//^^ requires this.HasDefaultValue;
			get { return this.partiallySpecializedParameter.DefaultValue; }
		}
...
//^ ensures result == this.unspecializedParameter.IsParameterArray;
			get { return this.partiallySpecializedParameter.IsParameterArray; }
		}
	...
	public class SpecializedParameterTypeInformation : IParameterTypeInformation
	{
		...
		/// <param name="containingSignature"></param>
		/// <param name="internFactory"></param>
		public SpecializedParameterTypeInformation(IParameterTypeInformation partiallySpecializedParameter, IGenericMethodInstanceReference containingSignature, IInternFactory internFactory)
		{
			this.partiallySpecializedParameter = partiallySpecializedParameter;
			this.containingSignature = containingSignature;
			this.internFactory = internFactory;
		...
		public ITypeReference SpecializeIfConstructed(ITypeReference partiallySpecializedType)
		{
	...
	public class SpecializedMethodParameterTypeInformation : IParameterTypeInformation
	{

		/// <summary>
		/// 
		/// </summary>
		public SpecializedMethodParameterTypeInformation(ISpecializedMethodReference containingMethod, IParameterTypeInformation unspecializedVersion, IInternFactory internFactory)
		{
			this.containingMethod = containingMethod;
			this.unspecializedVersion = unspecializedVersion;
			this.internFactory = internFactory;
	...
	public class SpecializedPropertyDefinition : SpecializedTypeDefinitionMember<IPropertyDefinition>, ISpecializedPropertyDefinition
	{
		...
		/// <param name="containingTypeDefinition"></param>
		/// <param name="containingGenericTypeInstance"></param>
		public SpecializedPropertyDefinition(IPropertyDefinition unspecializedVersion, IPropertyDefinition partiallySpecializedVersion, ITypeDefinition containingTypeDefinition, GenericTypeInstance containingGenericTypeInstance) : base(unspecializedVersion, containingTypeDefinition, containingGenericTypeInstance)
		{
			this.partiallySpecializedVersion = partiallySpecializedVersion;
		}
				...
				if (this.accessors == null) {
					lock (GlobalLock.LockingObject) {
						if (this.accessors == null) {
							...
							if (getter != null) {
								acc.Add(getter);
								gkey = this.partiallySpecializedVersion.Getter.InternedKey;
							}
							uint skey = 0;
							var setter = this.Setter;
							if (setter != null) {
								acc.Add(setter);
								skey = this.partiallySpecializedVersion.Setter.InternedKey;
							}
							foreach (IMethodReference accessor in this.partiallySpecializedVersion.Accessors) {
								var akey = accessor.InternedKey;
								if (akey == gkey || akey == skey)
									continue;
								acc.Add((IMethodReference)this.ContainingGenericTypeInstance.SpecializeMember(accessor.ResolvedMethod, this.ContainingGenericTypeInstance.InternFactory));
							}
							this.accessors = acc.AsReadOnly();
	...
	public abstract class SpecializedTypeDefinitionMember<MemberType> : ITypeDefinitionMember where MemberType : ITypeDefinitionMember
	{
		//  This constraint should also require the MemberType to be unspecialized.
		...
		/// <param name="containingTypeDefinition"></param>
		/// <param name="containingGenericTypeInstance"></param>
			/*!*/		public SpecializedTypeDefinitionMember(MemberType unspecializedVersion		, ITypeDefinition containingTypeDefinition, GenericTypeInstance containingGenericTypeInstance)
		{
			this.unspecializedVersion = unspecializedVersion;
		...
		public TypeMemberVisibility Visibility {
			get {
				...
				return TypeHelper.VisibilityIntersection(unspecializedVersion.Visibility, TypeHelper.TypeVisibilityAsTypeMemberVisibility(this.ContainingGenericTypeInstance));
			}
		}
