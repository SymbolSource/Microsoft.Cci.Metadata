...
namespace Microsoft.Cci
{
	...
	/// </summary>
	unsafe public sealed class MemoryMappedFile : IBinaryDocumentMemoryBlock, IDisposable
	{

		public MemoryMappedFile(IBinaryDocument binaryDocument, byte* buffer, uint length)
		{
		...
		public static MemoryMappedFile CreateMemoryMappedFile(string localFileName, IBinaryDocument binaryDocument)
		{
			...
			return new MemoryMappedFile(binaryDocument, buffer, length);
		}

		public static void OpenFileMemoryMap(string filename, out Byte* buffer, out uint length)
		{
			IntPtr hmap;
		...
		// low-order DWORD of size
			/*?*/			// object name
		public static extern IntPtr CreateFileMapping(IntPtr hFile, IntPtr lpAttributes, PageAccess flProtect, uint dwMaximumSizeHigh, uint dwMaximumSizeLow, string lpName		);
		...
		public static extern void* MapViewOfFile(IntPtr hFileMappingObject, FileMapAccess dwDesiredAccess, int dwFileOffsetHigh, int dwFileOffsetLow, IntPtr dwNumberOfBytesToMap);
	...
	/// Important: each instance of this class holds a read-lock on a file. Instances should be explicitly disposed as soon as they become inactive.
	/// </summary>
	unsafe public sealed class UnmanagedBinaryMemoryBlock : IBinaryDocumentMemoryBlock, IDisposable
	{
		IBinaryDocument binaryDocument;
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Reliability", "CA2006:UseSafeHandleToEncapsulateNativeResources")]
		IntPtr Pointer;

		public UnmanagedBinaryMemoryBlock(IBinaryDocument binaryDocument)
		{
			this.binaryDocument = binaryDocument;
	...
	public sealed class BinaryLocation : IBinaryLocation
	{
		...
		public BinaryLocation(IBinaryDocument binaryDocument, uint offset)
		{
			this.binaryDocument = binaryDocument;
			this.offset = offset;
		}
...
//^ assume ((IBinaryLocation)this).BinaryDocument == this.binaryDocument; //see above
	...
	public sealed class ILLocation : IILLocation
	{
		...
		/// <param name="offset"></param>
		public ILLocation(IBinaryDocument binaryDocument, IMethodDefinition methodDefinition, uint offset)
		{
			this.binaryDocument = binaryDocument;
