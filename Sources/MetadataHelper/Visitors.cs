...
namespace Microsoft.Cci
{
	...
	public class BaseMetadataTraverser : IMetadataVisitor
	{
		...
		public virtual void Visit(ITypeMemberReference typeMemberReference)
		{
			...
			//In principle, refererences can have attributes that are distinct from the definitions they refer to.
			//^ assume this.path.Count == oldCount+1; //True because all of the virtual methods of this class promise not decrease this.path.Count.
			this.path.Pop();
		}
		...
		public void DispatchAsReference(ITypeReference typeReference)
		{
		...
		public void DispatchAsReference(IUnitReference unitReference)
		{
	...
	public class MetadataTraverser
	{
		...
		public class Dispatcher : IMetadataVisitor
		{
			public MetadataTraverser traverser;
		...
		/// </summary>
		public SetOfObjects objectsThatHaveAlreadyBeenTraversed = new SetOfObjects(1024 * 4);
		...
		public void Traverse(IArrayTypeReference arrayTypeReference)
		{
			...
			if (!this.objectsThatHaveAlreadyBeenTraversed.Add(arrayTypeReference))
				return;
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(arrayTypeReference);
			//No need to dispatch. This call is already type specific.
			if (this.stopTraversal)
				return;
			this.TraverseChildren(arrayTypeReference);
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(arrayTypeReference);
		}
		...
		public void Traverse(IAssembly assembly)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(assembly);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(assembly);
		}
		...
		public void Traverse(IAssemblyReference assemblyReference)
		{
			...
			if (!this.objectsThatHaveAlreadyBeenTraversed.Add(assemblyReference))
				return;
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(assemblyReference);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(assemblyReference);
		}
		...
		public void Traverse(ICustomAttribute customAttribute)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(customAttribute);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(customAttribute);
		}
		...
		public void Traverse(ICustomModifier customModifier)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(customModifier);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(customModifier);
		}
		...
		public void Traverse(IEventDefinition eventDefinition)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(eventDefinition);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(eventDefinition);
		}
		...
		public void Traverse(IFieldDefinition fieldDefinition)
		{
			...
			if (this.preorderVisitor != null)
				fieldDefinition.Dispatch(this.preorderVisitor);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				fieldDefinition.Dispatch(this.postorderVisitor);
		}
		...
		/// </summary>
		public void TraverseUnspecialized(IFieldReference fieldReference)
		{
			Contract.Requires(fieldReference != null);
			Contract.Requires(!(fieldReference is ISpecializedFieldReference));
			if (!this.objectsThatHaveAlreadyBeenTraversed.Add(fieldReference))
				return;
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(fieldReference);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(fieldReference);
		}
		...
		public void Traverse(IFileReference fileReference)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(fileReference);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(fileReference);
		}
		...
		public void Traverse(IFunctionPointerTypeReference functionPointerTypeReference)
		{
			...
			if (!this.objectsThatHaveAlreadyBeenTraversed.Add(functionPointerTypeReference))
				return;
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(functionPointerTypeReference);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(functionPointerTypeReference);
		}
		...
		public void Traverse(IGenericMethodInstanceReference genericMethodInstanceReference)
		{
			...
			if (!this.objectsThatHaveAlreadyBeenTraversed.Add(genericMethodInstanceReference))
				return;
			if (this.preorderVisitor != null)
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(genericMethodInstanceReference);
		}
		...
		public void Traverse(IGenericMethodParameter genericMethodParameter)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(genericMethodParameter);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(genericMethodParameter);
		}
		...
		public void Traverse(IGenericMethodParameterReference genericMethodParameterReference)
		{
			...
			if (!this.objectsThatHaveAlreadyBeenTraversed.Add(genericMethodParameterReference))
				return;
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(genericMethodParameterReference);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(genericMethodParameterReference);
		}
		...
		public void Traverse(IGenericTypeInstanceReference genericTypeInstanceReference)
		{
			...
			if (!this.objectsThatHaveAlreadyBeenTraversed.Add(genericTypeInstanceReference))
				return;
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(genericTypeInstanceReference);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(genericTypeInstanceReference);
		}
		...
		public void Traverse(IGenericTypeParameter genericTypeParameter)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(genericTypeParameter);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(genericTypeParameter);
		}
		...
		public void Traverse(IGenericTypeParameterReference genericTypeParameterReference)
		{
			...
			if (!this.objectsThatHaveAlreadyBeenTraversed.Add(genericTypeParameterReference))
				return;
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(genericTypeParameterReference);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(genericTypeParameterReference);
		}
		...
		public void Traverse(IGlobalFieldDefinition globalFieldDefinition)
		{
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(globalFieldDefinition);
		}
		...
		public void Traverse(IGlobalMethodDefinition globalMethodDefinition)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(globalMethodDefinition);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(globalMethodDefinition);
		}
		...
		public void Traverse(ILocalDefinition localDefinition)
		{
			...
			if (!this.objectsThatHaveAlreadyBeenTraversed.Add(localDefinition))
				return;
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(localDefinition);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(localDefinition);
		}
		...
		public void Traverse(IManagedPointerTypeReference managedPointerTypeReference)
		{
			...
			if (!this.objectsThatHaveAlreadyBeenTraversed.Add(managedPointerTypeReference))
				return;
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(managedPointerTypeReference);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(managedPointerTypeReference);
		}
		...
		public void Traverse(IMarshallingInformation marshallingInformation)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(marshallingInformation);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(marshallingInformation);
		}
		...
		public void Traverse(IMetadataConstant constant)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(constant);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(constant);
		}
		...
		public void Traverse(IMetadataCreateArray createArray)
		{
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(createArray);
		}
		...
		public void Traverse(IMetadataNamedArgument namedArgument)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(namedArgument);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(namedArgument);
		}
		...
		public void Traverse(IMetadataTypeOf typeOf)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(typeOf);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(typeOf);
		}
		...
		public virtual void Traverse(IMethodBody methodBody)
		{
			...
			if (!this.TraverseIntoMethodBodies)
				return;
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(methodBody);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(methodBody);
		}
		...
		public void Traverse(IMethodDefinition method)
		{
			...
			if (this.preorderVisitor != null)
				method.Dispatch(this.preorderVisitor);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				method.Dispatch(this.postorderVisitor);
		}
		...
		public void Traverse(IMethodImplementation methodImplementation)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(methodImplementation);
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(methodImplementation);
		}
		...
		public void TraverseUnspecialized(IMethodReference methodReference)
		{
			Contract.Requires(methodReference != null);
			if (!this.objectsThatHaveAlreadyBeenTraversed.Add(methodReference))
				return;
			if (this.preorderVisitor != null)
				methodReference.DispatchAsReference(this.preorderVisitor);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				methodReference.DispatchAsReference(this.postorderVisitor);
		}
		...
		public void Traverse(IModifiedTypeReference modifiedTypeReference)
		{
			...
			if (!this.objectsThatHaveAlreadyBeenTraversed.Add(modifiedTypeReference))
				return;
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(modifiedTypeReference);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(modifiedTypeReference);
		}
		...
		public void Traverse(IModule module)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(module);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(module);
		}
		...
		public void Traverse(IModuleReference moduleReference)
		{
			...
			if (!this.objectsThatHaveAlreadyBeenTraversed.Add(moduleReference))
				return;
			if (this.preorderVisitor != null)
				moduleReference.DispatchAsReference(this.preorderVisitor);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				moduleReference.DispatchAsReference(this.postorderVisitor);
		}
		...
		public void Traverse(INamespaceAliasForType namespaceAliasForType)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(namespaceAliasForType);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(namespaceAliasForType);
		}
		...
		public void Traverse(INamespaceTypeDefinition namespaceTypeDefinition)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(namespaceTypeDefinition);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(namespaceTypeDefinition);
		}
		...
		public void Traverse(INamespaceTypeReference namespaceTypeReference)
		{
			...
			if (!this.objectsThatHaveAlreadyBeenTraversed.Add(namespaceTypeReference))
				return;
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(namespaceTypeReference);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(namespaceTypeReference);
		}
		...
		public void Traverse(INestedAliasForType nestedAliasForType)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(nestedAliasForType);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(nestedAliasForType);
		}
		...
		public void Traverse(INestedTypeDefinition nestedTypeDefinition)
		{
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(nestedTypeDefinition);
		}
		...
		public void TraverseUnspecialized(INestedTypeReference nestedTypeReference)
		{
			Contract.Requires(nestedTypeReference != null);
			if (!this.objectsThatHaveAlreadyBeenTraversed.Add(nestedTypeReference))
				return;
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(nestedTypeReference);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(nestedTypeReference);
		}
		...
		public void Traverse(INestedUnitNamespace nestedUnitNamespace)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(nestedUnitNamespace);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(nestedUnitNamespace);
		}
		...
		public void Traverse(INestedUnitNamespaceReference nestedUnitNamespaceReference)
		{
			...
			if (!this.objectsThatHaveAlreadyBeenTraversed.Add(nestedUnitNamespaceReference))
				return;
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(nestedUnitNamespaceReference);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(nestedUnitNamespaceReference);
		}
		...
		public void Traverse(INestedUnitSetNamespace nestedUnitSetNamespace)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(nestedUnitSetNamespace);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(nestedUnitSetNamespace);
		}
		...
		public void Traverse(IOperation operation)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(operation);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(operation);
		}
		...
		public void Traverse(IOperationExceptionInformation operationExceptionInformation)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(operationExceptionInformation);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(operationExceptionInformation);
		}
		...
		public void Traverse(IParameterDefinition parameterDefinition)
		{
			...
			if (!this.objectsThatHaveAlreadyBeenTraversed.Add(parameterDefinition))
				return;
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(parameterDefinition);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(parameterDefinition);
		}
		...
		public void Traverse(IParameterTypeInformation parameterTypeInformation)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(parameterTypeInformation);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(parameterTypeInformation);
		}
		...
		public void Traverse(IPESection peSection)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(peSection);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(peSection);
		}
		...
		public void Traverse(IPlatformInvokeInformation platformInvokeInformation)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(platformInvokeInformation);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(platformInvokeInformation);
		}
		...
		public void Traverse(IPointerTypeReference pointerTypeReference)
		{
			...
			if (!this.objectsThatHaveAlreadyBeenTraversed.Add(pointerTypeReference))
				return;
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(pointerTypeReference);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(pointerTypeReference);
		}
		...
		public void Traverse(IPropertyDefinition propertyDefinition)
		{
			...
			if (!this.objectsThatHaveAlreadyBeenTraversed.Add(propertyDefinition))
				return;
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(propertyDefinition);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(propertyDefinition);
		}
		...
		public void Traverse(IResourceReference resourceReference)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(resourceReference);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(resourceReference);
		}
		...
		public void Traverse(IRootUnitNamespace rootUnitNamespace)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(rootUnitNamespace);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(rootUnitNamespace);
		}
		...
		public void Traverse(IRootUnitSetNamespace rootUnitSetNamespace)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(rootUnitSetNamespace);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(rootUnitSetNamespace);
		}
		...
		public void Traverse(IRootUnitNamespaceReference rootUnitNamespaceReference)
		{
			...
			if (!this.objectsThatHaveAlreadyBeenTraversed.Add(rootUnitNamespaceReference))
				return;
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(rootUnitNamespaceReference);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(rootUnitNamespaceReference);
		}
		...
		public void Traverse(ISecurityAttribute securityAttribute)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(securityAttribute);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(securityAttribute);
		}
		...
		public void Traverse(ISpecializedFieldReference specializedFieldReference)
		{
			...
			if (!this.objectsThatHaveAlreadyBeenTraversed.Add(specializedFieldReference))
				return;
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(specializedFieldReference);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(specializedFieldReference);
		}
		...
		public void Traverse(ISpecializedMethodReference specializedMethodReference)
		{
			...
			if (!this.objectsThatHaveAlreadyBeenTraversed.Add(specializedMethodReference))
				return;
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(specializedMethodReference);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(specializedMethodReference);
		}
		...
		public void Traverse(ISpecializedNestedTypeReference specializedNestedTypeReference)
		{
			...
			if (!this.objectsThatHaveAlreadyBeenTraversed.Add(specializedNestedTypeReference))
				return;
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(specializedNestedTypeReference);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(specializedNestedTypeReference);
		}
		...
		public void Traverse(IWin32Resource win32Resource)
		{
			...
			if (this.preorderVisitor != null)
				this.preorderVisitor.Visit(win32Resource);
			if (this.stopTraversal)
				return;
			...
			if (this.stopTraversal)
				return;
			if (this.postorderVisitor != null)
				this.postorderVisitor.Visit(win32Resource);
		}
