...
namespace Microsoft.Cci
{
	...
	{
		//TODO: move this to another assembly.
		/// <summary>
		...
		public class OptionDescription : Attribute
		{
			...
			/// </summary>
			public OptionDescription(string s)
			{
				this.Description = s;
			}
			/// <summary>
		...
		/// </summary>
		public class OptionWitness : Attribute
		{
		}
		...
		/// </summary>
		public class OptionFor : Attribute
		{
			/// <summary>
		...
		/// </summary>
		public virtual bool UseDashOptionPrefix {
			get { return true; }
		}
		...
		public List<string> GeneralArguments {
			get { return this.generalArguments; }
		}
		...
		public virtual bool ParseUnknown(string option, string[] args, ref int index, string optionEqualsArgument)
		{
			return false;
		}
		...
		public void ParseResponseFile(string responseFile)
		{
		...
		public string[] SplitLineWithQuotes(string responseFileName, int lineNo, string line)
		{
			var start = 0;
			var args = new List<string>();
			bool inDoubleQuotes = false;
			int escaping = 0;
			// number of escape characters in sequence
		...
		public static void FinishArgument(string line, int start, List<string> args, StringBuilder currentArg, int index, bool includeEmpty)
		{
			currentArg.Append(line.Substring(start, index - start));
		...
		public bool ContainsQuote(string line)
		{
		...
		public IList<string> GatherRequiredOptions()
		{
		...
		public bool ParseValue<T>(Converter<string, T> parser, string equalArgument, string[] args, ref int index, ref object result)
		{
		...
		public bool ParseValue<T>(Converter<string, T> parser, string argument, ref object result)
		{
			bool success = false;
			if (argument != null) {
				try {
		...
		public object ParseValue(Type type, string argument, string option)
		{
			object result = null;
			if (type == typeof(bool)) {
				if (argument != null) {
		...
		public string AdvanceArgumentIfNoExplicitArg(Type type, string explicitArg, string[] args, ref int index)
		{
			if (explicitArg != null)
				return explicitArg;
			if (type == typeof(bool)) {
		...
		public bool FindOptionByReflection(string arg, string[] args, ref int index, string explicitArgument)
		{
		...
		public bool ProcessOptionWithMatchingField(string arg, string[] args, ref int index, string explicitArgument, ref System.Reflection.FieldInfo fi)
		{
		...
		public bool HasOptionForAttribute(System.Reflection.FieldInfo fi, out string argname)
		{
		...
		/// </summary>
		public string DerivedOptionFor(string fieldWithOptions, int option)
		{
			string[] options;
		...
		/// </summary>
		public bool TryGetOptions(string fieldWithOptions, out string[] options)
		{
			var fi = this.GetType().GetField(fieldWithOptions, System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.FlattenHierarchy | System.Reflection.BindingFlags.Public);
		...
		public Converter<string, object> ParseEnum(Type enumType)
		{
			return delegate(string s) { return Enum.Parse(enumType, s, true); };
		}

		public System.Collections.IList GetListField(System.Reflection.FieldInfo fi)
		{
			object obj = fi.GetValue(this);
			if (obj != null) {
				return (System.Collections.IList)obj;
			}
			System.Collections.IList result = (System.Collections.IList)fi.FieldType.GetConstructor(new Type[] {
		...
		public string GetOptionAttribute(System.Reflection.FieldInfo f)
		{
