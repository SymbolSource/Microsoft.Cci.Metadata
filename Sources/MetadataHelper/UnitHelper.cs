...
namespace Microsoft.Cci
{
	...
	public static class UnitHelper
	{
		...
		public static INamedTypeDefinition GetType(		/*?*/INameTable nameTable, INamespaceDefinition namespaceDefinition, string typeName, int genericParameterCount, ref int offset)
		{
			Contract.Requires(nameTable != null);
		...
		public static INestedUnitNamespace GetNamespace(		/*?*/INameTable nameTable, INamespaceDefinition namespaceDefinition, string typeName, ref int offset)
		{
			Contract.Requires(nameTable != null);
			Contract.Requires(namespaceDefinition != null);
			Contract.Requires(typeName != null);
			...
			if (dotPos < 0)
				return null;
			Contract.Assume(dotPos >= offset);
			//if a dot has been found, it must be at offset or later
		...
		public static INestedTypeDefinition GetNestedType(		/*?*/INameTable nameTable, ITypeDefinition typeDefinition, string typeName, int genericParameterCount, ref int offset)
		{
			Contract.Requires(nameTable != null);
			...
			/*?*/			/*?*/		public static bool UnitNamespacesAreEquivalent(IUnitNamespaceReference unitNamespace1		, IUnitNamespaceReference unitNamespace2		)
		{
			...
			if (nstUnitNamespace1 != null && nstUnitNamespace2 != null) {
				return nstUnitNamespace1.Name.UniqueKey == nstUnitNamespace2.Name.UniqueKey && UnitHelper.UnitNamespacesAreEquivalent(nstUnitNamespace1.ContainingUnitNamespace, nstUnitNamespace2.ContainingUnitNamespace);
			}
			if (nstUnitNamespace1 != null || nstUnitNamespace2 != null)
				return false;
...
namespace Microsoft.Cci.Immutable
{
					...
					lock (GlobalLock.LockingObject) {
						if (this.unitSetNamespaceRoot == null) {
							...
							foreach (IUnit unit in this.Units) {
								rootName = unit.NamespaceRoot.Name;
								break;
							}
	...
	public abstract class AggregatedNamespace<ContainerType, ContainerMemberType> : AggregatedScope<INamespaceMember, ContainerType, ContainerMemberType>, INamespaceDefinition where ContainerType : class, IContainer<ContainerMemberType> where ContainerMemberType : class, IContainerMember<ContainerType>
	{
		...
		public AggregatedNamespace(IName name)
		{
			this.name = name;
		}
		...
		/// </summary>
		public abstract INamespaceRootOwner RootOwner { get; }
		...
		/// </summary>
		public abstract IEnumerable<ILocation> Locations { get; }
	...
	public abstract class AggregatedScope<ScopeMemberType, ContainerType, ContainerMemberType> : Scope<ScopeMemberType> where ScopeMemberType : class, IScopeMember<IScope<ScopeMemberType>> where ContainerType : class, IContainer<ContainerMemberType> where ContainerMemberType : class, IContainerMember<ContainerType>
	{
		...
		/// <param name="member">The container member to aggregate. The aggregation gets cached and shows up in the Members collection of this scope.</param>
			/*!*/		public void AddContainerMemberToCache(ContainerMemberType member		)
		{
		...
		/// <param name="container">A collection of members to aggregate with members from other containers and add to the members collection of this scope.</param>
			/*!*/		public virtual void AddContainer(ContainerType container		)
		{
			foreach (ContainerMemberType containerMember in container.Members) {
				if (containerMember == null)
					continue;
				//TODO: see if the type system can preclude this
		...
		public abstract ScopeMemberType GetAggregatedMember(		/*!*/			/*!*/ContainerMemberType member		);
	...
	public sealed class RootUnitSetNamespace : UnitSetNamespace, IRootUnitSetNamespace
	{
		...
		public RootUnitSetNamespace(IName name, UnitSet unitSet) : base(name, unitSet)
		{
		}
	...
	public abstract class UnitSetNamespace : AggregatedNamespace<INamespaceDefinition, INamespaceMember>, IUnitSetNamespace
	{
		...
		/// <param name="name"></param>
		/// <param name="unitSet"></param>
		public UnitSetNamespace(IName name, UnitSet unitSet) : base(name)
		{
		...
		public UnitSetNamespace(IName name, IUnitSet unitSet, List<IUnitNamespace> nestedUnitNamespaces) : base(name)
		{
			this.unitSet = unitSet;
		...
		/// <returns></returns>
		public override INamespaceMember GetAggregatedMember(INamespaceMember member)
		{
		...
		/// 
		/// </summary>
		public List<IUnitNamespace> UnitNamespaces {
			get {
	...
	public sealed class NestedUnitSetNamespace : UnitSetNamespace, INamespaceMember, INestedUnitSetNamespace
	{
		...
		public NestedUnitSetNamespace(UnitSetNamespace containingNamespace, IName name, IUnitSet unitSet, List<IUnitNamespace> nestedUnitNamepaces) : base(name, unitSet, nestedUnitNamepaces)
		{
