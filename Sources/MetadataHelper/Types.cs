...
namespace Microsoft.Cci.Immutable
{
	...
	public abstract class ArrayType : SystemDefinedStructuralType, IArrayType
	{
		...
		public ArrayType(ITypeReference elementType, IInternFactory internFactory) : base(internFactory)
		{
		...
		public virtual IEnumerable<ITypeReference> GetInterfaceList()
		{
...
//^ assume this.IsGeneric == ((ITypeDefinition)this).IsGeneric;
	...
	public class CustomModifier : ICustomModifier
	{
		...
		public static ICustomModifier CopyModifierToNewContainer(ICustomModifier customModifier, SpecializedNestedTypeDefinition targetContainer, IInternFactory internFactory)
		{
			ITypeReference copiedModifier = TypeDefinition.DeepCopyTypeReference(customModifier.Modifier, targetContainer, internFactory);
			if (copiedModifier == customModifier.Modifier)
				return customModifier;
			return new CustomModifier(customModifier.IsOptional, copiedModifier);
		}

		public static ICustomModifier Specialize(ICustomModifier customModifier, ITypeReference targetContainer, IInternFactory internFactory)
		{
		...
		public static ICustomModifier Specialize(ICustomModifier customModifier, IMethodReference targetContainer, IInternFactory internFactory)
		{
			ITypeReference copiedModifier = TypeHelper.SpecializeTypeReference(customModifier.Modifier, targetContainer, internFactory);
			if (copiedModifier == customModifier.Modifier)
				return customModifier;
		...
		/// </summary>
		public static ICustomModifier SpecializeIfConstructedFromApplicableMethodTypeParameter(ICustomModifier customModifier, ISpecializedMethodReference specializedMethodReference, IInternFactory internFactory)
		{
	...
	public class FunctionPointerType : SystemDefinedStructuralType, IFunctionPointer
	{
		...
		public FunctionPointerType(ISignature signature, IInternFactory internFactory) : base(internFactory)
		{
			...
			/*?*/			/*?*/		public FunctionPointerType(CallingConvention callingConvention, bool returnValueIsByRef, ITypeReference type, IEnumerable<ICustomModifier> returnValueCustomModifiers		, IEnumerable<IParameterTypeInformation> parameters, IEnumerable<IParameterTypeInformation> extraArgumentTypes		, IInternFactory internFactory) : base(internFactory)
		{
		...
		public IEnumerable<ICustomModifier> ReturnValueCustomModifiers {
			get {
				...
				//shouldn't get here if the precondition is respected.
	...
	public class GenericTypeInstance : Scope<ITypeDefinitionMember>, IGenericTypeInstance
	{
		...
		public GenericTypeInstance(INamedTypeDefinition genericType, IEnumerable<ITypeReference> genericArguments, IInternFactory internFactory)
		{
			Contract.Requires(!(genericType is Dummy));
			Contract.Requires(genericArguments != null);
			Contract.Requires(internFactory != null);
		...
		//^ invariant genericType.ResolvedType.IsGeneric;
...
//TODO: specialize and cache the private helper members of the generic type template.
		...
		///  /// <param name="internFactory">An intern factory. </param>
		public static ITypeReference DeepCopyTypeReference(IGenericTypeInstanceReference genericTypeInstance, SpecializedNestedTypeDefinition targetContainer, IInternFactory internFactory)
		{
			...
			foreach (ITypeReference argType in genericTypeInstance.GenericArguments) {
				...
				if (argType != copiedArgType) {
					if (copiedArguments == null)
						copiedArguments = new List<ITypeReference>(genericTypeInstance.GenericArguments);
			...
			if (copiedArguments == null) {
				if (copiedGenericType == genericTypeInstance.GenericType)
		...
		public static ITypeReference SpecializeTypeReference(IGenericTypeInstanceReference genericTypeInstance, ITypeReference targetContainer, IInternFactory internFactory)
		{
		...
		public static ITypeReference SpecializeTypeReference(IGenericTypeInstanceReference genericTypeInstance, IMethodReference targetContainer, IInternFactory internFactory)
		{
			var copiedGenericType = (INamedTypeReference)TypeHelper.SpecializeTypeReference(genericTypeInstance.GenericType, targetContainer, internFactory);
			List<ITypeReference> 			/*?*/copiedArguments = null;
			int i = 0;
		...
		public static ITypeReference SpecializeIfConstructedFromApplicableTypeParameter(IGenericTypeInstanceReference genericTypeInstance, IGenericMethodInstanceReference containingMethodInstance, IInternFactory internFactory)
		{
			...
			foreach (ITypeReference argType in genericTypeInstance.GenericArguments) {
				...
				if (argType != specializedArgType) {
					if (specializedArguments == null)
						specializedArguments = new List<ITypeReference>(genericTypeInstance.GenericArguments);
					//^ assume 0 <= i && i < specializedArguments.Count; //Since genericTypeInstance.GenericArguments is immutable
			...
			if (specializedArguments == null) {
				if (specializedGenericType == genericTypeInstance.GenericType)
					return genericTypeInstance;
				else
					return new GenericTypeInstanceReference(specializedGenericType, genericTypeInstance.GenericArguments, internFactory);
			}
		...
		/// </summary>
		public static ITypeReference DeepCopyTypeReferenceWRTSpecializedMethod(IGenericTypeInstanceReference genericTypeInstance, ISpecializedMethodReference specializedMethodReference, IInternFactory internFactory)
		{
		...
		public ITypeDefinitionMember SpecializeMember(ITypeDefinitionMember unspecializedMember, IInternFactory internFactory)
		{
			...
			if (eventDef != null) {
				...
				if (specializedEventDef != null)
					unspecializedEventDef = specializedEventDef.UnspecializedVersion;
			...
			if (fieldDef != null) {
				...
				if (specializedFieldDef != null)
					unspecializedFieldDef = specializedFieldDef.UnspecializedVersion;
			...
			if (methodDef != null) {
				...
				if (specializedMethodDef != null)
					unspecializedMethodDef = specializedMethodDef.UnspecializedVersion;
			...
			if (propertyDef != null) {
				...
				if (specializedPropertyDef != null)
					unspecializedPropertyDef = specializedPropertyDef.UnspecializedVersion;
			...
			if (specializedTypeDef != null)
				unspecializedTypeDef = specializedTypeDef.UnspecializedVersion;
...
//^ ensures result == this.GenericType.ResolvedType.Layout;
			get { return this.GenericType.ResolvedType.Layout; }
		}
	...
	public static class GenericParameter
	{
		...
		public static ITypeReference SpecializeTypeReference(IGenericTypeParameterReference genericTypeParameter, ITypeReference targetContainer)
		{
			...
			while (true) {
				...
				if (specializedNestedType != null) {
					targetContainer = specializedNestedType.ContainingType;
					continue;
				}
				...
				if (specializedNestedType != null)
					genericType = specializedNestedType.UnspecializedVersion;
				if (!TypeHelper.TypesAreEquivalent(genericType, genericTypeParameter.DefiningType)) {
					targetContainer = genericTypeInstance.GenericType;
					continue;
				}
				var i = 0;
				...
				//The type parameter claims it is defined by genericTypeInstance.GenericType, so we should never get here legitimately.
				return Dummy.TypeReference;
			}
		}

		public static ITypeReference SpecializeTypeReference(IGenericTypeParameterReference genericTypeParameter, IMethodReference targetContainer)
		{
			return SpecializeTypeReference(genericTypeParameter, targetContainer.ContainingType);
		}

		public static ITypeReference SpecializeTypeReference(IGenericMethodParameterReference genericMethodParameter, IMethodReference targetContainer, IInternFactory internFactory)
		{
		...
		public static ITypeReference SpecializeIfConstructedFromApplicableTypeParameter(IGenericMethodParameterReference genericMethodParameter, IGenericMethodInstanceReference containingMethodInstance)
		{
			if (genericMethodParameter.DefiningMethod.InternedKey == containingMethodInstance.GenericMethod.InternedKey) {
				...
				while (genericArguments.MoveNext()) {
					if (i++ == n)
						return genericArguments.Current;
				}
			}
		...
		/// </summary>
		public static ITypeReference DeepCopyTypeReferenceWRTSpecializedMethod(IGenericMethodParameterReference genericMethodParameter, ISpecializedMethodReference specializedMethodReference)
		{
		...
		/// </summary>
		public static ITypeReference DeepCopyTypeReferenceWRTSpecializedMethod(IGenericTypeParameterReference genericTypeParameter, ISpecializedMethodReference specializedMethodReference)
		{
			var specializedNestedType = specializedMethodReference.ContainingType as SpecializedNestedTypeDefinition;
			if (specializedNestedType != null)
				return DeepCopyTypeReference(genericTypeParameter, specializedNestedType);
			return genericTypeParameter;
		}
	...
	public class ManagedPointerType : SystemDefinedStructuralType, IManagedPointerType
	{
		...
		public ManagedPointerType(ITypeReference targetType, IInternFactory internFactory) : base(internFactory)
		{
		...
		///  /// <param name="internFactory">An intern factory. </param>
		public static ITypeReference DeepCopyTypeReference(IManagedPointerTypeReference pointer, SpecializedNestedTypeDefinition targetContainer, IInternFactory internFactory)
		{
			...
			if (targetType == specializedtargetType)
				return pointer;
			return GetManagedPointerType(specializedtargetType, internFactory);
		}

		public static ITypeReference SpecializeTypeReference(IManagedPointerTypeReference pointer, ITypeReference targetContainer, IInternFactory internFactory)
		{
			ITypeReference targetType = pointer.TargetType;
		...
		public static ITypeReference SpecializeTypeReference(IManagedPointerTypeReference pointer, IMethodReference targetContainer, IInternFactory internFactory)
		{
			ITypeReference targetType = pointer.TargetType;
			ITypeReference specializedtargetType = TypeHelper.SpecializeTypeReference(targetType, targetContainer, internFactory);
			if (targetType == specializedtargetType)
		...
		/// </summary>
		public static ITypeReference DeepCopyTypeReferenceWRTSpecializedMethod(IManagedPointerTypeReference pointer, ISpecializedMethodReference specializedMethodReference, IInternFactory internFactory)
		{
			ITypeReference targetType = pointer.TargetType;
	...
	public class Matrix : ArrayType
	{
			...
			/*?*/			/*?*/		public Matrix(ITypeReference elementType, uint rank, IEnumerable<int> lowerBounds		, IEnumerable<ulong> sizes		, IInternFactory internFactory) : base(elementType, internFactory)
		{
			this.rank = rank;
		...
		public static ITypeReference DeepCopyTypeReference(IArrayTypeReference array, SpecializedNestedTypeDefinition targetContainer, IInternFactory internFactory)
		{
			...
			if (elementType == specializedElementType)
				return array;
		...
		///  /// <param name="internFactory">An intern factory. </param>
		//^ requires !array.IsVector;
		public static ITypeReference SpecializeTypeReference(IArrayTypeReference array, ITypeReference targetContainer, IInternFactory internFactory)
		{
			ITypeReference elementType = array.ElementType;
		...
		//^ requires !array.IsVector;
		public static ITypeReference SpecializeTypeReference(IArrayTypeReference array, IMethodReference targetContainer, IInternFactory internFactory)
		{
			ITypeReference elementType = array.ElementType;
			ITypeReference specializedElementType = TypeHelper.SpecializeTypeReference(elementType, targetContainer, internFactory);
			if (elementType == specializedElementType)
		...
		/// </summary>
		//^ requires !array.IsVector;
		public static ITypeReference DeepCopyTypeReferenceWRTSpecializedMethod(IArrayTypeReference array, ISpecializedMethodReference specializedMethodReference, IInternFactory internFactory)
		{
			ITypeReference elementType = array.ElementType;
	...
	public class PointerType : SystemDefinedStructuralType, IPointerType
	{
		...
		public PointerType(ITypeReference targetType, IInternFactory internFactory) : base(internFactory)
		{
			this.targetType = targetType;
		}
		...
		/// replace the occurrences of matching type parameters in <paramref name="pointer"/>.</param>
		///  /// <param name="internFactory">An intern factory. </param>
		public static ITypeReference DeepCopyTypeReference(IPointerTypeReference pointer, SpecializedNestedTypeDefinition targetContainer, IInternFactory internFactory)
		{
			ITypeReference targetType = pointer.TargetType;
			ITypeReference specializedtargetType = TypeDefinition.DeepCopyTypeReference(targetType, targetContainer, internFactory);
			if (targetType == specializedtargetType)
		...
		public static ITypeReference SpecializeTypeReference(IPointerTypeReference pointer, ITypeReference targetContainer, IInternFactory internFactory)
		{
			ITypeReference targetType = pointer.TargetType;
			ITypeReference specializedtargetType = TypeHelper.SpecializeTypeReference(targetType, targetContainer, internFactory);
			if (targetType == specializedtargetType)
		...
		public static ITypeReference SpecializeTypeReference(IPointerTypeReference pointer, IMethodReference targetContainer, IInternFactory internFactory)
		{
			ITypeReference targetType = pointer.TargetType;
			ITypeReference specializedtargetType = TypeHelper.SpecializeTypeReference(targetType, targetContainer, internFactory);
			if (targetType == specializedtargetType)
		...
		/// then return a new pointer using a target type that is the corresponding method type parameter from specializedMethodReference.
		/// </summary>
		public static ITypeReference DeepCopyTypeReferenceReplacingGenericMethodParameter(IPointerTypeReference pointer, ISpecializedMethodReference specializedMethodReference, IInternFactory internFactory)
		{
			ITypeReference targetType = pointer.TargetType;
			ITypeReference specializedtargetType = TypeDefinition.DeepCopyTypeReferenceWRTSpecializedMethod(targetType, specializedMethodReference, internFactory);
			if (targetType == specializedtargetType)
	...
	public class ModifiedPointerType : PointerType, IModifiedTypeReference
	{
		...
		public ModifiedPointerType(ITypeReference targetType, IEnumerable<ICustomModifier> customModifiers, IInternFactory internFactory) : base(targetType, internFactory)
		{
		...
		///  /// <param name="internFactory">An intern factory. </param>
		public static ITypeReference DeepCopyTypeReference(ModifiedPointerType modifiedPointer, SpecializedNestedTypeDefinition targetContainer, IInternFactory internFactory)
		{
			...
			foreach (var modifier in modifiedPointer.CustomModifiers) {
				...
				if (modifier != copiedModifier) {
					if (copiedModifiers == null)
						copiedModifiers = new List<ICustomModifier>(modifiedPointer.CustomModifiers);
					copiedModifiers[i] = copiedModifier;
				}
				i++;
			}
			if (copiedModifiers == null) {
				if (copiedTargetType == modifiedPointer.TargetType)
		...
		public static ITypeReference SpecializeTypeReference(ModifiedPointerType modifiedPointer, ITypeReference targetContainer, IInternFactory internFactory)
		{
		...
		public static ITypeReference SpecializeTypeReference(ModifiedPointerType modifiedPointer, IMethodReference targetContainer, IInternFactory internFactory)
		{
			var copiedTargetType = TypeHelper.SpecializeTypeReference(modifiedPointer.TargetType, targetContainer, internFactory);
			List<ICustomModifier> 			/*?*/copiedModifiers = null;
			int i = 0;
		...
		/// then return a new pointer using a target type that is the corresponding method type parameter from specializedMethodReference.
		/// </summary>
		public static ITypeReference DeepCopyTypeReferenceWRTSpecializedMethod(ModifiedPointerType modifiedPointer, ISpecializedMethodReference specializedMethodReference, IInternFactory internFactory)
		{
	...
	public class ModifiedTypeReference : IModifiedTypeReference
	{
		...
		public ModifiedTypeReference(IInternFactory internFactory, ITypeReference unmodifiedType, IEnumerable<ICustomModifier> customModifiers)
		{
			this.internFactory = internFactory;
		...
		///  /// <param name="internFactory">An intern factory. </param>
		public static ITypeReference DeepCopyTypeReference(IModifiedTypeReference modifiedTypeReference, SpecializedNestedTypeDefinition targetContainer, IInternFactory internFactory)
		{
			...
			foreach (var modifier in modifiedTypeReference.CustomModifiers) {
				...
				if (modifier != copiedModifier) {
					if (copiedModifiers == null)
						copiedModifiers = new List<ICustomModifier>(modifiedTypeReference.CustomModifiers);
					copiedModifiers[i] = copiedModifier;
				}
				i++;
			}
			if (copiedModifiers == null) {
				if (copiedUnmodifiedType == modifiedTypeReference.UnmodifiedType)
		...
		public static ITypeReference SpecializeTypeReference(IModifiedTypeReference modifiedTypeReference, ITypeReference targetContainer, IInternFactory internFactory)
		{
		...
		public static ITypeReference SpecializeTypeReference(IModifiedTypeReference modifiedTypeReference, IMethodReference targetContainer, IInternFactory internFactory)
		{
			ITypeReference copiedUnmodifiedType = TypeHelper.SpecializeTypeReference(modifiedTypeReference.UnmodifiedType, targetContainer, internFactory);
			List<ICustomModifier> 			/*?*/copiedModifiers = null;
			int i = 0;
		...
		/// </summary>
		public static ITypeReference DeepCopyTypeReferenceWRTSpecializedMethod(IModifiedTypeReference modifiedTypeReference, ISpecializedMethodReference specializedMethodReference, IInternFactory internFactory)
		{
	...
	public abstract class Scope<MemberType> : IScope<MemberType> where MemberType : class, INamedEntity
	{
		...
		public void AddMemberToCache(MemberType member		)
		{
		...
		public IEnumerable<MemberType> GetMembersNamed(IName name, bool ignoreCase)
		{
			...
			List<MemberType> 			/*?*/members;
			if (!nameToMemberListMap.TryGetValue(key, out members))
				return emptyList;
			//^ assume members != null; //Follows from the way Dictionary is instantiated, but the verifier is ignorant of this.
	...
	public abstract class SpecializedGenericParameter<ParameterType> : IGenericParameter where ParameterType : IGenericParameter
	{
		...
		/// <param name="internFactory"></param>
			/*!*/		public SpecializedGenericParameter(ParameterType partiallySpecializedParameter		, IInternFactory internFactory)
		{
		...
		public ParameterType PartiallySpecializedParameter {
			/*!*/			get { return this.unspecializedParameter; }
		}
	...
	public class SpecializedGenericTypeParameter : SpecializedGenericParameter<IGenericTypeParameter>, IGenericTypeParameter
	{
		...
		/// <param name="internFactory"></param>
		public SpecializedGenericTypeParameter(IGenericTypeParameter partiallySpecializedParameter, ISpecializedNestedTypeReference definingTypeInstance, IInternFactory internFactory) : base(partiallySpecializedParameter, internFactory)
		{
	...
	public class SpecializedNestedTypeDefinition : Scope<ITypeDefinitionMember>, ISpecializedNestedTypeDefinition, ISpecializedNestedTypeReference
	{
		...
		public static ITypeReference DeepCopyTypeReference(INestedTypeReference nestedType, SpecializedNestedTypeDefinition targetContainer, IInternFactory internFactory)
		{
			var parentCopy = TypeDefinition.DeepCopyTypeReference(nestedType.ContainingType, targetContainer, internFactory);
			if (parentCopy == nestedType.ContainingType)
				return nestedType;
			return new SpecializedNestedTypeReference(TypeHelper.Unspecialize(nestedType), parentCopy, internFactory);
		}

		public static ITypeReference SpecializeTypeReference(INestedTypeReference nestedType, ITypeReference targetContainer, IInternFactory internFactory)
		{
		...
		public static ITypeReference SpecializeTypeReference(INestedTypeReference nestedType, IMethodReference targetContainer, IInternFactory internFactory)
		{
			var parentCopy = TypeHelper.SpecializeTypeReference(nestedType.ContainingType, targetContainer, internFactory);
			if (parentCopy == nestedType.ContainingType)
				return nestedType;
		...
		public static ITypeReference DeepCopyTypeReferenceWRTSpecializedMethod(INestedTypeReference nestedType, ISpecializedMethodReference specializedMethodReference, IInternFactory internFactory)
		{
			...
			if (specializedParent == nestedType.ContainingType)
				return nestedType;
			return new SpecializedNestedTypeReference(TypeHelper.Unspecialize(nestedType), specializedParent, internFactory);
		}

		public static ITypeReference SpecializeIfConstructedFromApplicableTypeParameter(INestedTypeReference nestedType, IGenericMethodInstanceReference genericMethodInstance, IInternFactory internFactory)
		{
		...
		public static ITypeReference SpecializeIfConstructedFromApplicableTypeParameter(INestedTypeReference nestedType, IGenericTypeInstanceReference containingTypeInstance, IInternFactory internFactory)
		{
		...
		public readonly INestedTypeDefinition partiallySpecializedVersion;
		...
		public ITypeReference CopyAndSpecialize(ITypeReference partiallySpecializedTypeReference)
		{
		...
		public TypeMemberVisibility Visibility {
			get {
				if (this.visibility == TypeMemberVisibility.Default) {
					this.visibility = TypeHelper.VisibilityIntersection(this.partiallySpecializedVersion.Visibility, TypeHelper.TypeVisibilityAsTypeMemberVisibility(this.ContainingGenericTypeInstance));
				}
...
//^ ensures result == this.UnspecializedVersion.HasDeclarativeSecurity;
	...
	public abstract class SystemDefinedStructuralType : ITypeDefinition
	{
		...
		public SystemDefinedStructuralType(IInternFactory internFactory)
		{
			this.internFactory = internFactory;
		}
...
//^ ensures result == false;
	...
	public static class TypeDefinition
	{
		...
		/// <param name="internFactory">An intern factory.</param>
		public static ITypeReference DeepCopyTypeReference(ITypeReference partiallySpecializedTypeReference, SpecializedNestedTypeDefinition targetContainer, IInternFactory internFactory)
		{
			var arrayType = partiallySpecializedTypeReference as IArrayTypeReference;
			if (arrayType != null) {
				if (arrayType.IsVector)
					return Vector.DeepCopyTypeReference(arrayType, targetContainer, internFactory);
			...
			if (genericTypeParameter != null)
				return GenericParameter.DeepCopyTypeReference(genericTypeParameter, targetContainer);
			var genericTypeInstance = partiallySpecializedTypeReference as IGenericTypeInstanceReference;
			if (genericTypeInstance != null)
				return GenericTypeInstance.DeepCopyTypeReference(genericTypeInstance, targetContainer, internFactory);
			var managedPointerType = partiallySpecializedTypeReference as IManagedPointerTypeReference;
			if (managedPointerType != null)
				return ManagedPointerType.DeepCopyTypeReference(managedPointerType, targetContainer, internFactory);
			var modifiedPointer = partiallySpecializedTypeReference as ModifiedPointerType;
			if (modifiedPointer != null)
				return ModifiedPointerType.DeepCopyTypeReference(modifiedPointer, targetContainer, internFactory);
			var modifiedType = partiallySpecializedTypeReference as IModifiedTypeReference;
			if (modifiedType != null)
				return ModifiedTypeReference.DeepCopyTypeReference(modifiedType, targetContainer, internFactory);
			var nestedType = partiallySpecializedTypeReference as INestedTypeReference;
			if (nestedType != null)
				return SpecializedNestedTypeDefinition.DeepCopyTypeReference(nestedType, targetContainer, internFactory);
			var pointerType = partiallySpecializedTypeReference as IPointerTypeReference;
			if (pointerType != null)
				return PointerType.DeepCopyTypeReference(pointerType, targetContainer, internFactory);
		...
		/// </summary>
		public static ITypeReference SpecializeIfConstructedFromApplicableTypeParameter(ITypeReference partiallySpecializedTypeReference, IGenericMethodInstanceReference containingMethodInstance, IInternFactory internFactory)
		{
			var arrayType = partiallySpecializedTypeReference as IArrayTypeReference;
			if (arrayType != null) {
				if (arrayType.IsVector)
					return Vector.SpecializeIfConstructedFromApplicableTypeParameter(arrayType, containingMethodInstance, internFactory);
			...
			if (genericMethodParameter != null)
				return GenericParameter.SpecializeIfConstructedFromApplicableTypeParameter(genericMethodParameter, containingMethodInstance);
			var genericTypeInstance = partiallySpecializedTypeReference as IGenericTypeInstanceReference;
			if (genericTypeInstance != null)
				return GenericTypeInstance.SpecializeIfConstructedFromApplicableTypeParameter(genericTypeInstance, containingMethodInstance, internFactory);
			var managedPointerType = partiallySpecializedTypeReference as IManagedPointerTypeReference;
			if (managedPointerType != null)
				return ManagedPointerType.SpecializeIfConstructedFromApplicableTypeParameter(managedPointerType, containingMethodInstance, internFactory);
			var modifiedPointer = partiallySpecializedTypeReference as ModifiedPointerType;
			if (modifiedPointer != null)
				return ModifiedPointerType.SpecializeIfConstructedFromApplicableTypeParameter(modifiedPointer, containingMethodInstance, internFactory);
			var modifiedType = partiallySpecializedTypeReference as IModifiedTypeReference;
			if (modifiedType != null)
				return ModifiedTypeReference.SpecializeIfConstructedFromApplicableTypeParameter(modifiedType, containingMethodInstance, internFactory);
			var nestedType = partiallySpecializedTypeReference as INestedTypeReference;
			if (nestedType != null)
				return SpecializedNestedTypeDefinition.SpecializeIfConstructedFromApplicableTypeParameter(nestedType, containingMethodInstance, internFactory);
			var pointerType = partiallySpecializedTypeReference as IPointerTypeReference;
			if (pointerType != null)
				return PointerType.SpecializeIfConstructedFromApplicableTypeParameter(pointerType, containingMethodInstance, internFactory);
			return partiallySpecializedTypeReference;
		}
		...
		/// </summary>
		public static ITypeReference SpecializeIfConstructedFromApplicableTypeParameter(ITypeReference partiallySpecializedTypeReference, IGenericTypeInstanceReference containingTypeInstance, IInternFactory internFactory)
		{
			var arrayType = partiallySpecializedTypeReference as IArrayTypeReference;
			if (arrayType != null) {
				if (arrayType.IsVector)
					return Vector.SpecializeIfConstructedFromApplicableTypeParameter(arrayType, containingTypeInstance, internFactory);
				return Matrix.SpecializeIfConstructedFromApplicableTypeParameter(arrayType, containingTypeInstance, internFactory);
			}
			var genericTypeParameter = partiallySpecializedTypeReference as IGenericTypeParameterReference;
			if (genericTypeParameter != null)
				return GenericParameter.SpecializeIfConstructedFromApplicableTypeParameter(genericTypeParameter, containingTypeInstance);
			var genericTypeInstance = partiallySpecializedTypeReference as IGenericTypeInstanceReference;
			if (genericTypeInstance != null)
				return GenericTypeInstance.SpecializeIfConstructedFromApplicableTypeParameter(genericTypeInstance, containingTypeInstance, internFactory);
			var managedPointerType = partiallySpecializedTypeReference as IManagedPointerTypeReference;
			if (managedPointerType != null)
				return ManagedPointerType.SpecializeIfConstructedFromApplicableTypeParameter(managedPointerType, containingTypeInstance, internFactory);
			var modifiedPointer = partiallySpecializedTypeReference as ModifiedPointerType;
			if (modifiedPointer != null)
				return ModifiedPointerType.SpecializeIfConstructedFromApplicableTypeParameter(modifiedPointer, containingTypeInstance, internFactory);
			var modifiedType = partiallySpecializedTypeReference as IModifiedTypeReference;
			if (modifiedType != null)
				return ModifiedTypeReference.SpecializeIfConstructedFromApplicableTypeParameter(modifiedType, containingTypeInstance, internFactory);
			var nestedType = partiallySpecializedTypeReference as INestedTypeReference;
			if (nestedType != null)
				return SpecializedNestedTypeDefinition.SpecializeIfConstructedFromApplicableTypeParameter(nestedType, containingTypeInstance, internFactory);
			var pointerType = partiallySpecializedTypeReference as IPointerTypeReference;
			if (pointerType != null)
				return PointerType.SpecializeIfConstructedFromApplicableTypeParameter(pointerType, containingTypeInstance, internFactory);
			return partiallySpecializedTypeReference;
		}
		...
		/// </remarks>
		public static ITypeReference DeepCopyTypeReferenceWRTSpecializedMethod(ITypeReference partiallySpecializedTypeReference, ISpecializedMethodReference specializedMethodReference, IInternFactory internFactory)
		{
			var arrayType = partiallySpecializedTypeReference as IArrayTypeReference;
			if (arrayType != null) {
				if (arrayType.IsVector)
					return Vector.DeepCopyTypeReferenceWRTSpecializedMethod(arrayType, specializedMethodReference, internFactory);
				return Matrix.DeepCopyTypeReferenceWRTSpecializedMethod(arrayType, specializedMethodReference, internFactory);
			}
			var genericMethodParameter = partiallySpecializedTypeReference as IGenericMethodParameterReference;
			if (genericMethodParameter != null)
				return GenericParameter.DeepCopyTypeReferenceWRTSpecializedMethod(genericMethodParameter, specializedMethodReference);
			var genericTypeParameter = partiallySpecializedTypeReference as IGenericTypeParameterReference;
			if (genericTypeParameter != null)
				return GenericParameter.DeepCopyTypeReferenceWRTSpecializedMethod(genericTypeParameter, specializedMethodReference);
			var genericTypeInstance = partiallySpecializedTypeReference as IGenericTypeInstanceReference;
			if (genericTypeInstance != null)
				return GenericTypeInstance.DeepCopyTypeReferenceWRTSpecializedMethod(genericTypeInstance, specializedMethodReference, internFactory);
			var managedPointerType = partiallySpecializedTypeReference as IManagedPointerTypeReference;
			if (managedPointerType != null)
				return ManagedPointerType.DeepCopyTypeReferenceWRTSpecializedMethod(managedPointerType, specializedMethodReference, internFactory);
			var modifiedPointer = partiallySpecializedTypeReference as ModifiedPointerType;
			if (modifiedPointer != null)
				return ModifiedPointerType.DeepCopyTypeReferenceWRTSpecializedMethod(modifiedPointer, specializedMethodReference, internFactory);
			var modifiedType = partiallySpecializedTypeReference as IModifiedTypeReference;
			if (modifiedType != null)
				return ModifiedTypeReference.DeepCopyTypeReferenceWRTSpecializedMethod(modifiedType, specializedMethodReference, internFactory);
			var pointerType = partiallySpecializedTypeReference as IPointerTypeReference;
			if (pointerType != null)
				return PointerType.DeepCopyTypeReferenceReplacingGenericMethodParameter(pointerType, specializedMethodReference, internFactory);
			var nestedType = partiallySpecializedTypeReference as INestedTypeReference;
			if (nestedType != null)
				return SpecializedNestedTypeDefinition.DeepCopyTypeReferenceWRTSpecializedMethod(nestedType, specializedMethodReference, internFactory);
			return partiallySpecializedTypeReference;
		}
	}
	...
	public class Vector : ArrayType
	{
		...
		public Vector(ITypeReference elementType, IInternFactory internFactory) : base(elementType, internFactory)
		{
		}

		public override IEnumerable<ITypeReference> GetInterfaceList()
		{
			var coreAssembly = TypeHelper.GetDefiningUnitReference(this.PlatformType.SystemArray) as IAssemblyReference;
			var version = coreAssembly == null ? new Version(4, 0) : coreAssembly.AssemblyIdentity.Version;
