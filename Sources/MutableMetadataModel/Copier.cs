...
namespace Microsoft.Cci.MutableCodeModel
{
	...
	public class MetadataShallowCopier
	{
		...
		/// </summary>
		public IMetadataHost targetHost;

		IUnit 		/*?*/targetUnit;
		IInternFactory internFactory;

		public MetadataDispatcher Dispatcher {
			get {
		...
		public class MetadataDispatcher : MetadataVisitor
		{
			public MetadataShallowCopier copier;
		...
		/// Returns a shallow copy of the given field definition.
		/// </summary>
		public FieldDefinition CopyUnspecialized(IFieldDefinition fieldDefinition)
		{
			Contract.Requires(fieldDefinition != null);
			Contract.Ensures(Contract.Result<FieldDefinition>() != null);
		...
		/// Returns a shallow copy of the given field reference.
		/// </summary>
		public FieldReference CopyUnspecialized(IFieldReference fieldReference)
		{
			Contract.Requires(fieldReference != null);
			Contract.Ensures(Contract.Result<FieldReference>() != null);
		...
		/// Returns a shallow copy of the given method definition.
		/// </summary>
		public MethodDefinition CopyUnspecialized(IMethodDefinition method)
		{
		...
		/// Returns a shallow copy of the given method reference.
		/// </summary>
		public MethodReference CopyUnspecialized(IMethodReference methodReference)
		{
			Contract.Requires(methodReference != null);
			Contract.Ensures(Contract.Result<MethodReference>() != null);
		...
		public ModuleReference Copy(IModuleReference moduleReference)
		{
			...
			if (assemblyReference != null)
				return this.Copy(assemblyReference);
		...
		/// Returns a shallow copy of the given nested type definition.
		/// </summary>
		public NestedTypeDefinition CopyUnspecialized(INestedTypeDefinition nestedTypeDefinition)
		{
			Contract.Requires(nestedTypeDefinition != null);
			Contract.Ensures(Contract.Result<NestedTypeDefinition>() != null);
		...
		/// Returns a shallow copy of the given nested type reference.
		/// </summary>
		public NestedTypeReference CopyUnspecialized(INestedTypeReference nestedTypeReference)
		{
			Contract.Requires(nestedTypeReference != null);
			Contract.Ensures(Contract.Result<NestedTypeReference>() != null);
		...
		/// Returns a shallow copy of the given property definition.
		/// </summary>
		public PropertyDefinition CopyUnspecialized(IPropertyDefinition propertyDefinition)
		{
			Contract.Requires(propertyDefinition != null);
			Contract.Ensures(Contract.Result<PropertyDefinition>() != null);
	...
	public class MetadataDeepCopier
	{
		...
		/// </summary>
		/// <param name="targetHost">An object representing the application that will host the copies made by this copier.</param>
		public MetadataDeepCopier(IMetadataHost targetHost) : this(targetHost, new MetadataShallowCopier(targetHost))
		{
		...
		/// <param name="targetHost">An object representing the application that will host the copies made by this copier.</param>
		/// <param name="targetUnit">The unit of metadata into which copies made by this copier will be inserted.</param>
		public MetadataDeepCopier(IMetadataHost targetHost, IUnit targetUnit) : this(targetHost, new MetadataShallowCopier(targetHost, targetUnit))
		{
			Contract.Requires(targetHost != null);
		...
		public MetadataDeepCopier(IMetadataHost targetHost, MetadataShallowCopier shallowCopier)
		{
			Contract.Requires(targetHost != null);
		...
		public Substitutor SubstituteCopiesForOriginals {
			get {
		...
		public MetadataTraverser TraverseAndPopulateDefinitionCacheWithCopies {
			get {
		...
		public class MetadataDispatcher : MetadataVisitor
		{
			public MetadataDeepCopier copier;
			public object result;
		...
		/// 
		/// </summary>
		public class Populator : IMetadataVisitor
		{

			public Populator(MetadataShallowCopier shallowCopier, Hashtable<object, object> definitionCache)
			{
				this.shallowCopier = shallowCopier;
			...
			{
				if (this.definitionCache.ContainsKey(assembly))
					return;
			...
			{
				if (this.definitionCache.ContainsKey(fieldDefinition))
					return;
			...
			{
				if (this.definitionCache.ContainsKey(genericMethodParameter))
					return;
			...
			{
				if (this.definitionCache.ContainsKey(genericTypeParameter))
					return;
			...
			{
				if (this.definitionCache.ContainsKey(globalFieldDefinition))
					return;
			...
			{
				if (this.definitionCache.ContainsKey(globalMethodDefinition))
					return;
			...
			{
				if (this.definitionCache.ContainsKey(method))
					return;
			...
			{
				if (this.definitionCache.ContainsKey(module))
					return;
			...
			{
				if (this.definitionCache.ContainsKey(namespaceAliasForType))
					return;
			...
			{
				if (this.definitionCache.ContainsKey(namespaceTypeDefinition))
					return;
			...
			{
				if (this.definitionCache.ContainsKey(nestedAliasForType))
					return;
			...
			{
				if (this.definitionCache.ContainsKey(nestedTypeDefinition))
					return;
			...
			{
				if (this.definitionCache.ContainsKey(nestedUnitNamespace))
					return;
			...
			{
				if (this.definitionCache.ContainsKey(parameterDefinition))
					return;
			...
			public void Visit(IPropertyDefinition propertyDefinition)
			{
				...
				if (this.definitionCache.ContainsKey(propertyDefinition))
					return;
			...
			{
				if (this.definitionCache.ContainsKey(rootUnitNamespace))
					return;
		...
		public class Substitutor
		{
			...
			public Substitutor(IMetadataHost host, MetadataShallowCopier shallowCopier, MetadataDeepCopier deepCopier)
			{
				this.host = host;
				this.shallowCopier = shallowCopier;
			...
			public MetadataShallowCopier shallowCopier;
			...
			/// </summary>
			public Hashtable<object, object> DefinitionCache {
				get {
			...
			/// </summary>
			public Hashtable<object, object> ReferenceCache {
				get {
			...
			public IArrayTypeReference Substitute(IArrayTypeReference arrayTypeReference)
			{
				if (arrayTypeReference is Dummy)
					return arrayTypeReference;
				object copy;
				if (this.ReferenceCache.TryGetValue(arrayTypeReference, out copy))
					return (ArrayTypeReference)copy;
			...
			public IAssembly Substitute(IAssembly assembly)
			{
				if (assembly is Dummy)
			...
			public IAssemblyReference Substitute(IAssemblyReference assemblyReference, bool keepAsDefinition = true)
			{
				if (assemblyReference is Dummy)
					return assemblyReference;
				object copy;
				if (keepAsDefinition && this.DefinitionCache.TryGetValue(assemblyReference, out copy))
					return (IAssemblyReference)copy;
				if (this.ReferenceCache.TryGetValue(assemblyReference, out copy))
					return (AssemblyReference)copy;
			...
			public ICustomAttribute Substitute(ICustomAttribute customAttribute)
			{
				if (customAttribute is Dummy)
			...
			public ICustomModifier Substitute(ICustomModifier customModifier)
			{
				if (customModifier is Dummy)
			...
			public IDefinition Substitute(IDefinition definition)
			{
				if (definition is Dummy)
					return definition;
				definition.Dispatch(this.Dispatcher);
				return (IDefinition)this.Dispatcher.result;
			}

			public IEventDefinition Substitute(IEventDefinition eventDefinition)
			{
				if (eventDefinition is Dummy)
			...
			public IFieldDefinition Substitute(IFieldDefinition fieldDefinition)
			{
			...
			public IFieldReference Substitute(IFieldReference fieldReference, bool keepAsDefinition = true)
			{
				if (fieldReference is Dummy)
					return fieldReference;
				object copy;
				if (keepAsDefinition && this.DefinitionCache.TryGetValue(fieldReference, out copy))
					return (IFieldReference)copy;
				if (this.ReferenceCache.TryGetValue(fieldReference, out copy))
					return (FieldReference)copy;
			...
			public IFileReference Substitute(IFileReference fileReference)
			{
				if (fileReference is Dummy)
			...
			public IFunctionPointerTypeReference Substitute(IFunctionPointerTypeReference functionPointerTypeReference)
			{
				if (functionPointerTypeReference is Dummy)
					return functionPointerTypeReference;
				object copy;
				if (this.ReferenceCache.TryGetValue(functionPointerTypeReference, out copy))
					return (FunctionPointerTypeReference)copy;
			...
			public IGenericMethodInstanceReference Substitute(IGenericMethodInstanceReference genericMethodInstanceReference)
			{
				if (genericMethodInstanceReference is Dummy)
					return genericMethodInstanceReference;
				object copy;
				if (this.ReferenceCache.TryGetValue(genericMethodInstanceReference, out copy))
					return (GenericMethodInstanceReference)copy;
			...
			public IGenericMethodParameter Substitute(IGenericMethodParameter genericMethodParameter)
			{
				if (genericMethodParameter is Dummy)
			...
			public IGenericMethodParameterReference Substitute(IGenericMethodParameterReference genericMethodParameterReference, bool keepAsDefinition = true)
			{
				if (genericMethodParameterReference is Dummy)
					return genericMethodParameterReference;
				object copy;
				if (keepAsDefinition && this.DefinitionCache.TryGetValue(genericMethodParameterReference, out copy))
					return (IGenericMethodParameterReference)copy;
				if (this.ReferenceCache.TryGetValue(genericMethodParameterReference, out copy))
					return (GenericMethodParameterReference)copy;
			...
			public IGenericTypeInstanceReference Substitute(IGenericTypeInstanceReference genericTypeInstanceReference)
			{
				if (genericTypeInstanceReference is Dummy)
					return genericTypeInstanceReference;
				object copy;
				if (this.ReferenceCache.TryGetValue(genericTypeInstanceReference, out copy))
					return (GenericTypeInstanceReference)copy;
			...
			public IGenericTypeParameter Substitute(IGenericTypeParameter genericParameter)
			{
				if (genericParameter is Dummy)
			...
			public IGenericTypeParameterReference Substitute(IGenericTypeParameterReference genericTypeParameterReference, bool keepAsDefinition = true)
			{
				if (genericTypeParameterReference is Dummy)
					return genericTypeParameterReference;
				object copy;
				if (keepAsDefinition && this.DefinitionCache.TryGetValue(genericTypeParameterReference, out copy))
					return (IGenericTypeParameterReference)copy;
				if (this.ReferenceCache.TryGetValue(genericTypeParameterReference, out copy))
					return (GenericTypeParameterReference)copy;
			...
			public IManagedPointerTypeReference Substitute(IManagedPointerTypeReference managedPointerTypeReference)
			{
				if (managedPointerTypeReference is Dummy)
					return managedPointerTypeReference;
				object copy;
				if (this.ReferenceCache.TryGetValue(managedPointerTypeReference, out copy))
					return (ManagedPointerTypeReference)copy;
			...
			public IMarshallingInformation Substitute(IMarshallingInformation marshallingInformation)
			{
				if (marshallingInformation is Dummy)
				...
				if (mutableCopy.UnmanagedType == System.Runtime.InteropServices.UnmanagedType.SafeArray && (mutableCopy.SafeArrayElementSubtype == System.Runtime.InteropServices.VarEnum.VT_DISPATCH || mutableCopy.SafeArrayElementSubtype == System.Runtime.InteropServices.VarEnum.VT_UNKNOWN || mutableCopy.SafeArrayElementSubtype == System.Runtime.InteropServices.VarEnum.VT_RECORD))
			...
			public IMetadataConstant Substitute(IMetadataConstant constant)
			{
				if (constant is Dummy)
					return constant;
			...
			public IMetadataCreateArray Substitute(IMetadataCreateArray createArray)
			{
				if (createArray is Dummy)
					return createArray;
			...
			public IMetadataNamedArgument Substitute(IMetadataNamedArgument namedArgument)
			{
				if (namedArgument is Dummy)
			...
			public IMetadataTypeOf Substitute(IMetadataTypeOf typeOf)
			{
				if (typeOf is Dummy)
					return typeOf;
			...
			public IMethodBody Substitute(IMethodBody methodBody, IMethodDefinition method)
			{
			...
			public IMethodBody Substitute(MethodBody mutableCopy)
			{
			...
			public IMethodDefinition Substitute(IMethodDefinition method)
			{
				if (method is Dummy)
					return method;
			...
			public IMethodImplementation Substitute(IMethodImplementation methodImplementation)
			{
				if (methodImplementation is Dummy)
			...
			public IMethodReference Substitute(IMethodReference methodReference, bool keepAsDefinition = true)
			{
				if (methodReference is Dummy)
					return methodReference;
				object copy;
				if (keepAsDefinition && this.DefinitionCache.TryGetValue(methodReference, out copy))
					return (IMethodReference)copy;
				if (this.ReferenceCache.TryGetValue(methodReference, out copy))
					return (MethodReference)copy;
			...
			public IModifiedTypeReference Substitute(IModifiedTypeReference modifiedTypeReference)
			{
				if (modifiedTypeReference is Dummy)
					return modifiedTypeReference;
				object copy;
				if (this.ReferenceCache.TryGetValue(modifiedTypeReference, out copy))
					return (ModifiedTypeReference)copy;
			...
			public IModule Substitute(IModule module)
			{
				if (module is Dummy)
					return module;
			...
			public IModuleReference Substitute(IModuleReference moduleReference, bool keepAsDefinition = true)
			{
				if (moduleReference is Dummy)
					return moduleReference;
				object copy;
				if (keepAsDefinition && this.DefinitionCache.TryGetValue(moduleReference, out copy))
					return (IModuleReference)copy;
				if (this.ReferenceCache.TryGetValue(moduleReference, out copy))
					return (ModuleReference)copy;
			...
			public INamespaceAliasForType Substitute(INamespaceAliasForType namespaceAliasForType)
			{
				if (namespaceAliasForType is Dummy)
			...
			public INamespaceTypeDefinition Substitute(INamespaceTypeDefinition namespaceTypeDefinition)
			{
				if (namespaceTypeDefinition is Dummy)
			...
			public INamespaceTypeReference Substitute(INamespaceTypeReference namespaceTypeReference, bool keepAsDefinition = true)
			{
				if (namespaceTypeReference is Dummy)
					return namespaceTypeReference;
				object copy;
				if (keepAsDefinition && this.DefinitionCache.TryGetValue(namespaceTypeReference, out copy))
					return (INamespaceTypeReference)copy;
				if (this.ReferenceCache.TryGetValue(namespaceTypeReference, out copy))
					return (NamespaceTypeReference)copy;
			...
			public INestedAliasForType Substitute(INestedAliasForType nestedAliasForType)
			{
				if (nestedAliasForType is Dummy)
			...
			public INestedTypeDefinition Substitute(INestedTypeDefinition nestedTypeDefinition)
			{
				if (nestedTypeDefinition is Dummy)
			...
			public INestedTypeReference Substitute(INestedTypeReference nestedTypeReference, bool keepAsDefinition = true)
			{
				if (nestedTypeReference is Dummy)
					return nestedTypeReference;
				object copy;
				if (keepAsDefinition && this.DefinitionCache.TryGetValue(nestedTypeReference, out copy))
					return (INestedTypeReference)copy;
				if (this.ReferenceCache.TryGetValue(nestedTypeReference, out copy))
					return (NestedTypeReference)copy;
			...
			public INestedUnitNamespace Substitute(INestedUnitNamespace nestedUnitNamespace)
			{
				if (nestedUnitNamespace is Dummy)
			...
			public INestedUnitNamespaceReference Substitute(INestedUnitNamespaceReference nestedUnitNamespaceReference, bool keepAsDefinition = true)
			{
				if (nestedUnitNamespaceReference is Dummy)
					return nestedUnitNamespaceReference;
				object copy;
				if (keepAsDefinition && this.DefinitionCache.TryGetValue(nestedUnitNamespaceReference, out copy))
					return (INestedUnitNamespaceReference)copy;
				if (this.ReferenceCache.TryGetValue(nestedUnitNamespaceReference, out copy))
					return (NestedUnitNamespaceReference)copy;
			...
			public IOperation Substitute(IOperation operation)
			{
				if (operation is Dummy)
					return Dummy.Operation;
				var mutableCopy = this.shallowCopier.Copy(operation);
				if (mutableCopy.Value == null)
					return mutableCopy;
			...
			public IOperationExceptionInformation Substitute(IOperationExceptionInformation operationExceptionInformation)
			{
				if (operationExceptionInformation is Dummy)
			...
			public IParameterDefinition Substitute(IParameterDefinition parameterDefinition)
			{
				if (parameterDefinition is Dummy)
			...
			public IParameterTypeInformation Substitute(IParameterTypeInformation parameterTypeInformation, bool keepAsDefinition = true)
			{
				if (parameterTypeInformation is Dummy)
					return parameterTypeInformation;
				object copy;
				if (keepAsDefinition && this.DefinitionCache.TryGetValue(parameterTypeInformation, out copy))
					return (IParameterTypeInformation)copy;
				if (this.ReferenceCache.TryGetValue(parameterTypeInformation, out copy))
					return (ParameterTypeInformation)copy;
			...
			public IPESection Substitute(IPESection peSection)
			{
				if (peSection is Dummy)
					return peSection;
				var mutableCopy = this.shallowCopier.Copy(peSection);
				return mutableCopy;
			}

			public IPlatformInvokeInformation Substitute(IPlatformInvokeInformation platformInvokeInformation)
			{
				if (platformInvokeInformation is Dummy)
			...
			public IPointerTypeReference Substitute(IPointerTypeReference pointerTypeReference)
			{
				if (pointerTypeReference is Dummy)
					return pointerTypeReference;
				object copy;
				if (this.ReferenceCache.TryGetValue(pointerTypeReference, out copy))
					return (PointerTypeReference)copy;
			...
			public IPropertyDefinition Substitute(IPropertyDefinition propertyDefinition)
			{
				if (propertyDefinition is Dummy)
			...
			public IResourceReference Substitute(IResourceReference resourceReference)
			{
				if (resourceReference is Dummy)
			...
			public IRootUnitNamespace Substitute(IRootUnitNamespace rootUnitNamespace)
			{
				if (rootUnitNamespace is Dummy)
			...
			public IRootUnitNamespaceReference Substitute(IRootUnitNamespaceReference rootUnitNamespaceReference, bool keepAsDefinition = true)
			{
				if (rootUnitNamespaceReference is Dummy)
					return rootUnitNamespaceReference;
				object copy;
				if (keepAsDefinition && this.DefinitionCache.TryGetValue(rootUnitNamespaceReference, out copy))
					return (IRootUnitNamespaceReference)copy;
				if (this.ReferenceCache.TryGetValue(rootUnitNamespaceReference, out copy))
					return (RootUnitNamespaceReference)copy;
			...
			public ISecurityAttribute Substitute(ISecurityAttribute securityAttribute)
			{
				if (securityAttribute is Dummy)
			...
			public ISpecializedFieldReference Substitute(ISpecializedFieldReference fieldReference)
			{
				if (fieldReference is Dummy)
					return fieldReference;
				object copy;
				if (this.DefinitionCache.TryGetValue(fieldReference, out copy))
					return (ISpecializedFieldReference)copy;
				if (this.ReferenceCache.TryGetValue(fieldReference, out copy))
					return (SpecializedFieldReference)copy;
				var mutableCopy = this.shallowCopier.Copy(fieldReference);
				this.ReferenceCache.Add(fieldReference, mutableCopy);
			...
			public ISpecializedMethodReference Substitute(ISpecializedMethodReference methodReference)
			{
				if (methodReference is Dummy)
					return methodReference;
				object copy;
				if (this.DefinitionCache.TryGetValue(methodReference, out copy))
					return (ISpecializedMethodReference)copy;
				if (this.ReferenceCache.TryGetValue(methodReference, out copy))
					return (SpecializedMethodReference)copy;
				var mutableCopy = this.shallowCopier.Copy(methodReference);
				this.ReferenceCache.Add(methodReference, mutableCopy);
				this.Substitute((MethodReference)mutableCopy);
				mutableCopy.UnspecializedVersion = this.Substitute(mutableCopy.UnspecializedVersion);
			...
			public ISpecializedNestedTypeReference Substitute(ISpecializedNestedTypeReference nestedTypeReference)
			{
				if (nestedTypeReference is Dummy)
					return nestedTypeReference;
				object copy;
				if (this.DefinitionCache.TryGetValue(nestedTypeReference, out copy))
					return (ISpecializedNestedTypeReference)copy;
				if (this.ReferenceCache.TryGetValue(nestedTypeReference, out copy))
					return (SpecializedNestedTypeReference)copy;
				var mutableCopy = this.shallowCopier.Copy(nestedTypeReference);
				this.ReferenceCache.Add(nestedTypeReference, mutableCopy);
			...
			public IWin32Resource Substitute(IWin32Resource win32Resource)
			{
				if (win32Resource is Dummy)
					return win32Resource;
				var mutableCopy = this.shallowCopier.Copy(win32Resource);
				return mutableCopy;
			}

			public void Substitute(AliasForType mutableCopy)
			{
			...
			public void Substitute(EventDefinition mutableCopy)
			{
			...
			public void Substitute(FieldDefinition mutableCopy)
			{
				this.Substitute((TypeDefinitionMember)mutableCopy);
			...
			public void Substitute(GenericParameter mutableCopy)
			{
				this.Substitute((NamedTypeDefinition)mutableCopy);
				this.SubstituteElements(mutableCopy.Constraints);
			}

			public void Substitute(MetadataExpression mutableCopy)
			{
				mutableCopy.Type = this.SubstituteViaDispatcher(mutableCopy.Type);
			}

			public void Substitute(MethodDefinition mutableCopy)
			{
				this.Substitute((TypeDefinitionMember)mutableCopy);
			...
			public void Substitute(MethodReference mutableCopy)
			{
				this.SubstituteElements(mutableCopy.Attributes);
				mutableCopy.ContainingType = this.SubstituteViaDispatcher(mutableCopy.ContainingType);
			...
			public void Substitute(Module mutableCopy)
			{
			...
			public void Substitute(NamespaceTypeDefinition mutableCopy)
			{
				this.Substitute((NamedTypeDefinition)mutableCopy);
				object copy;
				if (this.DefinitionCache.TryGetValue(mutableCopy.ContainingUnitNamespace, out copy))
			...
			public void Substitute(NamespaceTypeReference namespaceTypeReference)
			{
			...
			public void Substitute(NestedTypeDefinition mutableCopy)
			{
				this.Substitute((NamedTypeDefinition)mutableCopy);
				object copy;
			...
			public void Substitute(NestedTypeReference mutableCopy)
			{
				this.Substitute((TypeReference)mutableCopy);
				mutableCopy.ContainingType = this.SubstituteViaDispatcher(mutableCopy.ContainingType);
			}

			public void Substitute(PropertyDefinition mutableCopy)
			{
				this.Substitute((TypeDefinitionMember)mutableCopy);
				this.SubstituteElements(mutableCopy.Accessors);
				if (mutableCopy.HasDefaultValue)
			...
			public void Substitute(NamedTypeDefinition mutableCopy)
			{
				this.SubstituteElements(mutableCopy.Attributes);
			...
			public void Substitute(TypeDefinitionMember mutableCopy)
			{
				this.SubstituteElements(mutableCopy.Attributes);
				object copy;
				if (this.DefinitionCache.TryGetValue(mutableCopy.ContainingTypeDefinition, out copy))
			...
			public void Substitute(TypeReference mutableCopy)
			{
				this.SubstituteElements(mutableCopy.Attributes);
				mutableCopy.InternFactory = this.host.InternFactory;
				mutableCopy.PlatformType = this.host.PlatformType;
			...
			public void Substitute(UnitNamespace mutableCopy)
			{
				this.SubstituteElements(mutableCopy.Attributes);
				this.SubstituteElements(mutableCopy.Members);
				object copy;
			...
			public void Substitute(UnitNamespaceReference mutableCopy)
			{
				this.SubstituteElements(mutableCopy.Attributes);
			}

				/*?*/			public void SubstituteElements(List<IAliasForType> aliasesForTypes			)
			{
				...
				/*?*/			public void SubstituteElements(List<IAliasMember> aliasesMembers			)
			{
				if (aliasesMembers == null)
					return;
				...
				/*?*/			public void SubstituteElements(List<IAssemblyReference> assemblyReferences			)
			{
				...
				/*?*/			public void SubstituteElements(List<ICustomAttribute> customAttributes			)
			{
				...
				/*?*/			public void SubstituteElements(List<ICustomModifier> customModifiers			)
			{
				...
				/*?*/			public void SubstituteElements(List<IEventDefinition> events			)
			{
				if (events == null)
					return;
				...
				/*?*/			public void SubstituteElements(List<IFieldDefinition> fields			)
			{
				if (fields == null)
					return;
				...
				/*?*/			public void SubstituteElements(List<IFileReference> fileReferences			)
			{
				...
				/*?*/			public void SubstituteElements(List<IGenericMethodParameter> genericParameters			)
			{
				...
				/*?*/			public void SubstituteElements(List<IGenericTypeParameter> genericParameters			)
			{
				if (genericParameters == null)
					return;
				for (int i = 0, n = genericParameters.Count; i < n; i++)
				...
				/*?*/			public void SubstituteElements(List<ILocalDefinition> localDefinitions			)
			{
				...
				/*?*/			public void SubstituteElements(List<IMetadataExpression> expressions			)
			{
				if (expressions == null)
					return;
				...
				/*?*/			public void SubstituteElements(List<IMetadataNamedArgument> namedArguments			)
			{
				...
				/*?*/			public void SubstituteElements(List<IMethodDefinition> methods			)
			{
				if (methods == null)
					return;
				...
				/*?*/			public void SubstituteElements(List<IMethodImplementation> methodImplementations			)
			{
				...
				/*?*/			public void SubstituteElements(List<IMethodReference> methodReferences			)
			{
				...
				/*?*/			public void SubstituteElements(List<IModule> modules			)
			{
				if (modules == null)
					return;
				...
				/*?*/			public void SubstituteElements(List<IModuleReference> moduleReferences			)
			{
				...
				/*?*/			public void SubstituteElements(List<INamespaceMember> namespaceMembers			)
			{
				...
				/*?*/			public void SubstituteElements(List<INestedTypeDefinition> nestedTypes			)
			{
				if (nestedTypes == null)
					return;
				...
				/*?*/			public void SubstituteElements(List<IOperation> operations			)
			{
				if (operations == null)
					return;
				...
				/*?*/			public void SubstituteElements(List<IOperationExceptionInformation> operationExceptionInformations			)
			{
				if (operationExceptionInformations == null)
					return;
				...
				/*?*/			public void SubstituteElements(List<IParameterDefinition> parameters			)
			{
				if (parameters == null)
					return;
				...
				/*?*/			public void SubstituteElements(List<IParameterTypeInformation> parameterTypeInformations			)
			{
				if (parameterTypeInformations == null)
					return;
				...
				/*?*/			public void SubstituteElements(List<IPropertyDefinition> properties			)
			{
				if (properties == null)
					return;
				...
				/*?*/			public void SubstituteElements(List<IResourceReference> resourceReferences			)
			{
				...
				/*?*/			public void SubstituteElements(List<ISecurityAttribute> securityAttributes			)
			{
				...
				/*?*/			public void SubstituteElements(List<ITypeDefinitionMember> typeMembers			)
			{
				if (typeMembers == null)
					return;
				...
				/*?*/			public void SubstituteElements(List<ITypeReference> typeReferences			)
			{
				if (typeReferences == null)
					return;
				...
				/*?*/			public void SubstituteElements(List<IWin32Resource> win32Resources			)
			{
			...
			public ILocalDefinition SubstituteReference(ILocalDefinition localDefinition)
			{
				if (localDefinition is Dummy)
					return localDefinition;
				object copy;
				if (this.DefinitionCache.TryGetValue(localDefinition, out copy))
					return (ILocalDefinition)copy;
			...
			public INamespaceAliasForType SubstituteReference(INamespaceAliasForType namespaceAliasForType)
			{
				if (namespaceAliasForType is Dummy)
					return namespaceAliasForType;
				object copy;
				if (this.DefinitionCache.TryGetValue(namespaceAliasForType, out copy))
					return (NamespaceAliasForType)copy;
			...
			public INestedAliasForType SubstituteReference(INestedAliasForType nestedAliasForType)
			{
				if (nestedAliasForType is Dummy)
					return nestedAliasForType;
				object copy;
				if (this.DefinitionCache.TryGetValue(nestedAliasForType, out copy))
					return (NestedAliasForType)copy;
				//If we get here, the alias is outside of the cone and we just use it as is since aliases do not have independent reference objects. 
				return nestedAliasForType;
			}

			public IParameterDefinition SubstituteReference(IParameterDefinition parameterDefinition)
			{
				if (parameterDefinition is Dummy)
					return parameterDefinition;
				object copy;
				if (this.DefinitionCache.TryGetValue(parameterDefinition, out copy))
					return (IParameterDefinition)copy;
			...
			public IPropertyDefinition SubstituteReference(IPropertyDefinition propertyDefinition)
			{
				if (propertyDefinition is Dummy)
					return propertyDefinition;
				object copy;
				if (this.DefinitionCache.TryGetValue(propertyDefinition, out copy))
					return (IPropertyDefinition)copy;
			...
			public IAliasForType SubstituteViaDispatcher(IAliasForType aliasForType)
			{
				if (aliasForType is Dummy)
					return aliasForType;
				aliasForType.Dispatch(this.Dispatcher);
				return (IAliasForType)this.Dispatcher.result;
			}

			public IFieldReference SubstituteViaDispatcher(IFieldReference fieldReference)
			{
				if (fieldReference is Dummy)
					return fieldReference;
				fieldReference.DispatchAsReference(this.Dispatcher);
			...
			public IMetadataExpression SubstituteViaDispatcher(IMetadataExpression metadataExpression)
			{
				if (metadataExpression is Dummy)
					return metadataExpression;
				metadataExpression.Dispatch(this.Dispatcher);
				return (IMetadataExpression)this.Dispatcher.result;
			}

			public IMethodReference SubstituteViaDispatcher(IMethodReference methodReference)
			{
				if (methodReference is Dummy)
					return methodReference;
				methodReference.DispatchAsReference(this.Dispatcher);
			...
			public INamedTypeDefinition SubstituteViaDispatcher(INamedTypeDefinition typeDefinition)
			{
			...
			public INamedTypeReference SubstituteViaDispatcher(INamedTypeReference namedTypeReference)
			{
				if (namedTypeReference is Dummy)
			...
			public INamespaceMember SubstituteViaDispatcher(INamespaceMember namespaceMember)
			{
				if (namespaceMember is Dummy)
					return namespaceMember;
				namespaceMember.Dispatch(this.Dispatcher);
				return (INamespaceMember)this.Dispatcher.result;
			}

			public ITypeDefinitionMember SubstituteViaDispatcher(ITypeDefinitionMember typeDefinitionMember)
			{
				if (typeDefinitionMember is Dummy)
			...
			public ITypeReference SubstituteViaDispatcher(ITypeReference typeReference)
			{
			...
			public IUnitNamespaceReference SubstituteViaDispatcher(IUnitNamespaceReference unitNamespaceReference)
			{
				if (unitNamespaceReference is Dummy)
			...
			public IUnitReference SubstituteViaDispatcher(IUnitReference unitReference)
			{
				if (unitReference is Dummy)
		...
		/// </summary>
		public virtual IMethodBody CopyMethodBody(IMethodBody methodBody, IMethodDefinition method)
		{
			Contract.Requires(methodBody != null);
			Contract.Requires(method != null);
		...
		/// </summary>
		public IParameterDefinition GetExistingCopyIfInsideCone(IParameterDefinition parameter)
		{
		...
		/// </summary>
		public IPropertyDefinition GetExistingCopyIfInsideCone(IPropertyDefinition propertyDefinition)
		{
			Contract.Requires(propertyDefinition != null);
	...
	public class MetadataCopier
	{
		...
		/// </summary>
		public List<INamedTypeDefinition> flatListOfTypes = new List<INamedTypeDefinition>();
		/// <summary>
		/// A metadata host.
		/// </summary>
		...
		/// <returns></returns>
		public AliasForType GetMutableShallowCopy(IAliasForType aliasForType)
		{
		...
		/// <returns></returns>
		public AssemblyReference GetMutableShallowCopy(IAssemblyReference assemblyReference)
		{
		...
		/// <returns></returns>
		public CustomAttribute GetMutableShallowCopy(ICustomAttribute customAttribute)
		{
		...
		/// <returns></returns>
		public CustomModifier GetMutableShallowCopy(ICustomModifier customModifier)
		{
		...
		/// <returns></returns>
		public EventDefinition GetMutableShallowCopy(IEventDefinition eventDefinition)
		{
		...
		/// <returns></returns>
		public FieldDefinition GetMutableShallowCopy(IFieldDefinition fieldDefinition)
		{
		...
		/// <returns></returns>
		public FieldReference GetMutableShallowCopy(IFieldReference fieldReference)
		{
		...
		/// <returns></returns>
		public FileReference GetMutableShallowCopy(IFileReference fileReference)
		{
		...
		/// <returns></returns>
		public FunctionPointerTypeReference GetMutableShallowCopy(IFunctionPointerTypeReference functionPointerTypeReference)
		{
		...
		/// <returns></returns>
		public GenericMethodInstanceReference GetMutableShallowCopy(IGenericMethodInstanceReference genericMethodInstanceReference)
		{
		...
		/// <returns></returns>
		public GenericMethodParameter GetMutableShallowCopy(IGenericMethodParameter genericMethodParameter)
		{
		...
		/// <returns></returns>
		public GenericMethodParameterReference GetMutableShallowCopy(IGenericMethodParameterReference genericMethodParameterReference)
		{
		...
		/// <returns></returns>
		public GenericTypeInstanceReference GetMutableShallowCopy(IGenericTypeInstanceReference genericTypeInstanceReference)
		{
		...
		/// <returns></returns>
		public GenericTypeParameter GetMutableShallowCopy(IGenericTypeParameter genericTypeParameter)
		{
		...
		/// <returns></returns>
		public GenericTypeParameterReference GetMutableShallowCopy(IGenericTypeParameterReference genericTypeParameterReference)
		{
		...
		/// <returns></returns>
		public GlobalFieldDefinition GetMutableShallowCopy(IGlobalFieldDefinition globalFieldDefinition)
		{
		...
		/// <returns></returns>
		public GlobalMethodDefinition GetMutableShallowCopy(IGlobalMethodDefinition globalMethodDefinition)
		{
		...
		/// <returns></returns>
		public LocalDefinition GetMutableShallowCopy(ILocalDefinition localDefinition)
		{
		...
		/// <returns></returns>
		public ManagedPointerTypeReference GetMutableShallowCopy(IManagedPointerTypeReference managedPointerTypeReference)
		{
		...
		/// <returns></returns>
		public MarshallingInformation GetMutableShallowCopy(IMarshallingInformation marshallingInformation)
		{
		...
		/// <returns></returns>
		public MetadataConstant GetMutableShallowCopy(IMetadataConstant metadataConstant)
		{
		...
		/// <returns></returns>
		public MetadataCreateArray GetMutableShallowCopy(IMetadataCreateArray metadataCreateArray)
		{
		...
		/// <returns></returns>
		public MetadataNamedArgument GetMutableShallowCopy(IMetadataNamedArgument metadataNamedArgument)
		{
		...
		/// <returns></returns>
		public MetadataTypeOf GetMutableShallowCopy(IMetadataTypeOf metadataTypeOf)
		{
		...
		/// <returns></returns>
		public MethodDefinition GetMutableShallowCopy(IMethodDefinition methodDefinition)
		{
		...
		/// <returns></returns>
		public MethodBody GetMutableShallowCopy(IMethodBody methodBody)
		{
		...
		/// <returns></returns>
		public MethodImplementation GetMutableShallowCopy(IMethodImplementation methodImplementation)
		{
		...
		/// <returns></returns>
		public MethodReference GetMutableShallowCopy(IMethodReference methodReference)
		{
		...
		/// <returns></returns>
		public ModifiedTypeReference GetMutableShallowCopy(IModifiedTypeReference modifiedTypeReference)
		{
		...
		/// <returns></returns>
		public Module GetMutableShallowCopy(IModule module)
		{
			Module 			/*?*/result;
			object 			/*?*/cachedValue = null;
		...
		/// <returns></returns>
		public ModuleReference GetMutableShallowCopy(IModuleReference moduleReference)
		{
		...
		/// <returns></returns>
		public NamespaceAliasForType GetMutableShallowCopy(INamespaceAliasForType namespaceAliasForType)
		{
		...
		/// <returns></returns>
		public NamespaceTypeDefinition GetMutableShallowCopy(INamespaceTypeDefinition namespaceTypeDefinition)
		{
		...
		/// <returns></returns>
		public NamespaceTypeReference GetMutableShallowCopy(INamespaceTypeReference namespaceTypeReference)
		{
		...
		/// <returns></returns>
		public NestedAliasForType GetMutableShallowCopy(INestedAliasForType nestedAliasForType)
		{
		...
		/// <returns></returns>
		public NestedTypeDefinition GetMutableShallowCopy(INestedTypeDefinition nestedTypeDefinition)
		{
		...
		/// <returns></returns>
		public NestedTypeReference GetMutableShallowCopy(INestedTypeReference nestedTypeReference)
		{
		...
		/// <returns></returns>
		public NestedUnitNamespace GetMutableShallowCopy(INestedUnitNamespace nestedUnitNamespace)
		{
		...
		/// <returns></returns>
		public NestedUnitNamespaceReference GetMutableShallowCopy(INestedUnitNamespaceReference nestedUnitNamespaceReference)
		{
		...
		/// <returns></returns>
		public Operation GetMutableShallowCopy(IOperation operation)
		{
		...
		/// <returns></returns>
		public OperationExceptionInformation GetMutableShallowCopy(IOperationExceptionInformation operationExceptionInformation)
		{
		...
		/// <returns></returns>
		public ParameterDefinition GetMutableShallowCopy(IParameterDefinition parameterDefinition)
		{
		...
		/// <returns></returns>
		public ParameterTypeInformation GetMutableShallowCopy(IParameterTypeInformation parameterTypeInformation)
		{
		...
		/// <returns></returns>
		public PESection GetMutableShallowCopy(IPESection peSection)
		{
		...
		/// <returns></returns>
		public PlatformInvokeInformation GetMutableShallowCopy(IPlatformInvokeInformation platformInvokeInformation)
		{
		...
		/// <returns></returns>
		public PointerTypeReference GetMutableShallowCopy(IPointerTypeReference pointerTypeReference)
		{
		...
		/// <returns></returns>
		public PropertyDefinition GetMutableShallowCopy(IPropertyDefinition propertyDefinition)
		{
		...
		/// <returns></returns>
		public ResourceReference GetMutableShallowCopy(IResourceReference resourceReference)
		{
		...
		/// <returns></returns>
		public RootUnitNamespace GetMutableShallowCopy(IRootUnitNamespace rootUnitNamespace)
		{
		...
		/// <returns></returns>
		public RootUnitNamespaceReference GetMutableShallowCopy(IRootUnitNamespaceReference rootUnitNamespaceReference)
		{
		...
		/// <returns></returns>
		public SectionBlock GetMutableShallowCopy(ISectionBlock sectionBlock)
		{
			SectionBlock 			/*?*/result;
			object 			/*?*/cachedValue = null;
		...
		/// <returns></returns>
		public SecurityAttribute GetMutableShallowCopy(ISecurityAttribute securityAttribute)
		{
		...
		/// <returns></returns>
		public SpecializedFieldReference GetMutableShallowCopy(ISpecializedFieldReference specializedFieldReference)
		{
		...
		/// <returns></returns>
		public SpecializedMethodReference GetMutableShallowCopy(ISpecializedMethodReference specializedMethodReference)
		{
		...
		/// <returns></returns>
		public SpecializedNestedTypeReference GetMutableShallowCopy(ISpecializedNestedTypeReference specializedNestedTypeReference)
		{
		...
		/// <returns></returns>
		public Win32Resource GetMutableShallowCopy(IWin32Resource win32Resource)
		{
		...
		/// <returns></returns>
		public MatrixTypeReference GetMutableMatrixShallowCopy(IArrayTypeReference matrixTypeReference)
		{
		...
		/// <returns></returns>
		public VectorTypeReference GetMutableVectorShallowCopy(IArrayTypeReference vectorTypeReference)
		{
		...
		/// <param name="methodReference"></param>
		/// <returns></returns>
		public IMethodReference GetTypeSpecificMutableShallowCopy(IMethodReference methodReference)
		{
		...
		/// <param name="aliasForType"></param>
		/// <returns></returns>
		public virtual AliasForType DeepCopy(AliasForType aliasForType)
		{
		...
		/// <returns></returns>
		public virtual Assembly DeepCopy(Assembly assembly)
		{
		...
		public virtual AssemblyReference DeepCopy(AssemblyReference assemblyReference)
		{
			...
			return assemblyReference;
			//a shallow copy is also deep in this case.
		}
		...
		/// <returns></returns>
		public virtual CustomAttribute DeepCopy(CustomAttribute customAttribute)
		{
		...
		/// <returns></returns>
		public virtual CustomModifier DeepCopy(CustomModifier customModifier)
		{
		...
		/// <returns></returns>
		public virtual EventDefinition DeepCopy(EventDefinition eventDefinition)
		{
			...
			if (eventDefinition.Accessors.Count > 0) {
				if (eventDefinition.Adder == eventDefinition.Accessors[0])
					adderIndex = 0; else if (eventDefinition.Remover == eventDefinition.Accessors[0])
					removerIndex = 0;
			}
			if (eventDefinition.Accessors.Count > 1) {
				if (eventDefinition.Adder == eventDefinition.Accessors[1])
					adderIndex = 1; else if (eventDefinition.Remover == eventDefinition.Accessors[1])
					removerIndex = 1;
			}
		...
		/// <returns></returns>
		public virtual FieldDefinition DeepCopy(FieldDefinition fieldDefinition)
		{
		...
		/// <returns></returns>
		public virtual FieldReference DeepCopy(FieldReference fieldReference)
		{
		...
		/// <returns></returns>
		public virtual FileReference DeepCopy(FileReference fileReference)
		{
			return fileReference;
		}
		...
		/// <returns></returns>
		public virtual FunctionPointerTypeReference DeepCopy(FunctionPointerTypeReference functionPointerTypeReference)
		{
		...
		/// <returns></returns>
		public virtual GenericMethodInstanceReference DeepCopy(GenericMethodInstanceReference genericMethodInstanceReference)
		{
		...
		/// <returns></returns>
		public virtual List<IGenericMethodParameter> DeepCopy(		/*?*/			/*?*/List<IGenericMethodParameter> genericMethodParameters		, IMethodDefinition declaringMethod)
		{
		...
		/// <returns></returns>
		public virtual GenericMethodParameter DeepCopy(GenericMethodParameter genericMethodParameter)
		{
		...
		/// <returns></returns>
		public virtual GenericMethodParameterReference DeepCopy(GenericMethodParameterReference genericMethodParameterReference)
		{
		...
		/// <returns></returns>
		public virtual GenericTypeParameterReference DeepCopy(GenericTypeParameterReference genericTypeParameterReference)
		{
		...
		/// <returns></returns>
		public virtual GlobalFieldDefinition DeepCopy(GlobalFieldDefinition globalFieldDefinition)
		{
		...
		/// <returns></returns>
		public virtual GlobalMethodDefinition DeepCopy(GlobalMethodDefinition globalMethodDefinition)
		{
		...
		/// <returns></returns>
		public virtual GenericTypeInstanceReference DeepCopy(GenericTypeInstanceReference genericTypeInstanceReference)
		{
		...
		/// <returns></returns>
		public virtual GenericParameter DeepCopy(GenericParameter genericParameter)
		{
		...
		/// <returns></returns>
		public virtual GenericTypeParameter DeepCopy(GenericTypeParameter genericTypeParameter)
		{
		...
		/// <param name="aliasForType"></param>
		/// <returns></returns>
		public virtual IAliasForType DeepCopy(IAliasForType aliasForType)
		{
		...
		/// <returns></returns>
		public virtual IAliasMember DeepCopy(IAliasMember aliasMember)
		{
		...
		/// <param name="assemblyReference">The assembly reference.</param>
		/// <returns></returns>
		public virtual IAssemblyReference DeepCopy(IAssemblyReference assemblyReference)
		{
		...
		public virtual IArrayTypeReference DeepCopy(IArrayTypeReference arrayTypeReference)
		{
			object cachedValue;
		...
		/// <param name="eventDefinition"></param>
		/// <returns></returns>
		public virtual IEventDefinition DeepCopy(IEventDefinition eventDefinition)
		{
		...
		/// <param name="fieldDefinition"></param>
		/// <returns></returns>
		public virtual IFieldDefinition DeepCopy(IFieldDefinition fieldDefinition)
		{
		...
		/// <param name="fieldReference">The field reference.</param>
		/// <returns></returns>
		public virtual IFieldReference DeepCopy(IFieldReference fieldReference)
		{
			object copy;
		...
		/// <param name="genericMethodInstanceReference"></param>
		/// <returns></returns>
		public virtual IGenericMethodInstanceReference DeepCopy(IGenericMethodInstanceReference genericMethodInstanceReference)
		{
			object cachedValue;
		...
		/// <param name="genericMethodParameterReference">The generic method parameter reference.</param>
		/// <returns></returns>
		public virtual IGenericMethodParameterReference DeepCopy(IGenericMethodParameterReference genericMethodParameterReference)
		{
		...
		/// <param name="genericTypeParameterReference">The generic type parameter reference.</param>
		/// <returns></returns>
		public virtual IGenericTypeParameterReference DeepCopy(IGenericTypeParameterReference genericTypeParameterReference)
		{
		...
		/// <param name="genericTypeInstanceReference">The generic type instance reference.</param>
		/// <returns></returns>
		public virtual IGenericTypeInstanceReference DeepCopy(IGenericTypeInstanceReference genericTypeInstanceReference)
		{
			object cachedValue;
		...
		/// <param name="globalFieldDefinition">The global field definition.</param>
		/// <returns></returns>
		public virtual IGlobalFieldDefinition DeepCopy(IGlobalFieldDefinition globalFieldDefinition)
		{
		...
		/// <param name="globalMethodDefinition">The global method definition.</param>
		/// <returns></returns>
		public virtual IGlobalMethodDefinition DeepCopy(IGlobalMethodDefinition globalMethodDefinition)
		{
		...
		/// <returns></returns>
		public virtual ILocation DeepCopy(ILocation location)
		{
			return location;
		}
		...
		/// <returns></returns>
		public virtual IMethodDefinition DeepCopy(IMethodDefinition methodDefinition)
		{
		...
		/// <returns></returns>
		public virtual IMethodReference DeepCopy(IMethodReference methodReference)
		{
			object cachedValue;
		...
		/// <param name="namespaceAliasForType"></param>
		/// <returns></returns>
		public virtual INamespaceAliasForType DeepCopy(INamespaceAliasForType namespaceAliasForType)
		{
			object cachedValue;
		...
		/// <returns></returns>
		public virtual INamespaceMember DeepCopy(INamespaceMember namespaceMember)
		{
			INamespaceTypeDefinition 			/*?*/namespaceTypeDefinition = namespaceMember as INamespaceTypeDefinition;
			if (namespaceTypeDefinition != null)
				return this.DeepCopy(namespaceTypeDefinition);
		...
		/// <returns></returns>
		public virtual INamespaceTypeReference DeepCopy(INamespaceTypeReference namespaceTypeReference)
		{
			object cachedValue;
		...
		/// <returns></returns>
		public virtual INestedTypeReference DeepCopy(INestedTypeReference nestedTypeReference)
		{
			object cachedValue;
		...
		/// <returns></returns>
		public virtual List<IAliasForType> DeepCopy(		/*?*/			/*?*/List<IAliasForType> aliasesForTypes		)
		{
			if (aliasesForTypes == null)
				return null;
			for (int i = 0, n = aliasesForTypes.Count; i < n; i++)
		...
		/// <returns></returns>
		public virtual List<IAliasMember> DeepCopy(		/*?*/			/*?*/List<IAliasMember> aliasMembers		)
		{
		...
		/// <returns></returns>
		public virtual List<IAssemblyReference> DeepCopy(		/*?*/			/*?*/List<IAssemblyReference> assemblyReferences		)
		{
			if (assemblyReferences == null)
				return null;
			for (int i = 0, n = assemblyReferences.Count; i < n; i++)
		...
		/// <returns></returns>
		public virtual List<ICustomAttribute> DeepCopy(		/*?*/			/*?*/List<ICustomAttribute> customAttributes		)
		{
			if (customAttributes == null)
				return null;
			for (int i = 0, n = customAttributes.Count; i < n; i++)
		...
		/// <returns></returns>
		public virtual List<ICustomModifier> DeepCopy(		/*?*/			/*?*/List<ICustomModifier> customModifiers		)
		{
			if (customModifiers == null)
				return null;
			for (int i = 0, n = customModifiers.Count; i < n; i++)
		...
		/// <returns></returns>
		public virtual List<IEventDefinition> DeepCopy(		/*?*/			/*?*/List<IEventDefinition> eventDefinitions		)
		{
		...
		/// <returns></returns>
		public virtual List<IFieldDefinition> DeepCopy(		/*?*/			/*?*/List<IFieldDefinition> fieldDefinitions		)
		{
		...
		/// <returns></returns>
		public virtual List<IFileReference> DeepCopy(		/*?*/			/*?*/List<IFileReference> fileReferences		)
		{
			if (fileReferences == null)
				return null;
			for (int i = 0, n = fileReferences.Count; i < n; i++)
		...
		/// <returns></returns>
		public virtual List<IGenericTypeParameter> DeepCopy(		/*?*/			/*?*/List<IGenericTypeParameter> genericTypeParameters		)
		{
		...
		/// <returns></returns>
		public virtual IMetadataExpression DeepCopy(IMetadataExpression expression)
		{
			IMetadataConstant 			/*?*/metadataConstant = expression as IMetadataConstant;
			if (metadataConstant != null)
				return this.DeepCopy(this.GetMutableShallowCopy(metadataConstant));
			IMetadataCreateArray 			/*?*/metadataCreateArray = expression as IMetadataCreateArray;
			if (metadataCreateArray != null)
				return this.DeepCopy(this.GetMutableShallowCopy(metadataCreateArray));
			IMetadataTypeOf 			/*?*/metadataTypeOf = expression as IMetadataTypeOf;
			if (metadataTypeOf != null)
				return this.DeepCopy(this.GetMutableShallowCopy(metadataTypeOf));
			return expression;
		}
		...
		/// <returns></returns>
		public virtual List<IModuleReference> DeepCopy(		/*?*/			/*?*/List<IModuleReference> moduleReferences		)
		{
			if (moduleReferences == null)
				return null;
			for (int i = 0, n = moduleReferences.Count; i < n; i++)
		...
		/// <returns></returns>
		public virtual List<ILocation> DeepCopy(		/*?*/			/*?*/List<ILocation> locations		)
		{
			if (locations == null)
				return locations;
		...
		/// <returns></returns>
		public virtual List<ILocalDefinition> DeepCopy(		/*?*/			/*?*/List<ILocalDefinition> locals		)
		{
			if (locals == null)
				return null;
		...
		/// <returns></returns>
		public virtual List<IMetadataExpression> DeepCopy(		/*?*/			/*?*/List<IMetadataExpression> metadataExpressions		)
		{
		...
		/// <returns></returns>
		public virtual List<IMetadataNamedArgument> DeepCopy(		/*?*/			/*?*/List<IMetadataNamedArgument> namedArguments		)
		{
			if (namedArguments == null)
				return null;
			for (int i = 0, n = namedArguments.Count; i < n; i++)
		...
		/// <returns></returns>
		public virtual List<IMethodDefinition> DeepCopy(		/*?*/			/*?*/List<IMethodDefinition> methodDefinitions		)
		{
		...
		/// <returns></returns>
		public virtual List<IMethodImplementation> DeepCopy(		/*?*/			/*?*/List<IMethodImplementation> methodImplementations		)
		{
			if (methodImplementations == null)
				return null;
			for (int i = 0, n = methodImplementations.Count; i < n; i++)
		...
		/// <returns></returns>
		public virtual List<IMethodReference> DeepCopy(		/*?*/			/*?*/List<IMethodReference> methodReferences		)
		{
			if (methodReferences == null)
				return null;
			for (int i = 0, n = methodReferences.Count; i < n; i++)
		...
		/// <returns></returns>
		public virtual List<IModule> DeepCopy(		/*?*/			/*?*/List<IModule> modules		)
		{
			if (modules == null)
				return null;
			for (int i = 0, n = modules.Count; i < n; i++) {
		...
		/// <returns></returns>
		public virtual List<INamespaceMember> DeepCopy(		/*?*/			/*?*/List<INamespaceMember> namespaceMembers		)
		{
			if (namespaceMembers == null)
				return null;
			for (int i = 0, n = namespaceMembers.Count; i < n; i++)
		...
		/// <returns></returns>
		public virtual List<INestedTypeDefinition> DeepCopy(		/*?*/			/*?*/List<INestedTypeDefinition> nestedTypeDefinitions		)
		{
		...
		/// <returns></returns>
		public virtual List<IOperation> DeepCopy(		/*?*/			/*?*/List<IOperation> operations		)
		{
			if (operations == null)
				return null;
			for (int i = 0, n = operations.Count; i < n; i++)
		...
		/// <returns></returns>
		public virtual List<IOperationExceptionInformation> DeepCopy(		/*?*/			/*?*/List<IOperationExceptionInformation> exceptionInformations		)
		{
			if (exceptionInformations == null)
				return null;
		...
		/// <returns></returns>
		public virtual List<ITypeDefinitionMember> DeepCopy(		/*?*/			/*?*/List<ITypeDefinitionMember> typeDefinitionMembers		)
		{
			if (typeDefinitionMembers == null)
				return null;
		...
		/// <returns></returns>
		public virtual List<IWin32Resource> DeepCopy(		/*?*/			/*?*/List<IWin32Resource> win32Resources		)
		{
			if (win32Resources == null)
				return null;
			for (int i = 0, n = win32Resources.Count; i < n; i++)
		...
		/// <returns></returns>
		public virtual LocalDefinition DeepCopy(LocalDefinition localDefinition)
		{
		...
		/// <returns></returns>
		public virtual ManagedPointerTypeReference DeepCopy(ManagedPointerTypeReference managedPointerTypeReference)
		{
		...
		/// <returns></returns>
		public virtual MarshallingInformation DeepCopy(MarshallingInformation marshallingInformation)
		{
			...
			if (marshallingInformation.UnmanagedType == UnmanagedType.SafeArray && (marshallingInformation.SafeArrayElementSubtype == VarEnum.VT_DISPATCH || marshallingInformation.SafeArrayElementSubtype == VarEnum.VT_UNKNOWN || marshallingInformation.SafeArrayElementSubtype == VarEnum.VT_RECORD))
		...
		/// <returns></returns>
		public virtual MetadataConstant DeepCopy(MetadataConstant constant)
		{
		...
		/// <returns></returns>
		public virtual MetadataCreateArray DeepCopy(MetadataCreateArray createArray)
		{
		...
		/// <param name="methodDefinition">The method definition.</param>
		/// <returns></returns>
		public virtual MethodDefinition DeepCopy(MethodDefinition methodDefinition)
		{
		...
		/// <returns></returns>
		public virtual MetadataNamedArgument DeepCopy(MetadataNamedArgument namedArgument)
		{
		...
		/// <returns></returns>
		public virtual MetadataTypeOf DeepCopy(MetadataTypeOf typeOf)
		{
		...
		/// <returns></returns>
		public virtual MatrixTypeReference DeepCopy(MatrixTypeReference matrixTypeReference)
		{
		...
		/// <returns></returns>
		public virtual MethodBody DeepCopy(MethodBody methodBody)
		{
		...
		/// <returns></returns>
		public virtual MethodImplementation DeepCopy(MethodImplementation methodImplementation)
		{
		...
		/// </summary>
		public IMethodReference currentMethodReference;
		/// <summary>
		/// Visits the specified method reference.
		/// </summary>
		/// <param name="methodReference">The method reference.</param>
		/// <returns></returns>
		public virtual MethodReference DeepCopy(MethodReference methodReference)
		{
		...
		/// <returns></returns>
		public virtual ModifiedTypeReference DeepCopy(ModifiedTypeReference modifiedTypeReference)
		{
		...
		/// <returns></returns>
		public virtual Module DeepCopy(Module module)
		{
		...
		/// <returns></returns>
		public virtual NamespaceAliasForType DeepCopy(NamespaceAliasForType namespaceAliasForType)
		{
		...
		/// <returns></returns>
		public virtual NamespaceTypeDefinition DeepCopy(NamespaceTypeDefinition namespaceTypeDefinition)
		{
		...
		/// <param name="namespaceTypeReference">The namespace type reference.</param>
		/// <returns></returns>
		public virtual NamespaceTypeReference DeepCopy(NamespaceTypeReference namespaceTypeReference)
		{
		...
		/// <returns></returns>
		public virtual NestedAliasForType DeepCopy(NestedAliasForType nestedAliasForType)
		{
		...
		/// <returns></returns>
		public virtual OperationExceptionInformation DeepCopy(OperationExceptionInformation operationExceptionInformation)
		{
		...
		/// <returns></returns>
		public virtual Operation DeepCopy(Operation operation)
		{
		...
		/// <returns></returns>
		public virtual NestedTypeDefinition DeepCopy(NestedTypeDefinition nestedTypeDefinition)
		{
		...
		/// <param name="nestedTypeReference">The nested type reference.</param>
		/// <returns></returns>
		public virtual NestedTypeReference DeepCopy(NestedTypeReference nestedTypeReference)
		{
		...
		/// <returns></returns>
		public virtual SpecializedFieldReference DeepCopy(SpecializedFieldReference specializedFieldReference)
		{
		...
		/// <returns></returns>
		public virtual SpecializedMethodReference DeepCopy(SpecializedMethodReference specializedMethodReference)
		{
		...
		/// <returns></returns>
		public virtual SpecializedNestedTypeReference DeepCopy(SpecializedNestedTypeReference specializedNestedTypeReference)
		{
		...
		public virtual void DeepCopy(NamedTypeDefinition typeDefinition)
		{
		...
		/// <returns></returns>
		public virtual List<ITypeReference> DeepCopy(		/*?*/			/*?*/List<ITypeReference> typeReferences		)
		{
			if (typeReferences == null)
				return null;
			for (int i = 0, n = typeReferences.Count; i < n; i++)
		...
		/// it is a definition.
		/// </remarks>
		public virtual IPointerTypeReference DeepCopy(IPointerTypeReference pointerTypeReference)
		{
			object cachedValue;
		...
		/// <param name="functionPointerTypeReference">The function pointer type reference.</param>
		/// <returns></returns>
		public virtual IFunctionPointerTypeReference DeepCopy(IFunctionPointerTypeReference functionPointerTypeReference)
		{
			object cachedValue;
		...
		/// it is a definition.
		/// </remarks>
		public virtual IManagedPointerTypeReference DeepCopy(IManagedPointerTypeReference managedPointerTypeReference)
		{
			object cachedValue;
		...
		/// <param name="modifiedTypeReference">The modified type reference.</param>
		/// <returns></returns>
		public virtual IModifiedTypeReference DeepCopy(IModifiedTypeReference modifiedTypeReference)
		{
			object cachedValue;
		...
		/// <param name="moduleReference">The module reference.</param>
		/// <returns></returns>
		public virtual IModuleReference DeepCopy(IModuleReference moduleReference)
		{
			object cachedValue;
		...
		/// <param name="namespaceTypeDefinition">The namespace type definition.</param>
		/// <returns></returns>
		public virtual INamespaceTypeDefinition DeepCopy(INamespaceTypeDefinition namespaceTypeDefinition)
		{
		...
		/// <param name="nestedTypeDefinition">The nested type definition.</param>
		/// <returns></returns>
		public virtual INestedTypeDefinition DeepCopy(INestedTypeDefinition nestedTypeDefinition)
		{
		...
		/// <returns></returns>
		public virtual ITypeReference DeepCopy(ITypeReference typeReference)
		{
		...
		/// <returns></returns>
		public virtual IUnitNamespaceReference DeepCopy(IUnitNamespaceReference unitNamespaceReference)
		{
			object cachedValue;
		...
		/// <returns></returns>
		public virtual INestedUnitNamespace DeepCopy(INestedUnitNamespace nestedUnitNamespace)
		{
		...
		/// <returns></returns>
		public virtual INestedUnitNamespaceReference DeepCopy(INestedUnitNamespaceReference nestedUnitNamespaceReference)
		{
			object cachedValue;
		...
		/// <param name="nestedUnitNamespace">The nested unit namespace.</param>
		/// <returns></returns>
		public virtual NestedUnitNamespace DeepCopy(NestedUnitNamespace nestedUnitNamespace)
		{
		...
		/// <param name="nestedUnitNamespaceReference">The nested unit namespace reference.</param>
		/// <returns></returns>
		public virtual NestedUnitNamespaceReference DeepCopy(NestedUnitNamespaceReference nestedUnitNamespaceReference)
		{
		...
		/// <returns></returns>
		public virtual IUnitReference DeepCopy(IUnitReference unitReference)
		{
			object cachedValue;
		...
		/// <returns></returns>
		public virtual List<IParameterDefinition> DeepCopy(		/*?*/			/*?*/List<IParameterDefinition> parameterDefinitions		)
		{
		...
		/// <returns></returns>
		public virtual ParameterDefinition DeepCopy(ParameterDefinition parameterDefinition)
		{
		...
		/// <returns></returns>
		public virtual List<IParameterTypeInformation> DeepCopy(		/*?*/			/*?*/List<IParameterTypeInformation> parameterTypeInformationList		)
		{
			if (parameterTypeInformationList == null)
				return null;
		...
		/// <returns></returns>
		public virtual ParameterTypeInformation DeepCopy(ParameterTypeInformation parameterTypeInformation)
		{
		...
		/// <returns></returns>
		public virtual PlatformInvokeInformation DeepCopy(PlatformInvokeInformation platformInvokeInformation)
		{
		...
		/// <returns></returns>
		public virtual List<IPropertyDefinition> DeepCopy(List<IPropertyDefinition> propertyDefinitions)
		{
		...
		/// <returns></returns>
		public virtual IPropertyDefinition DeepCopy(IPropertyDefinition propertyDefinition)
		{
		...
		/// <param name="propertyDefinition">The property definition.</param>
		/// <returns></returns>
		public virtual PropertyDefinition DeepCopy(PropertyDefinition propertyDefinition)
		{
			...
			if (propertyDefinition.Accessors != null) {
				if (propertyDefinition.Accessors.Count > 0) {
					if (propertyDefinition.Getter == propertyDefinition.Accessors[0])
						getterIndex = 0; else if (propertyDefinition.Setter == propertyDefinition.Accessors[0])
						setterIndex = 0;
				}
				if (propertyDefinition.Accessors.Count > 1) {
					if (propertyDefinition.Getter == propertyDefinition.Accessors[1])
						getterIndex = 1; else if (propertyDefinition.Setter == propertyDefinition.Accessors[1])
						setterIndex = 1;
				}
			}
		...
		/// <param name="pointerTypeReference">The pointer type reference.</param>
		/// <returns></returns>
		public virtual PointerTypeReference DeepCopy(PointerTypeReference pointerTypeReference)
		{
		...
		/// <returns></returns>
		public virtual List<IResourceReference> DeepCopy(List<IResourceReference> resourceReferences)
		{
			if (resourceReferences == null)
				return null;
			for (int i = 0, n = resourceReferences.Count; i < n; i++)
		...
		/// <returns></returns>
		public virtual ResourceReference DeepCopy(ResourceReference resourceReference)
		{
		...
		/// <returns></returns>
		public virtual List<ISecurityAttribute> DeepCopy(List<ISecurityAttribute> securityAttributes)
		{
			if (securityAttributes == null)
				return null;
			for (int i = 0, n = securityAttributes.Count; i < n; i++)
		...
		/// <returns></returns>
		public virtual IRootUnitNamespaceReference DeepCopy(IRootUnitNamespaceReference rootUnitNamespaceReference)
		{
		...
		/// <returns></returns>
		public virtual RootUnitNamespace DeepCopy(RootUnitNamespace rootUnitNamespace)
		{
		...
		/// <param name="rootUnitNamespaceReference">The root unit namespace reference.</param>
		/// <returns></returns>
		public virtual RootUnitNamespaceReference DeepCopy(RootUnitNamespaceReference rootUnitNamespaceReference)
		{
		...
		/// <returns></returns>
		public virtual SecurityAttribute DeepCopy(SecurityAttribute securityAttribute)
		{
		...
		/// <returns></returns>
		public virtual SectionBlock DeepCopy(SectionBlock sectionBlock)
		{
			return sectionBlock;
		}
		...
		/// <param name="typeDefinitionMember">The type definition member.</param>
		/// <returns></returns>
		public virtual ITypeDefinitionMember DeepCopy(TypeDefinitionMember typeDefinitionMember)
		{
		...
		/// <param name="typeReference">The type reference.</param>
		/// <returns></returns>
		public virtual TypeReference DeepCopy(TypeReference typeReference)
		{
		...
		/// <returns></returns>
		public virtual Unit DeepCopy(Unit unit)
		{
		...
		/// <returns></returns>
		public virtual UnitNamespace DeepCopy(UnitNamespace unitNamespace)
		{
		...
		/// <param name="unitNamespaceReference">The unit namespace reference.</param>
		/// <returns></returns>
		public virtual UnitNamespaceReference DeepCopy(UnitNamespaceReference unitNamespaceReference)
		{
		...
		/// <returns></returns>
		public virtual VectorTypeReference DeepCopy(VectorTypeReference vectorTypeReference)
		{
		...
		/// <returns></returns>
		public virtual Win32Resource DeepCopy(Win32Resource win32Resource)
		{
			return win32Resource;
		}
		#endregion
		...
		/// <param name="localDefinition">The local definition.</param>
		/// <returns></returns>
		public virtual ILocalDefinition GetMutableCopyIfItExists(ILocalDefinition localDefinition)
		{
			object 			/*?*/cachedValue;
			this.cache.TryGetValue(localDefinition, out cachedValue);
		...
		/// <param name="methodDefinition"></param>
		/// <returns></returns>
		public virtual IMethodDefinition GetMutableCopyIfItExists(IMethodDefinition methodDefinition)
		{
			object 			/*?*/cachedValue;
			this.cache.TryGetValue(methodDefinition, out cachedValue);
		...
		/// <returns></returns>
		public virtual INamespaceDefinition GetMutableCopyIfItExists(INamespaceDefinition namespaceDefinition)
		{
			object 			/*?*/cachedValue;
		...
		/// <param name="parameterDefinition">The parameter definition.</param>
		/// <returns></returns>
		public virtual IParameterDefinition GetMutableCopyIfItExists(IParameterDefinition parameterDefinition)
		{
			object 			/*?*/cachedValue;
			this.cache.TryGetValue(parameterDefinition, out cachedValue);
		...
		/// <returns></returns>
		public virtual ISignature GetMutableCopyIfItExists(ISignature signature)
		{
			object 			/*?*/cachedValue;
		...
		/// <returns></returns>
		public ITypeDefinition GetMutableCopyIfItExists(ITypeDefinition typeDefinition)
		{
			object 			/*?*/cachedValue;
		...
		/// <returns></returns>
		public virtual IUnit GetMutableCopyIfItExists(IUnit unitNamespace)
		{
			object 			/*?*/cachedValue;
			this.cache.TryGetValue(unitNamespace, out cachedValue);
			var result = cachedValue as IUnit;
			if (result == null)
				result = unitNamespace;
			return result;
		}
		...
		/// <param name="unitNamespace"></param>
		/// <returns></returns>
		public virtual IUnitNamespace GetMutableCopyIfItExists(IUnitNamespace unitNamespace)
		{
			object 			/*?*/cachedValue;
			this.cache.TryGetValue(unitNamespace, out cachedValue);
		...
		public class TypeOrderPreserver : Comparer<INamedTypeDefinition>
		{
			...
			public override int Compare(INamedTypeDefinition x, INamedTypeDefinition y)
			{
				...
				if (!this.oldOrder.TryGetValue(xn, out xi))
					xi = int.MaxValue;
				if (!this.oldOrder.TryGetValue(yn, out yi))
					yi = int.MaxValue;
				return xi - yi;
			}
		}
		...
		/// <param name="customAttributes">The custom attributes.</param>
		/// <returns></returns>
		public List<ICustomAttribute> DeepCopyMethodReturnValueAttributes(List<ICustomAttribute> customAttributes)
		{
		...
		/// <returns></returns>
		public List<ICustomModifier> DeepCopyMethodReturnValueCustomModifiers(List<ICustomModifier> customModifers)
		{
		...
		/// <param name="marshallingInformation">The marshalling information.</param>
		/// <returns></returns>
		public IMarshallingInformation DeepCopyMethodReturnValueMarshallingInformation(MarshallingInformation marshallingInformation)
		{
		...
		/// </summary>
		public bool coneAlreadyFixed;

		/// <summary>
		/// Assembly is the root of the cone. collect all sub def-nodes. 
		/// </summary>
		/// <param name="assembly"></param>
		public void AddDefinition(IAssembly assembly)
		{
			if (this.coneAlreadyFixed) {
		...
		/// </summary>
		/// <param name="module"></param>
		public void AddDefinition(IModule module)
		{
			if (this.coneAlreadyFixed) {
		...
		public virtual IModule Substitute(IModule module)
		{
			...
			var assembly = module as IAssembly;
			if (assembly != null)
				return this.Substitute(assembly);
			this.coneAlreadyFixed = true;
	...
	/// 
	/// </remarks>
	public class CollectAndShallowCopyDefinitions : MetadataVisitor
	{
		...
		public CollectAndShallowCopyDefinitions(MetadataCopier copier, List<INamedTypeDefinition> newTypes)
		{
			this.copier = copier;
