...
namespace Microsoft.Cci.MutableCodeModel
{
	...
	public class MetadataRewriter
	{
		...
		/// </summary>
		public readonly IMetadataHost host;
		...
		public class Dispatcher : MetadataVisitor
		{
			public MetadataRewriter rewriter;
		...
		/// </summary>
		public Hashtable<IReference, object> referenceRewrites = new Hashtable<IReference, object>();
		...
		public virtual IArrayTypeReference Rewrite(IArrayTypeReference arrayTypeReference)
		{
			...
			object result;
			if (this.referenceRewrites.TryGetValue(arrayTypeReference, out result))
				return (IArrayTypeReference)result;
		...
		public virtual IAssemblyReference Rewrite(IAssemblyReference assemblyReference)
		{
			...
			object result;
			if (this.referenceRewrites.TryGetValue(assemblyReference, out result))
				return (IAssemblyReference)result;
		...
		public virtual ICustomAttribute Rewrite(ICustomAttribute customAttribute)
		{
			...
			if (mutableCustomAttribute == null)
				return customAttribute;
		...
		public virtual IEventDefinition Rewrite(IEventDefinition eventDefinition)
		{
			...
			if (mutableEventDefinition == null)
				return eventDefinition;
		...
		public virtual IFieldDefinition Rewrite(IFieldDefinition fieldDefinition)
		{
			...
			if (mutableFieldDefinition == null)
				return fieldDefinition;
		...
		public virtual IFieldReference RewriteUnspecialized(IFieldReference fieldReference)
		{
			...
			if (fieldReference is Dummy)
				return fieldReference;
			object result;
			if (this.referenceRewrites.TryGetValue(fieldReference, out result))
				return (IFieldReference)result;
		...
		public virtual IFunctionPointerTypeReference Rewrite(IFunctionPointerTypeReference functionPointerTypeReference)
		{
			...
			object result;
			if (this.referenceRewrites.TryGetValue(functionPointerTypeReference, out result))
				return (IFunctionPointerTypeReference)result;
		...
		public virtual IGenericMethodInstanceReference Rewrite(IGenericMethodInstanceReference genericMethodInstanceReference)
		{
			...
			object result;
			if (this.referenceRewrites.TryGetValue(genericMethodInstanceReference, out result))
				return (IGenericMethodInstanceReference)result;
		...
		public virtual IGenericMethodParameter Rewrite(IGenericMethodParameter genericMethodParameter)
		{
			...
			if (mutableGenericMethodParameter == null)
				return genericMethodParameter;
		...
		public virtual ITypeReference Rewrite(IGenericMethodParameterReference genericMethodParameterReference)
		{
			...
			object result;
			if (this.referenceRewrites.TryGetValue(genericMethodParameterReference, out result))
				return (IGenericMethodParameterReference)result;
		...
		public virtual ITypeReference Rewrite(IGenericTypeInstanceReference genericTypeInstanceReference)
		{
			...
			object result;
			if (this.referenceRewrites.TryGetValue(genericTypeInstanceReference, out result))
				return (IGenericTypeInstanceReference)result;
		...
		public virtual ITypeReference Rewrite(IGenericTypeParameterReference genericTypeParameterReference)
		{
			...
			object result;
			if (this.referenceRewrites.TryGetValue(genericTypeParameterReference, out result))
				return (IGenericTypeParameterReference)result;
		...
		public virtual IGlobalFieldDefinition Rewrite(IGlobalFieldDefinition globalFieldDefinition)
		{
			...
			if (mutableGlobalFieldDefinition == null)
				return globalFieldDefinition;
		...
		public virtual IGlobalMethodDefinition Rewrite(IGlobalMethodDefinition globalMethodDefinition)
		{
			...
			if (mutableGlobalMethodDefinition == null)
				return globalMethodDefinition;
		...
		public virtual IManagedPointerTypeReference Rewrite(IManagedPointerTypeReference managedPointerTypeReference)
		{
			...
			object result;
			if (this.referenceRewrites.TryGetValue(managedPointerTypeReference, out result))
				return (IManagedPointerTypeReference)result;
		...
		public virtual IMarshallingInformation Rewrite(IMarshallingInformation marshallingInformation)
		{
			...
			if (mutableMarshallingInformation == null)
				return marshallingInformation;
		...
		public virtual IMetadataConstant Rewrite(IMetadataConstant constant)
		{
			...
			if (mutableMetadataConstant == null)
				return constant;
		...
		public virtual IMetadataNamedArgument Rewrite(IMetadataNamedArgument namedArgument)
		{
			...
			if (mutableMetadataNamedArgument == null)
				return namedArgument;
		...
		public virtual IMethodDefinition Rewrite(IMethodDefinition method)
		{
			...
			if (mutableMethodDefinition == null)
				return method;
		...
		public virtual IMethodReference RewriteUnspecialized(IMethodReference methodReference)
		{
			...
			if (methodReference is Dummy)
				return methodReference;
			object result;
			if (this.referenceRewrites.TryGetValue(methodReference, out result))
		...
		public virtual IModifiedTypeReference Rewrite(IModifiedTypeReference modifiedTypeReference)
		{
			...
			object result;
			if (this.referenceRewrites.TryGetValue(modifiedTypeReference, out result))
				return (IModifiedTypeReference)result;
		...
		public virtual IModuleReference Rewrite(IModuleReference moduleReference)
		{
			...
			object result;
			if (this.referenceRewrites.TryGetValue(moduleReference, out result))
				return (IModuleReference)result;
		...
		public virtual INamedTypeDefinition Rewrite(INamedTypeDefinition namedTypeDefinition)
		{
			...
			if (namedTypeDefinition is Dummy)
		...
		public virtual INamespaceAliasForType Rewrite(INamespaceAliasForType namespaceAliasForType)
		{
			...
			if (mutableNamespaceAliasForType == null)
				return namespaceAliasForType;
		...
		public virtual INamespaceDefinition Rewrite(INamespaceDefinition namespaceDefinition)
		{
			...
			if (namespaceDefinition is Dummy)
		...
		public virtual INamespaceTypeReference Rewrite(INamespaceTypeReference namespaceTypeReference)
		{
			...
			object result;
			if (this.referenceRewrites.TryGetValue(namespaceTypeReference, out result))
		...
		public virtual INestedAliasForType Rewrite(INestedAliasForType nestedAliasForType)
		{
			...
			if (mutableNestedAliasForType == null)
				return nestedAliasForType;
		...
		public virtual INestedTypeDefinition Rewrite(INestedTypeDefinition namespaceTypeDefinition)
		{
			...
			if (mutableNestedTypeDefinition == null)
				return namespaceTypeDefinition;
		...
		public virtual INestedTypeReference RewriteUnspecialized(INestedTypeReference nestedTypeReference)
		{
			...
			if (nestedTypeReference is Dummy)
				return nestedTypeReference;
			object result;
			if (this.referenceRewrites.TryGetValue(nestedTypeReference, out result))
				return (INestedTypeReference)result;
		...
		public virtual INestedUnitNamespace Rewrite(INestedUnitNamespace nestedUnitNamespace)
		{
			...
			if (mutableNestedUnitNamespace == null)
				return nestedUnitNamespace;
		...
		public virtual INestedUnitNamespaceReference Rewrite(INestedUnitNamespaceReference nestedUnitNamespaceReference)
		{
			...
			object result;
			if (this.referenceRewrites.TryGetValue(nestedUnitNamespaceReference, out result))
				return (INestedUnitNamespaceReference)result;
		...
		public virtual IOperationExceptionInformation Rewrite(IOperationExceptionInformation operationExceptionInformation)
		{
			...
			if (mutableOperationExceptionInformation == null)
				return operationExceptionInformation;
		...
		public virtual IParameterDefinition Rewrite(IParameterDefinition parameterDefinition)
		{
			...
			if (mutableParameterDefinition == null)
				return parameterDefinition;
		...
		public virtual IParameterTypeInformation Rewrite(IParameterTypeInformation parameterTypeInformation)
		{
			...
			if (mutableParameterTypeInformation == null)
				return parameterTypeInformation;
		...
		public virtual IPlatformInvokeInformation Rewrite(IPlatformInvokeInformation platformInvokeInformation)
		{
			...
			if (mutablePlatformInvokeInformation == null)
				return platformInvokeInformation;
		...
		public virtual IPointerTypeReference Rewrite(IPointerTypeReference pointerTypeReference)
		{
			...
			object result;
			if (this.referenceRewrites.TryGetValue(pointerTypeReference, out result))
				return (IPointerTypeReference)result;
		...
		public virtual IResourceReference Rewrite(IResourceReference resourceReference)
		{
			...
			if (mutableResourceReference == null)
				return resourceReference;
		...
		public virtual IRootUnitNamespace Rewrite(IRootUnitNamespace rootUnitNamespace)
		{
			...
			if (mutableRootUnitNamespace == null)
				return rootUnitNamespace;
		...
		public virtual IRootUnitNamespaceReference Rewrite(IRootUnitNamespaceReference rootUnitNamespaceReference)
		{
			...
			object result;
			if (this.referenceRewrites.TryGetValue(rootUnitNamespaceReference, out result))
				return (IRootUnitNamespaceReference)result;
		...
		public virtual ISecurityAttribute Rewrite(ISecurityAttribute securityAttribute)
		{
			...
			if (mutableSecurityAttribute == null)
				return securityAttribute;
		...
		public virtual ISpecializedFieldReference Rewrite(ISpecializedFieldReference specializedFieldReference)
		{
			...
			if (specializedFieldReference is Dummy)
				return specializedFieldReference;
			object result;
			if (this.referenceRewrites.TryGetValue(specializedFieldReference, out result))
				return (ISpecializedFieldReference)result;
		...
		public virtual IMethodReference Rewrite(ISpecializedMethodReference specializedMethodReference)
		{
			...
			if (specializedMethodReference is Dummy)
				return specializedMethodReference;
			object result;
			if (this.referenceRewrites.TryGetValue(specializedMethodReference, out result))
				return (IMethodReference)result;
		...
		public virtual INestedTypeReference Rewrite(ISpecializedNestedTypeReference specializedNestedTypeReference)
		{
			...
			if (specializedNestedTypeReference is Dummy)
				return specializedNestedTypeReference;
			object result;
			if (this.referenceRewrites.TryGetValue(specializedNestedTypeReference, out result))
				return (ISpecializedNestedTypeReference)result;
	...
	public abstract class ICopyFromContract<ImmutableObject> : ICopyFrom<ImmutableObject>
	{
	...
	public class MetadataMutator
	{
		...
		/// </summary>
		public Dictionary<object, object> cache = new Dictionary<object, object>();

		/// <summary>
		/// True if the mutator should try and perform mutations in place, rather than mutating new copies.
		/// </summary>
		public readonly bool copyOnlyIfNotAlreadyMutable;
		...
		/// </summary>
		public Dictionary<object, object> referenceCache = new Dictionary<object, object>();
		...
		/// 
		/// </summary>
		public System.Collections.Stack path = new System.Collections.Stack();
		...
		{
			if (this.stopTraversal || aliasesForTypes == null)
				return aliasesForTypes;
			for (int i = 0, n = aliasesForTypes.Count; i < n; i++)
		...
		public virtual IAliasForType Visit(IAliasForType aliasForType)
		{
			...
			if (namespaceAliasForType != null)
				return this.Visit(this.GetMutableCopy(namespaceAliasForType));
			INestedAliasForType 			/*?*/nestedAliasForType = aliasForType as INestedAliasForType;
			if (nestedAliasForType != null)
				return this.Visit(this.GetMutableCopy(nestedAliasForType));
			//TODO: error
			return aliasForType;
		}
		...
		{
			if (this.stopTraversal || assemblyReferences == null)
				return assemblyReferences;
			for (int i = 0, n = assemblyReferences.Count; i < n; i++)
		...
		{
			if (this.stopTraversal || customAttributes == null)
				return customAttributes;
			for (int i = 0, n = customAttributes.Count; i < n; i++)
		...
		{
			if (this.stopTraversal || customModifiers == null)
				return customModifiers;
			for (int i = 0, n = customModifiers.Count; i < n; i++)
		...
		{
			if (this.stopTraversal || eventDefinitions == null)
		...
		{
			if (this.stopTraversal || fieldDefinitions == null)
		...
		{
			if (this.stopTraversal || fileReferences == null)
				return fileReferences;
			for (int i = 0, n = fileReferences.Count; i < n; i++)
		...
		{
			if (this.stopTraversal || genericMethodParameters == null)
		...
		{
			if (this.stopTraversal || genericTypeParameters == null)
		...
		{
			if (this.stopTraversal || locations == null)
				return locations;
		...
		{
			if (this.stopTraversal || metadataExpressions == null)
		...
		{
			if (this.stopTraversal || namedArguments == null)
				return namedArguments;
			for (int i = 0, n = namedArguments.Count; i < n; i++)
		...
		{
			if (this.stopTraversal || exceptionInformations == null)
		...
		{
			if (this.stopTraversal || operations == null)
				return operations;
			for (int i = 0, n = operations.Count; i < n; i++)
		...
		{
			if (this.stopTraversal || locals == null)
				return locals;
		...
		{
			if (this.stopTraversal || methodDefinitions == null)
		...
		{
			if (this.stopTraversal || methodImplementations == null)
				return methodImplementations;
			for (int i = 0, n = methodImplementations.Count; i < n; i++)
		...
		{
			if (this.stopTraversal || methodReferences == null)
				return methodReferences;
			for (int i = 0, n = methodReferences.Count; i < n; i++)
		...
		{
			if (this.stopTraversal || modules == null)
				return modules;
			for (int i = 0, n = modules.Count; i < n; i++) {
		...
		{
			if (this.stopTraversal || moduleReferences == null)
				return moduleReferences;
			for (int i = 0, n = moduleReferences.Count; i < n; i++)
		...
		{
			if (this.stopTraversal || namespaceMembers == null)
				return namespaceMembers;
			for (int i = 0, n = namespaceMembers.Count; i < n; i++)
		...
		{
			if (this.stopTraversal || nestedTypeDefinitions == null)
		...
		public virtual void Visit(NamedTypeDefinition typeDefinition)
		{
			if (this.stopTraversal)
				return;
		...
		{
			if (this.stopTraversal || typeDefinitions == null)
				return;
		...
		{
			if (this.stopTraversal || typeDefinitionMembers == null)
		...
		{
			if (this.stopTraversal || typeReferences == null)
				return typeReferences;
			for (int i = 0, n = typeReferences.Count; i < n; i++)
		...
		{
			if (this.stopTraversal || parameterDefinitions == null)
		...
		{
			if (this.stopTraversal || parameterTypeInformationList == null)
		...
		{
			if (this.stopTraversal || propertyDefinitions == null)
		...
		{
			if (this.stopTraversal || resourceReferences == null)
				return resourceReferences;
			for (int i = 0, n = resourceReferences.Count; i < n; i++)
		...
		{
			if (this.stopTraversal || securityAttributes == null)
				return securityAttributes;
			for (int i = 0, n = securityAttributes.Count; i < n; i++)
		...
		{
			if (this.stopTraversal || peSections == null)
				return peSections;
			for (int i = 0, n = peSections.Count; i < n; i++)
		...
		{
			if (this.stopTraversal || win32Resources == null)
				return win32Resources;
			for (int i = 0, n = win32Resources.Count; i < n; i++)
	...
	public class MutatingVisitor
	{
		...
		/// True if the mutator should try and perform mutations in place, rather than mutating new copies.
		/// </summary>
		public readonly bool visitImmutableNodes;
		...
		/// </summary>
		public Dictionary<IReference, IReference> referenceCache = new Dictionary<IReference, IReference>();
		...
		/// </summary>
		public void Visit(IEnumerable<ICustomAttribute> attributes)
		{
		...
		public void Visit(IEnumerable<ILocation> locations)
		{
			if (this.visitImmutableNodes) {
		...
		public void Visit(IEnumerable<IMetadataExpression> metadataExpressions)
		{
		...
		public void Visit(IEnumerable<IAliasForType> aliasForTypes)
		{
		...
		public void Visit(IEnumerable<ICustomModifier> modifiers)
		{
		...
		public void Visit(IEnumerable<IGenericTypeParameter> genericTypeParameters)
		{
		...
		public void Visit(IEnumerable<IFileReference> files)
		{
		...
		public void Visit(IEnumerable<IMethodImplementation> methodImpls)
		{
			foreach (var mi in methodImpls)
				this.Visit(mi);
		}
		...
		/// </summary>
		/// <param name="methods"></param>
		public void Visit(IEnumerable<IMethodReference> methods)
		{
			foreach (var m in methods)
				this.Visit(m);
		}
		...
		public void Visit(IEnumerable<IModule> modules)
		{
		...
		public void Visit(IEnumerable<INamespaceMember> members)
		{
		...
		public void Visit(IEnumerable<INestedTypeDefinition> nestedTypes)
		{
		...
		public void Visit(IEnumerable<IParameterTypeInformation> parameterTypes)
		{
		...
		public void Visit(IEnumerable<IResourceReference> resources)
		{
		...
		public void Visit(IEnumerable<ISecurityAttribute> securityAttributes)
		{
		...
		public virtual IAliasForType Visit(IAliasForType aliasForType)
		{
			...
			INamespaceAliasForType 			/*?*/namespaceAliasForType = aliasForType as INamespaceAliasForType;
			if (namespaceAliasForType != null)
				return this.Visit(namespaceAliasForType);
			INestedAliasForType 			/*?*/nestedAliasForType = aliasForType as INestedAliasForType;
			if (nestedAliasForType != null)
				return this.Visit(nestedAliasForType);
			Debug.Assert(false);
			return aliasForType;
		}
		...
		public virtual IGenericMethodInstanceReference Visit(IGenericMethodInstanceReference genericMethodInstanceReference)
		{
			...
			if (mutable1 != null)
				return this.Mutate(this.GetReferenceCopy(mutable1));
			var mutable2 = genericMethodInstanceReference as Immutable.GenericMethodInstance;
			if (mutable2 != null)
				return this.Mutate(this.GetReferenceCopy(mutable2));
			if (this.visitImmutableNodes) {
				this.path.Push(genericMethodInstanceReference);
		...
		public virtual IMetadataExpression Dispatch(IMetadataExpression expression)
		{
			...
			IMetadataConstant 			/*?*/metadataConstant = expression as IMetadataConstant;
			if (metadataConstant != null)
				return this.Visit(metadataConstant);
			IMetadataCreateArray 			/*?*/metadataCreateArray = expression as IMetadataCreateArray;
			if (metadataCreateArray != null)
				return this.Visit(metadataCreateArray);
			IMetadataTypeOf 			/*?*/metadataTypeOf = expression as IMetadataTypeOf;
			if (metadataTypeOf != null)
				return this.Visit(metadataTypeOf);
			IMetadataNamedArgument metadataNamedArgument = expression as IMetadataNamedArgument;
			if (metadataNamedArgument != null)
				return this.Visit(metadataNamedArgument);
			return expression;
		}
		...
		public INestedTypeReference SubstituteNestedTypeReference(INestedTypeReference nestedTypeReference)
		{
		...
		/// </summary>
		/// <param name="typeDefinition">A mutable type definition.</param>
		public virtual void VisitTypeDefinition(NamedTypeDefinition typeDefinition)
		{
			if (this.stopTraversal)
				return;
			this.path.Push(typeDefinition);
		...
		public virtual INamespaceTypeReference Mutate(INamespaceTypeReference namespaceTypeReference)
		{
			...
			if (containingUnit != namespaceTypeReference.ContainingUnitNamespace) {
				...
				var copy = MutableModelHelper.GetNamespaceTypeReference(containingUnit, namespaceTypeReference.GenericParameterCount, namespaceTypeReference.MangleName, namespaceTypeReference.Name, this.host.InternFactory, namespaceTypeReference);
				return copy;
			}
			return namespaceTypeReference;
		}
		...
		/// <param name="methodReference"></param>
		/// <returns></returns>
		public IMethodReference GetTypeSpecificReferenceCopy(IMethodReference methodReference)
		{
			IReference cachedValue;
			if (this.referenceCache.TryGetValue(methodReference, out cachedValue)) {
				return (IMethodReference)cachedValue;
		...
		public virtual IFunctionPointerTypeReference Mutate(IFunctionPointerTypeReference functionPointerTypeReference)
		{
			...
			if (pars != functionPointerTypeReference.Parameters || typ != functionPointerTypeReference.Type || extraArgumentTypes != functionPointerTypeReference.ExtraArgumentTypes || (customModifiers != functionPointerTypeReference.ReturnValueCustomModifiers && functionPointerTypeReference.ReturnValueIsModified)) {
				var copy = MutableModelHelper.GetFunctionPointerTypeReference(functionPointerTypeReference.CallingConvention, pars, extraArgumentTypes, functionPointerTypeReference.ReturnValueIsModified, customModifiers, functionPointerTypeReference.ReturnValueIsByRef, typ, this.host.InternFactory, functionPointerTypeReference);
				return copy;
			}
			return functionPointerTypeReference;
		}
		...
		{
			if (this.stopTraversal || parameters == null)
				return parameters;
		...
		/// <param name="fieldReference"></param>
		/// <returns></returns>
		public FieldReference GetReferenceCopy(IFieldReference fieldReference)
		{
		...
		/// <param name="methodReference"></param>
		/// <returns></returns>
		public MethodReference GetReferenceCopy(IMethodReference methodReference)
		{
		...
		/// <param name="rootUnitNamespaceReference"></param>
		/// <returns></returns>
		public RootUnitNamespaceReference GetReferenceCopy(IRootUnitNamespaceReference rootUnitNamespaceReference)
		{
		...
		/// <param name="specializedFieldReference"></param>
		/// <returns></returns>
		public SpecializedFieldReference GetReferenceCopy(ISpecializedFieldReference specializedFieldReference)
		{
		...
		/// <param name="specializedMethodReference"></param>
		/// <returns></returns>
		public SpecializedMethodReference GetReferenceCopy(ISpecializedMethodReference specializedMethodReference)
		{
		...
		/// <param name="genericMethodInstanceReference"></param>
		/// <returns></returns>
		public GenericMethodInstanceReference GetReferenceCopy(IGenericMethodInstanceReference genericMethodInstanceReference)
		{
			//^ requires !this.referenceCache.Contains(genericMethodInstanceReference);
	...
	public class MutableModelHelper
	{
		...
		/// created node.</param>
		/// <returns></returns>
		public static IFunctionPointerTypeReference GetFunctionPointerTypeReference(CallingConvention callingConvention, IEnumerable<IParameterTypeInformation> parameters, IEnumerable<IParameterTypeInformation> extraArgumentTypes, bool returnValueIsModified, IEnumerable<ICustomModifier> returnValueCustomModifiers, bool returnValueIsByRef, ITypeReference type, IInternFactory internFactory, ITypeReference original)
		{
