...
//^ requires this.IsStatic;
		...
		public bool IsReadOnly {
			get { return (this.flags & 0x8000000) != 0; }
			set {
				if (value)
		...
		/// <value></value>
		public bool IsRuntimeSpecial {
			get { return (this.flags & 0x4000000) != 0; }
		...
		/// <value></value>
		public bool IsSpecialName {
			get { return (this.flags & 0x2000000) != 0; }
			set {
				if (value)
		...
		public bool IsStatic {
			get { return (this.flags & 0x1000000) != 0; }
			set {
				if (value)
	...
	public class MethodDefinition : TypeDefinitionMember, IMethodDefinition, ICopyFrom<IMethodDefinition>
	{
		...
		public bool IsExternal {
			get { return (this.flags & 0x800000) != 0; }
			set {
				if (value)
					this.flags |= 0x800000;
				else
		...
		public bool IsForwardReference {
			get { return (this.flags & 0x400000) != 0; }
			set {
				if (value)
					this.flags |= 0x400000;
				else
		...
		public bool IsHiddenBySignature {
			get { return (this.flags & 0x200000) != 0; }
			set {
				if (value)
					this.flags |= 0x200000;
				else
		...
		public bool IsNativeCode {
			get { return (this.flags & 0x100000) != 0; }
			set {
				if (value)
					this.flags |= 0x100000;
				else
		...
		public bool IsNewSlot {
			get { return (this.flags & 0x80000) != 0; }
			set {
				if (value)
					this.flags |= 0x80000;
				else
		...
		public bool IsNeverInlined {
			get { return (this.flags & 0x40000) != 0; }
			set {
				if (value)
					this.flags |= 0x40000;
				else
		...
		public bool IsNeverOptimized {
			get { return (this.flags & 0x20000) != 0; }
			set {
				if (value)
					this.flags |= 0x20000;
				else
		...
		public bool IsPlatformInvoke {
			get { return (this.flags & 0x10000) != 0; }
			set {
				if (value)
					this.flags |= 0x10000;
				else
		...
		public bool IsRuntimeInternal {
			get { return (this.flags & 0x4000) != 0; }
			set {
				if (value)
					this.flags |= 0x4000;
				else
		...
		/// <value></value>
		public bool IsRuntimeSpecial {
			get { return (this.flags & 0x2000) != 0; }
			set {
				if (value)
					this.flags |= 0x2000;
				else
		...
		public bool IsSealed {
			get { return (this.flags & 0x1000) != 0; }
			set {
				if (value)
					this.flags |= 0x1000;
				else
...
//^ assume !this.IsStatic;
		...
		IEnumerable<IGenericMethodParameter> IMethodDefinition.GenericParameters {
			get {
				if (this.genericParameters == null)
					return Enumerable<IGenericMethodParameter>.Empty;
		...
		IEnumerable<IParameterTypeInformation> ISignature.Parameters {
			get {
				if (this.parameters == null)
					return Enumerable<IParameterTypeInformation>.Empty;
		...
		IEnumerable<IParameterDefinition> IMethodDefinition.Parameters {
			get {
				if (this.parameters == null)
					return Enumerable<IParameterDefinition>.Empty;
		...
		IEnumerable<IMethodReference> IPropertyDefinition.Accessors {
			get {
				if (this.Accessors == null)
					return Enumerable<IMethodReference>.Empty;
	...
	public abstract class TypeDefinitionMember : ITypeDefinitionMember, ICopyFrom<ITypeDefinitionMember>
	{
		...
		public override string ToString()
		{
			return MemberHelper.GetMemberSignature(this, NameFormattingOptions.ParameterModifiers | NameFormattingOptions.TypeParameters | NameFormattingOptions.ParameterName | NameFormattingOptions.ReturnType | NameFormattingOptions.Signature);
		}
