...
namespace System.Diagnostics.Contracts
{
	...
	{
		Immutable,
		// read-only after construction, except for lazy initialization & caches
		// Do we need a "deeply immutable" value?
		Mutable,
		HasInitializationPhase
		// read-only after some point.  
	...
	public static class Contract
	{
		...
		/// </summary>
		public static void AssertMustUseRewriter(ContractFailureKind kind, String contractKind)
		{
			// @TODO: localize this
		...
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
		#endif
		public static ulong WritableBytes(UIntPtr startAddress)
		{
			return MaxWritableExtent;
		}
		...
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
		#endif
		public static ulong WritableBytes(IntPtr startAddress)
		{
			return MaxWritableExtent;
		}
		...
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
		#endif
		unsafe public static ulong WritableBytes(void* startAddress)
		{
			return MaxWritableExtent;
		}
		...
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
		#endif
		public static ulong ReadableBytes(IntPtr startAddress)
		{
			return MaxWritableExtent;
		}
		...
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
		#endif
		unsafe public static ulong ReadableBytes(void* startAddress)
		{
			return MaxWritableExtent;
		}
		#endif
...
#endif
			add { Internal.ContractHelper.InternalContractFailed += value; }

			#if !SILVERLIGHT
			[SecurityPermission(SecurityAction.LinkDemand, Unrestricted = true)]
#endif
			remove { Internal.ContractHelper.InternalContractFailed -= value; }
		}
		#endif
...
namespace System.Diagnostics.Contracts.Internal
{
	public static class ContractHelper
	{
		...
		/// full trust.
		/// </summary>
		static internal event EventHandler<ContractFailedEventArgs> InternalContractFailed {
			#if !SILVERLIGHT
			[SecurityPermission(SecurityAction.LinkDemand, Unrestricted = true)]
			#endif
			add {
		...
		public static string RaiseContractFailedEvent(ContractFailureKind failureKind, String userMessage, String conditionText, Exception innerException)
		{
			...
			// Incomplete, but in case of OOM during resource lookup...
		...
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
		#endif
		public static String GetDisplayMessage(ContractFailureKind failureKind, String userMessage, String conditionText)
		{
		...
		[ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
		#endif
		public static void ReportFailure(ContractFailureKind failureKind, String userMessage, String conditionText, Exception innerException)
		{
			if (failureKind < ContractFailureKind.Precondition || failureKind > ContractFailureKind.Assume)
				throw new ArgumentException("failureKind is not in range", "failureKind");
			Contract.EndContractBlock();
