...
namespace System.Diagnostics.Contracts
{
	public class RuntimeContracts
	{
		...
		public static string KindToString(ContractFailureKind kind)
		{
		...
		public static void CountFailure(ContractFailureKind kind)
		{
			switch (kind) {
				case ContractFailureKind.Precondition:
		...
		public static void CountCheck(ContractFailureKind kind)
		{
			switch (kind) {
				case ContractFailureKind.Precondition:
