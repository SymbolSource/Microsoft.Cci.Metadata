...
namespace Microsoft.Cci
{
	...
	/// </summary>
	public sealed class MetadataReaderException : Exception
	{
		public MetadataReaderException(string message) : base(message)
		{
		}
	}
	...
	/// </summary>
	public sealed class MetadataReaderErrorsReporter : IMetadataReaderErrorsReporter
	{
	}
	...
	{
		public readonly MetadataReaderErrorsReporter ErrorsReporter;
		public readonly IMetadataReaderHost metadataReaderHost;
		//  In Multimodule case only the main module is added to this map.
		readonly Hashtable<Module> InternedIdToModuleMap;
		Assembly 		/*?*/coreAssembly;

		public readonly IName Value__;
		public readonly IName AsyncCallback;
		public readonly IName ParamArrayAttribute;
		public readonly IName IAsyncResult;
		public readonly IName ICloneable;
		public readonly IName RuntimeArgumentHandle;
		public readonly IName RuntimeFieldHandle;
		public readonly IName RuntimeMethodHandle;
		public readonly IName RuntimeTypeHandle;
		public readonly IName ArgIterator;
		public readonly IName IList;
		public readonly IName Mscorlib;
		public readonly IName System_Runtime;
		public readonly IName _Deleted_;
    ...
    ^*/
		...
		/// <param name="coreAssembly"></param>
			/*?*/		public void RegisterCoreAssembly(Assembly coreAssembly		)
		{
		...
		public void OpenMemberModules(IBinaryDocument binaryDocument, Assembly assembly)
		{
		...
		/// <returns></returns>
		public Assembly LookupAssembly(		/*?*/			/*?*/IModule referringModule		, AssemblyIdentity unifiedAssemblyIdentity)
		{
			lock (GlobalLock.LockingObject) {
		...
		/// <returns></returns>
		public Module LookupModule(		/*?*/			/*?*/IModule referringModule		, ModuleIdentity moduleIdentity)
		{
			lock (GlobalLock.LockingObject) {
		...
		public AssemblyIdentity GetAssemblyIdentifier(PEFileReader peFileReader)
		{
		...
		//^ ensures (result.Location != null && result.Location.Length != 0);
		public ModuleIdentity GetModuleIdentifier(PEFileReader peFileReader)
		{
		...
		//^ requires peFileReader.ReaderState >= ReaderState.Metadata;
		//^ ensures (result.Location != null && result.Location.Length != 0);
		public ModuleIdentity GetModuleIdentifier(PEFileReader peFileReader, AssemblyIdentity containingAssemblyIdentity)
		{
			ModuleRow moduleRow = peFileReader.ModuleTable[1];
			IName moduleName = this.metadataReaderHost.NameTable.GetNameFor(peFileReader.StringStream[moduleRow.Name]);
		...
		public class DefaultHost : MetadataReaderHost
		{
			...
			/// uses PeReader as its metadata reader.
			/// </summary>
			public DefaultHost() : base(new NameTable(), new InternFactory(), 0, null, true)
			{
			...
			/// </param>
			public DefaultHost(INameTable nameTable) : base(nameTable, new InternFactory(), 0, null, false)
			{
				this.peReader = new PeReader(this);
			}
