...
namespace Microsoft.Cci.MetadataReader.Errors
{
	...
	public sealed class DirectoryLocation : IDirectoryLocation
	{
		public readonly IBinaryDocument binaryDocument;
		public readonly Directories directory;
		public readonly uint offset;

		public DirectoryLocation(IBinaryDocument binaryDocument, Directories directory, uint offset)
		{
	...
	public sealed class MetadataStreamLocation : IMetadataStreamLocation
	{
		public readonly IBinaryDocument binaryDocument;
		public readonly string streamName;
		public readonly uint offset;

		public MetadataStreamLocation(IBinaryDocument binaryDocument, string streamName, uint offset)
		{
			this.binaryDocument = binaryDocument;
	...
	{
		public readonly IBinaryDocument binaryDocument;
		public readonly TableIndices tableIndex;
		public readonly uint rowId;

		public MetadataLocation(IBinaryDocument binaryDocument, TableIndices tableIndex, uint rowId)
		{
			this.binaryDocument = binaryDocument;
	...
	public sealed class MetadataReaderErrorMessage : IErrorMessage
	{
		private readonly object errorReporter;
		public readonly ILocation location;
		public readonly MetadataReaderErrorKind mrwErrorKind;

		public MetadataReaderErrorMessage(object errorReporter, ILocation location, MetadataReaderErrorKind mrwErrorKind)
		{
	...
	public enum MetadataReaderErrorKind : int
	{
		FileSizeTooSmall,
		DosHeader,
		PESignature,
	...
	public sealed class MetadataErrorContainer
	{
		...
		public MetadataErrorContainer(PeReader metadataReader, IBinaryDocument binaryDocument)
		{
			this.MetadataReader = metadataReader;
			this.BinaryDocument = binaryDocument;
			this.ErrorList = new MultiHashtable<MetadataReaderErrorMessage>();
		}
		public void AddMetadataReaderErrorMessage(MetadataReaderErrorMessage errMessage)
		{
			this.ErrorList.Add((uint)errMessage.mrwErrorKind, errMessage);
			this.MetadataReader.metadataReaderHost.ReportError(errMessage);
		}
		public void AddBinaryError(uint offset, MetadataReaderErrorKind errorKind)
		{
		...
		public void AddDirectoryError(Directories directory, uint offset, MetadataReaderErrorKind errorKind)
		{
			foreach (MetadataReaderErrorMessage errMessage in this.ErrorList.GetValuesFor((uint)errorKind)) {
		...
		public void AddMetadataStreamError(string streamName, uint offset, MetadataReaderErrorKind errorKind)
		{
			foreach (MetadataReaderErrorMessage errMessage in this.ErrorList.GetValuesFor((uint)errorKind)) {
		...
		public void AddMetadataError(TableIndices tableIndex, uint rowId, MetadataReaderErrorKind errorKind)
		{
			foreach (MetadataReaderErrorMessage errMessage in this.ErrorList.GetValuesFor((uint)errorKind)) {
		...
		public void AddILError(IMethodDefinition methodDefinition, uint offset, MetadataReaderErrorKind errorKind)
		{
			foreach (MetadataReaderErrorMessage errMessage in this.ErrorList.GetValuesFor((uint)errorKind)) {
