...
namespace Microsoft.Cci.MetadataReader.ObjectModelImplementation
{
	...
	public interface IMetadataReaderModuleReference : IModuleReference
	{
	...
	public abstract class ScopedContainerMetadataObject<InternalMemberType, ExternalMemberType, ExternalContainerType> : MetadataDefinitionObject, IContainer<ExternalMemberType>, IScope<ExternalMemberType> where InternalMemberType : class, ExternalMemberType where ExternalMemberType : class, IScopeMember<IScope<ExternalMemberType>>, IContainerMember<ExternalContainerType>
	{
		...
		public ScopedContainerMetadataObject(PEFileToObjectModel peFileToObjectModel) : base(peFileToObjectModel)
		{
			this.ContainerState = ContainerState.Initialized;
		}

		//^ ensures this.ContainerState == ContainerState.StartedLoading;
		public void StartLoadingMembers()
		{
		...
		public void AddMember(InternalMemberType member		)
		{
		...
		public void DoneLoadingMembers()
		{
		...
		public MultiHashtable<InternalMemberType>.ValuesEnumerable InternalMembers {
			get {
	...
	public class Module : MetadataObject, IModule, IMetadataReaderModuleReference
	{
		public readonly IName ModuleName;
		readonly COR20Flags Cor20Flags;
		public readonly uint InternedModuleId;
		public readonly ModuleIdentity ModuleIdentity;
		IMethodReference 		/*?*/entryPointMethodReference;

		public Module(PEFileToObjectModel peFileToObjectModel, IName moduleName, COR20Flags cor20Flags, uint internedModuleId, ModuleIdentity moduleIdentity) : base(peFileToObjectModel)
		{
		...
		public override uint TokenValue {
			get { return TokenTypeIds.Module | (uint)0x1; }
		}
		...
		ulong IModule.BaseAddress {
			get { return this.PEFileToObjectModel.PEFileReader.ImageBase; }
		}
		...
		IEnumerable<IAssemblyReference> IModule.AssemblyReferences {
			get { return this.PEFileToObjectModel.GetAssemblyReferences(); }
		}

		string IModule.DebugInformationLocation {
			get { return this.PEFileToObjectModel.GetDebugInformationLocation(); }
		}
		...
		IEnumerable<IWin32Resource> IModule.Win32Resources {
			get { return this.PEFileToObjectModel.GetWin32Resources(); }
		}

		IEnumerable<ICustomAttribute> IModule.ModuleAttributes {
			get { return this.PEFileToObjectModel.GetModuleCustomAttributes(); }
		}
		...
		IRootUnitNamespace IUnit.UnitNamespaceRoot {
			get { return this.PEFileToObjectModel.RootModuleNamespace; }
		}
	...
	public sealed class Assembly : Module, IAssembly, IMetadataReaderModuleReference
	{
		...
		public IModule[] 		/*?*/MemberModules;

		//^ requires peFileToObjectModel.PEFileReader.IsAssembly;
		public Assembly(PEFileToObjectModel peFileToObjectModel, IName moduleName, COR20Flags corFlags, uint internedModuleId, AssemblyIdentity assemblyIdentity, IName assemblyName, AssemblyFlags assemblyFlags, byte[] publicKey) : base(peFileToObjectModel, moduleName, corFlags, internedModuleId, assemblyIdentity)
		{
		...
		public override uint TokenValue {
			get { return TokenTypeIds.Assembly | (uint)0x1; }
		}

		public IModule FindMemberModuleNamed(		/*?*/IName moduleName)
		{
			IModule[] 			/*?*/memberModuleArray = this.MemberModules;
			if (memberModuleArray == null)
				return null;
		...
		public void SetMemberModules(IModule[] memberModules)
		{
		...
		IEnumerable<IResourceReference> IAssembly.Resources {
			get { return this.PEFileToObjectModel.GetResources(); }
		}

		IEnumerable<IFileReference> IAssembly.Files {
			get { return this.PEFileToObjectModel.GetFiles(); }
		}
		...
		IEnumerable<byte> IAssemblyReference.PublicKey {
			get { return IteratorHelper.GetReadonly(this.publicKey); }
		}

		IEnumerable<ICustomAttribute> IAssembly.AssemblyAttributes {
			get { return this.PEFileToObjectModel.GetAssemblyCustomAttributes(); }
		}
	...
	public sealed class ModuleReference : MetadataObject, IMetadataReaderModuleReference
	{
		readonly uint ModuleRefRowId;
		public readonly uint InternedId;
		public readonly ModuleIdentity ModuleIdentity;
		IModule 		/*?*/resolvedModule;

		public ModuleReference(PEFileToObjectModel peFileToObjectModel, uint moduleRefRowId, uint internedId, ModuleIdentity moduleIdentity) : base(peFileToObjectModel)
		{
	...
	public sealed class AssemblyReference : MetadataObject, IAssemblyReference, IMetadataReaderModuleReference
	{
		readonly uint AssemblyRefRowId;
		public readonly AssemblyIdentity AssemblyIdentity;
		AssemblyFlags AssemblyFlags;

		public AssemblyReference(PEFileToObjectModel peFileToObjectModel, uint assemblyRefRowId, AssemblyIdentity assemblyIdentity, AssemblyFlags assemblyFlags) : base(peFileToObjectModel)
		{
		...
		IEnumerable<byte> IAssemblyReference.PublicKey {
			get {
				if ((this.AssemblyFlags & PEFileFlags.AssemblyFlags.PublicKey) == 0)
					return Enumerable<byte>.Empty;
	...
	public abstract class Namespace : ScopedContainerMetadataObject<INamespaceMember, INamespaceMember, INamespaceDefinition>, IUnitNamespace
	{
		public readonly IName NamespaceName;
		public readonly IName NamespaceFullName;
		uint namespaceNameOffset;
		public Namespace(PEFileToObjectModel peFileToObjectModel, IName namespaceName, IName namespaceFullName) : base(peFileToObjectModel)
		{
			this.NamespaceName = namespaceName;
			this.NamespaceFullName = namespaceFullName;
			this.namespaceNameOffset = 0xffffffffu;
		}

		public void SetNamespaceNameOffset(uint namespaceNameOffset)
		{
			this.namespaceNameOffset = namespaceNameOffset;
		}

		public uint NamespaceNameOffset {
			get { return this.namespaceNameOffset; }
		}
		...
		public override void LoadMembers()
		{
			...
			lock (GlobalLock.LockingObject) {
				if (this.ContainerState == ContainerState.Loaded)
					return;
				this.StartLoadingMembers();
				if (this.namespaceNameOffset != 0xffffffffu)
	...
	public sealed class RootNamespace : Namespace, IRootUnitNamespace
	{
		public RootNamespace(PEFileToObjectModel peFileToObjectModel) : base(peFileToObjectModel, peFileToObjectModel.NameTable.EmptyName, peFileToObjectModel.NameTable.EmptyName)
		{
	...
	public sealed class NestedNamespace : Namespace, INestedUnitNamespace
	{
		readonly Namespace ParentModuleNamespace;

		public NestedNamespace(PEFileToObjectModel peFileToObjectModel, IName namespaceName, IName namespaceFullName, Namespace parentModuleNamespace) : base(peFileToObjectModel, namespaceName, namespaceFullName)
		{
	...
	public abstract class NamespaceReference : MetadataObject, IUnitNamespaceReference
	{
		public readonly IName NamespaceName;
		public readonly IName NamespaceFullName;
		public readonly IMetadataReaderModuleReference ModuleReference;

		public NamespaceReference(PEFileToObjectModel peFileToObjectModel, IMetadataReaderModuleReference moduleReference, IName namespaceName, IName namespaceFullName) : base(peFileToObjectModel)
		{
			this.NamespaceName = namespaceName;
		...
		public override sealed void Dispatch(IMetadataVisitor visitor)
		{
		...
		public abstract IUnitNamespace ResolvedUnitNamespace { get; }
	...
	public sealed class RootNamespaceReference : NamespaceReference, IRootUnitNamespaceReference
	{
		public RootNamespaceReference(PEFileToObjectModel peFileToObjectModel, IMetadataReaderModuleReference moduleReference) : base(peFileToObjectModel, moduleReference, peFileToObjectModel.NameTable.EmptyName, peFileToObjectModel.NameTable.EmptyName)
		{
		}
		...
		public override IUnitNamespace ResolvedUnitNamespace {
			get { return this.ModuleReference.ResolvedModule.UnitNamespaceRoot; }
		}
	}

	public sealed class NestedNamespaceReference : NamespaceReference, INestedUnitNamespaceReference
	{
		readonly NamespaceReference ParentModuleNamespaceReference;
		INestedUnitNamespace 		/*?*/resolvedNamespace;

		public NestedNamespaceReference(PEFileToObjectModel peFileToObjectModel, IName namespaceName, IName namespaceFullName, NamespaceReference parentModuleNamespaceReference) : base(peFileToObjectModel, parentModuleNamespaceReference.ModuleReference, namespaceName, namespaceFullName)
		{
		...
		public INestedUnitNamespace ResolvedNestedUnitNamespace {
			get {
				if (this.resolvedNamespace == null) {
					foreach (INestedUnitNamespace nestedUnitNamespace in IteratorHelper.GetFilterEnumerable<INamespaceMember, INestedUnitNamespace>(this.ParentModuleNamespaceReference.ResolvedUnitNamespace.GetMembersNamed(this.NamespaceName, false))) {
	...
	public abstract class TypeMember : MetadataDefinitionObject, ITypeDefinitionMember
	{
		public readonly IName MemberName;
		public readonly TypeBase OwningModuleType;

		public TypeMember(PEFileToObjectModel peFileToObjectModel, IName memberName, TypeBase owningModuleType) : base(peFileToObjectModel)
		{
	...
	public class FieldDefinition : TypeMember, IFieldDefinition
	{
		public readonly uint FieldDefRowId;
		...
		public FieldDefinition(PEFileToObjectModel peFileToObjectModel, IName memberName, TypeBase parentModuleType, uint fieldDefRowId, FieldFlags fieldFlags) : base(peFileToObjectModel, memberName, parentModuleType)
		{
		...
		public void InitFieldSignature()
		{
			lock (GlobalLock.LockingObject) {
	...
	public sealed class GlobalFieldDefinition : FieldDefinition, IGlobalFieldDefinition
	{
		readonly Namespace ParentModuleNamespace;
		readonly IName NamespaceMemberName;

		public GlobalFieldDefinition(PEFileToObjectModel peFileToObjectModel, IName typeMemberName, TypeBase parentModuleType, uint fieldDefRowId, FieldFlags fieldFlags, IName namespaceMemberName, Namespace parentModuleNamespace) : base(peFileToObjectModel, typeMemberName, parentModuleType, fieldDefRowId, fieldFlags)
		{
	...
	public sealed class SectionBlock : ISectionBlock
	{
		readonly PESectionKind PESectionKind;
		readonly uint Offset;
		readonly MemoryBlock MemoryBlock;
		public SectionBlock(PESectionKind peSectionKind, uint offset, MemoryBlock memoryBlock)
		{
	...
	public sealed class ReturnParameter : MetadataObject
	{
		private readonly IName name;
		public readonly ParamFlags ReturnParamFlags;
		public readonly uint ReturnParamRowId;
		public override uint TokenValue {
			get { return TokenTypeIds.ParamDef | this.ReturnParamRowId; }
		}
		public ReturnParameter(PEFileToObjectModel peFileToObjectModel, IName name, ParamFlags returnParamFlags, uint returnParamRowId) : base(peFileToObjectModel)
		{
			this.name = name;
	...
	public sealed class PESection : IPESection
	{
		...
		public PESection(SectionHeader[] sectionHeaders, int index, IName sectionName, PEFileToObjectModel peFileToObjectModel)
		{
	...
	public sealed class PlatformInvokeInformation : IPlatformInvokeInformation
	{
		readonly PInvokeMapFlags PInvokeMapFlags;
		readonly IName ImportName;
		readonly ModuleReference ImportModule;

		public PlatformInvokeInformation(PInvokeMapFlags pInvokeMapFlags, IName importName, ModuleReference importModule)
		{
		...
		bool? IPlatformInvokeInformation.ThrowExceptionForUnmappableChar {
			get {
				switch (this.PInvokeMapFlags & PInvokeMapFlags.ThrowOnUnmappableCharMask) {
					case PInvokeMapFlags.EnabledThrowOnUnmappableChar:
						return true;
					case PInvokeMapFlags.DisabledThrowOnUnmappableChar:
						return false;
					default:
						return null;
				}
		...
		bool? IPlatformInvokeInformation.UseBestFit {
			get {
				switch (this.PInvokeMapFlags & PInvokeMapFlags.BestFitMask) {
					case PInvokeMapFlags.EnabledBestFit:
						return true;
					case PInvokeMapFlags.DisabledBestFit:
						return false;
					default:
						return null;
				}
	...
	public abstract class MethodDefinition : TypeMember, IMethodDefinition, ITokenDecoder
	{
		public readonly uint MethodDefRowId;
		public MethodFlags MethodFlags;
		public MethodImplFlags MethodImplFlags;
		...
		public MethodDefinition(PEFileToObjectModel peFileToObjectModel, IName memberName, TypeBase parentModuleType, uint methodDefRowId, MethodFlags methodFlags, MethodImplFlags methodImplFlags) : base(peFileToObjectModel, memberName, parentModuleType)
		{
		...
		public void InitMethodSignature()
		{
		...
		public bool IsExternal {
			get { return this.IsPlatformInvoke || this.IsRuntimeInternal || this.IsRuntimeImplemented || this.PEFileToObjectModel.PEFileReader.GetMethodIL(this.MethodDefRowId) == null; }
		}
		...
		public bool ReturnValueIsMarshalledExplicitly {
			get { return this.returnParameter != null && this.returnParameter.IsMarshalledExplicitly; }
		}

		public IMarshallingInformation ReturnValueMarshallingInformation {
			get { return this.returnParameter == null ? Dummy.MarshallingInformation : this.returnParameter.MarshallingInformation; }
		}

		public IName ReturnValueName {
			get { return this.returnParameter == null ? Dummy.Name : this.returnParameter.Name; }
		}
		...
		public IParameterDefinition[] RequiredModuleParameters {
			/*?*/			get {
				if (this.returnType == null) {
					this.InitMethodSignature();
				}
	...
	public class NonGenericMethod : MethodDefinition
	{
		public NonGenericMethod(PEFileToObjectModel peFileToObjectModel, IName memberName, TypeBase parentModuleType, uint methodDefRowId, MethodFlags methodFlags, MethodImplFlags methodImplFlags) : base(peFileToObjectModel, memberName, parentModuleType, methodDefRowId, methodFlags, methodImplFlags)
		{
		}
	...
	public sealed class GlobalNonGenericMethod : NonGenericMethod, IGlobalMethodDefinition
	{
		readonly Namespace ParentModuleNamespace;
		readonly IName NamespaceMemberName;

		public GlobalNonGenericMethod(PEFileToObjectModel peFileToObjectModel, IName memberName, TypeBase parentModuleType, uint methodDefRowId, MethodFlags methodFlags, MethodImplFlags methodImplFlags, IName namespaceMemberName, Namespace parentModuleNamespace) : base(peFileToObjectModel, memberName, parentModuleType, methodDefRowId, methodFlags, methodImplFlags)
		{
			this.NamespaceMemberName = namespaceMemberName;
			this.ParentModuleNamespace = parentModuleNamespace;
		}
	...
	public class GenericMethod : MethodDefinition
	{
		public readonly uint GenericParamRowIdStart;
		public readonly uint GenericParamRowIdEnd;

		public GenericMethod(PEFileToObjectModel peFileToObjectModel, IName memberName, TypeBase parentModuleType, uint methodDefRowId, MethodFlags methodFlags, MethodImplFlags methodImplFlags, uint genericParamRowIdStart, uint genericParamRowIdEnd) : base(peFileToObjectModel, memberName, parentModuleType, methodDefRowId, methodFlags, methodImplFlags)
		{
	...
	public sealed class GlobalGenericMethod : GenericMethod, IGlobalMethodDefinition
	{
		readonly Namespace ParentModuleNamespace;
		readonly IName NamespaceMemberName;

		public GlobalGenericMethod(PEFileToObjectModel peFileToObjectModel, IName memberName, TypeBase parentModuleType, uint methodDefRowId, MethodFlags methodFlags, MethodImplFlags methodImplFlags, uint genericParamRowIdStart, uint genericParamRowIdEnd, IName namespaceMemberName, Namespace parentModuleNamespace) : base(peFileToObjectModel, memberName, parentModuleType, methodDefRowId, methodFlags, methodImplFlags, genericParamRowIdStart, genericParamRowIdEnd)
		{
			this.NamespaceMemberName = namespaceMemberName;
			this.ParentModuleNamespace = parentModuleNamespace;
		}
	...
	/// 
	/// </summary>
	public sealed class GenericMethodInstanceReferenceWithToken : GenericMethodInstanceReference, IMetadataObjectWithToken
	{
		...
		/// </param>
		public GenericMethodInstanceReferenceWithToken(IMethodReference genericMethod, IEnumerable<ITypeReference> genericArguments, IInternFactory internFactory, uint tokenValue) : base(genericMethod, genericArguments, internFactory)
		{
	...
	public sealed class EventDefinition : TypeMember, IEventDefinition
	{
		public readonly uint EventRowId;
		...
		public EventDefinition(PEFileToObjectModel peFileToObjectModel, IName memberName, TypeBase parentModuleType, uint eventRowId, EventFlags eventFlags) : base(peFileToObjectModel, memberName, parentModuleType)
		{
		...
		public IMethodDefinition AdderMethod {
			get {
		...
		public IMethodDefinition RemoverMethod {
			get {
		...
		public IMethodDefinition FireMethod {
			/*?*/			get {
	...
	public sealed class PropertyDefinition : TypeMember, IPropertyDefinition
	{
		public readonly uint PropertyRowId;
		...
		public PropertyDefinition(PEFileToObjectModel peFileToObjectModel, IName memberName, TypeBase containingType, uint propertyRowId, PropertyFlags propertyFlags) : base(peFileToObjectModel, memberName, containingType)
		{
		...
		public void InitPropertySignature()
		{
			lock (GlobalLock.LockingObject) {
		...
		public IEnumerable<ICustomModifier> ReturnModuleCustomModifiers {
			get {
				if (this.returnValueCustomModifiers == null) {
		...
		public IMethodDefinition GetterMethod {
			/*?*/			get {
		...
		public IMethodDefinition SetterMethod {
			/*?*/			get {
		...
		public IEnumerable<ICustomModifier> ReturnValueCustomModifiers {
			get { return this.ReturnModuleCustomModifiers; }
		}
		...
		public CallingConvention CallingConvention {
			get {
				...
				return (CallingConvention)(this.FirstSignatureByte & ~0x8);
			}
		}
	...
	public abstract class MemberReference : MetadataObject, ITypeMemberReference
	{
		public readonly uint MemberRefRowId;
		public readonly IName Name;
		public readonly ITypeReference 		/*?*/ParentTypeReference;

			/*?*/		public MemberReference(PEFileToObjectModel peFileToObjectModel, uint memberRefRowId, ITypeReference parentTypeReference		, IName name) : base(peFileToObjectModel)
		{
		...
		public abstract ITypeDefinitionMember ResolvedTypeDefinitionMember { get; }
	...
	{
		public bool signatureLoaded;
		public IEnumerable<ICustomModifier> 		/*?*/customModifiers;
		public ITypeReference 		/*?*/typeReference;
		public bool isStatic;
			/*?*/		public FieldReference(PEFileToObjectModel peFileToObjectModel, uint memberRefRowId, ITypeReference parentTypeReference		, IName name) : base(peFileToObjectModel, memberRefRowId, parentTypeReference, name)
		{
		}
		...
		public virtual void InitFieldSignature()
		{
	...
	public class MethodReference : MemberReference, IMethodReference
	{
		...
		public ITypeReference 		/*?*/returnTypeReference;
		public bool isReturnByReference;
		public IParameterTypeInformation[] 		/*?*/requiredParameters;
		public IParameterTypeInformation[] 		/*?*/varArgParameters;

			/*?*/		public MethodReference(PEFileToObjectModel peFileToObjectModel, uint memberRefRowId, ITypeReference parentTypeReference		, IName name, byte firstByte) : base(peFileToObjectModel, memberRefRowId, parentTypeReference, name)
		{
		...
		public virtual void InitMethodSignature()
		{
			lock (GlobalLock.LockingObject) {
		...
		public ushort ParameterCount {
			get {
				...
				if (this.RequiredModuleParameterInfos == null)
					return 0;
				if (this.VarArgModuleParameterInfos == null)
					return (ushort)this.RequiredModuleParameterInfos.Length;
	...
	public sealed class ByValArrayMarshallingInformation : IMarshallingInformation
	{
		readonly System.Runtime.InteropServices.UnmanagedType arrayElementType;
		readonly uint numberOfElements;

		public ByValArrayMarshallingInformation(System.Runtime.InteropServices.UnmanagedType arrayElementType, uint numberOfElements)
		{
	...
	public sealed class ByValTStrMarshallingInformation : IMarshallingInformation
	{
		readonly uint numberOfElements;

		public ByValTStrMarshallingInformation(uint numberOfElements)
		{
			this.numberOfElements = numberOfElements;
		}
	...
	public sealed class IidParameterIndexMarshallingInformation : IMarshallingInformation
	{
		readonly uint iidParameterIndex;

		public IidParameterIndexMarshallingInformation(uint iidParameterIndex)
		{
	...
	public sealed class LPArrayMarshallingInformation : IMarshallingInformation
	{
		readonly System.Runtime.InteropServices.UnmanagedType ArrayElementType;
		int paramIndex;
		uint numElement;

		public LPArrayMarshallingInformation(System.Runtime.InteropServices.UnmanagedType arrayElementType, int paramIndex, uint numElement)
		{
			this.ArrayElementType = arrayElementType;
	...
	public sealed class SafeArrayMarshallingInformation : IMarshallingInformation
	{
		...
		public SafeArrayMarshallingInformation(System.Runtime.InteropServices.VarEnum arrayElementType, ITypeReference safeArrayElementUserDefinedSubType)
		{
			this.ArrayElementType = arrayElementType;
	...
	public sealed class SimpleMarshallingInformation : IMarshallingInformation
	{
		readonly System.Runtime.InteropServices.UnmanagedType unmanagedType;

		public SimpleMarshallingInformation(System.Runtime.InteropServices.UnmanagedType unmanagedType)
		{
	...
	public sealed class CustomMarshallingInformation : IMarshallingInformation
	{
		readonly ITypeReference Marshaller;
		readonly string MarshallerRuntimeArgument;

		public CustomMarshallingInformation(ITypeReference marshaller, string marshallerRuntimeArgument)
		{
	...
	public sealed class Win32Resource : IWin32Resource
	{
		public readonly PEFileToObjectModel PEFileToObjectModel;
		public readonly int TypeIdOrName;
		public readonly int IdOrName;
		public readonly int LanguageIdOrName;
		public readonly int RVAToData;
		public readonly uint Size;
		public readonly uint CodePage;

		public Win32Resource(PEFileToObjectModel peFileTOObjectModel, int typeIdOrName, int idOrName, int languageIdOrName, int rvaToData, uint size, uint codePage)
		{
			this.PEFileToObjectModel = peFileTOObjectModel;
		...
		public string TypeName {
			get { return this.PEFileToObjectModel.GetWin32ResourceName(this.TypeIdOrName); }
		}
		...
		public string Name {
			get { return this.PEFileToObjectModel.GetWin32ResourceName(this.IdOrName); }
		}
		...
		public IEnumerable<byte> Data {
			get { return this.PEFileToObjectModel.GetWin32ResourceBytes(this.RVAToData, (int)this.Size); }
		}

		#endregion
	}

	public sealed class FileReference : MetadataObject, IFileReference
	{
		public readonly uint FileRowId;
		public readonly FileFlags FileFlags;
		public readonly IName Name;
		public FileReference(PEFileToObjectModel peFileToObjectModel, uint fileRowId, FileFlags fileFlags, IName name) : base(peFileToObjectModel)
		{
		...
		public override uint TokenValue {
			get { return TokenTypeIds.File | this.FileRowId; }
		}
		...
		public IEnumerable<byte> HashValue {
			get { return this.PEFileToObjectModel.GetFileHash(this.FileRowId); }
		}

		#endregion
	}

	public class ResourceReference : MetadataObject, IResourceReference
	{
		public readonly uint ResourceRowId;
		readonly IAssemblyReference DefiningAssembly;
		public readonly ManifestResourceFlags Flags;
		public readonly IName Name;
		IResource 		/*?*/resolvedResource;

		public ResourceReference(PEFileToObjectModel peFileToObjectModel, uint resourceRowId, IAssemblyReference definingAssembly, ManifestResourceFlags flags, IName name) : base(peFileToObjectModel)
		{
	...
	public sealed class Resource : ResourceReference, IResource
	{
		...
		public IEnumerable<byte> Data {
			get { return this.PEFileToObjectModel.GetResourceData(this); }
		}
