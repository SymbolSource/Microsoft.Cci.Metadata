...
namespace Microsoft.Cci.MetadataReader.PEFile
{
	...
	public struct StringStreamReader
	{
	...
	public struct BlobStreamReader
	{
		...
		//^ requires offset >= 0 && offset < this.MemoryReader.Length;
		public byte GetByteAt(uint offset, int index)
		{
			int bytesRead;
			int numberOfBytes = this.MemoryReader.PeekCompressedInt32((int)offset, out bytesRead);
		...
		//^ requires offset >= 0 && offset < this.MemoryReader.Length;
		public MemoryBlock GetMemoryBlockAt(uint offset)
		{
			uint bytesRead;
	...
	public struct GUIDStreamReader
	{
		public MemoryReader MemoryReader;
		public Guid this[uint offset] {
	...
	public struct UserStringStreamReader
	{
		public MemoryReader MemoryReader;
		public string this[uint offset] {
			//^ requires offset >= 0 && offset < this.MemoryReader.Length;
	...
	unsafe public struct ModuleTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsStringHeapRefSizeSmall;
		public readonly bool IsGUIDHeapRefSizeSmall;
		public readonly uint GenerationOffset;
		public readonly uint NameOffset;
		public readonly uint MVIdOffset;
		public readonly uint EnCIdOffset;
		public readonly uint EnCBaseIdOffset;
		public readonly uint RowSize;
		public readonly MemoryReader ModuleTableMemoryReader;

		public ModuleTableReader(uint numberOfRows, int stringHeapRefSize, int guidHeapRefSize, byte* buffer)
		{
		...
		public ModuleRow this[uint rowId] {
			//  This is 1 based...
		...
		public uint GetName(uint rowId)
		{
			uint rowOffset = (rowId - 1) * this.RowSize;
			uint name = this.ModuleTableMemoryReader.PeekReference(rowOffset + this.NameOffset, this.IsStringHeapRefSizeSmall);
			return name;
	...
	unsafe public struct TypeRefTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsResolutionScopeRefSizeSmall;
		public readonly bool IsStringHeapRefSizeSmall;
		public readonly int ResolutionScopeOffset;
		public readonly int NameOffset;
		public readonly int NamespaceOffset;
		public readonly int RowSize;
		public readonly MemoryReader TypeRefTableMemoryReader;
		public TypeRefTableReader(uint numberOfRows, int resolutionScopeRefSize, int stringHeapRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
		...
		public TypeRefRow this[uint rowId] {
			//  This is 1 based...
			//^ requires rowId > 0 && rowId <= this.NumberOfRows;
			get {
	...
	unsafe public struct TypeDefTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsFieldRefSizeSmall;
		public readonly bool IsMethodRefSizeSmall;
		public readonly bool IsTypeDefOrRefRefSizeSmall;
		public readonly bool IsStringHeapRefSizeSmall;
		public readonly int FlagsOffset;
		public readonly int NameOffset;
		public readonly int NamespaceOffset;
		public readonly int ExtendsOffset;
		public readonly int FieldListOffset;
		public readonly int MethodListOffset;
		public int RowSize;
		public MemoryReader TypeDefTableMemoryReader;
		public TypeDefTableReader(uint numberOfRows, int fieldRefSize, int methodRefSize, int typeDefOrRefRefSize, int stringHeapRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
		...
		public TypeDefRow this[uint rowId] {
			//  This is 1 based...
		...
		//^ requires rowId <= this.NumberOfRows;
		public uint GetNamespace(uint rowId)
		{
			int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		public uint GetExtends(uint rowId)
		{
			int rowOffset = (int)(rowId - 1) * this.RowSize;
			uint extends = this.TypeDefTableMemoryReader.PeekReference(rowOffset + this.ExtendsOffset, this.IsTypeDefOrRefRefSizeSmall);
		...
		//^ requires rowId <= this.NumberOfRows;
		public uint GetFieldStart(uint rowId)
		{
			int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		//^ requires rowId <= this.NumberOfRows;
		public uint GetMethodStart(uint rowId)
		{
			int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		public uint FindTypeContainingMethod(uint methodDefOrPtrRowId, int numberOfMethods)
		{
		...
		public uint FindTypeContainingField(uint fieldDefOrPtrRowId, int numberOfFields)
		{
			uint numOfRows = this.NumberOfRows;
	...
	unsafe public struct FieldPtrTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsFieldTableRowRefSizeSmall;
		public readonly int FieldOffset;
		public readonly int RowSize;
		public readonly MemoryReader FieldPtrTableMemoryReader;
		public FieldPtrTableReader(uint numberOfRows, int fieldTableRowRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
		...
		#if false
		public FieldPtrRow this[uint rowId] {
			//  This is 1 based...
			//^ requires rowId <= this.NumberOfRows;
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		#endif
		public uint GetFieldFor(uint rowId)
		{
			int rowOffset = (int)(rowId - 1) * this.RowSize;
			uint field = this.FieldPtrTableMemoryReader.PeekReference(rowOffset + this.FieldOffset, this.IsFieldTableRowRefSizeSmall);
			return field;
		}
		public uint GetRowIdForFieldDefRow(uint fieldDefRowId)
		{
	...
	unsafe public struct FieldTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsStringHeapRefSizeSmall;
		...
		public readonly int RowSize;
		public readonly MemoryReader FieldTableMemoryReader;
		public FieldTableReader(uint numberOfRows, int stringHeapRefSize, int blobHeapRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
			this.IsStringHeapRefSizeSmall = stringHeapRefSize == 2;
		...
		public FieldRow this[uint rowId] {
			//  This is 1 based...
			//^ requires rowId <= this.NumberOfRows;
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		//^ requires rowId <= this.NumberOfRows;
		public uint GetSignature(uint rowId)
		{
			int rowOffset = (int)(rowId - 1) * this.RowSize;
			uint signature = this.FieldTableMemoryReader.PeekReference(rowOffset + this.SignatureOffset, this.IsBlobHeapRefSizeSmall);
			return signature;
	...
	unsafe public struct MethodPtrTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsMethodTableRowRefSizeSmall;
		public readonly int MethodOffset;
		public readonly int RowSize;
		public readonly MemoryReader MethodPtrTableMemoryReader;
		public MethodPtrTableReader(uint numberOfRows, int methodTableRowRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
		...
		#if false
		public MethodPtrRow this[uint rowId] {
			//  This is 1 based...
			//^ requires rowId <= this.NumberOfRows;
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		#endif
		public uint GetMethodFor(uint rowId)
		{
			int rowOffset = (int)(rowId - 1) * this.RowSize;
			uint method = this.MethodPtrTableMemoryReader.PeekReference(rowOffset + this.MethodOffset, this.IsMethodTableRowRefSizeSmall);
			return method;
		}
		public uint GetRowIdForMethodDefRow(uint methodDefRowId)
		{
	...
	unsafe public struct MethodTableReader
	{
		public readonly uint NumberOfRows;
		...
		public readonly int RowSize;
		public readonly MemoryReader MethodTableMemoryReader;
		public MethodTableReader(uint numberOfRows, int paramRefSize, int stringHeapRefSize, int blobHeapRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
		...
		public MethodRow this[uint rowId] {
			//  This is 1 based...
			//^ requires rowId <= this.NumberOfRows;
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		//^ requires rowId <= this.NumberOfRows;
		public uint GetParamStart(uint rowId)
		{
			int rowOffset = (int)(rowId - 1) * this.RowSize;
	...
	unsafe public struct ParamPtrTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsParamTableRowRefSizeSmall;
		public readonly int ParamOffset;
		public readonly int RowSize;
		public readonly MemoryReader ParamPtrTableMemoryReader;
		public ParamPtrTableReader(uint numberOfRows, int paramTableRowRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
		...
		#if false
		public ParamPtrRow this[uint rowId] {
			//  This is 1 based...
			//^ requires rowId <= this.NumberOfRows;
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		#endif
		public uint GetParamFor(uint rowId)
		{
			int rowOffset = (int)(rowId - 1) * this.RowSize;
			uint param = this.ParamPtrTableMemoryReader.PeekReference(rowOffset + this.ParamOffset, this.IsParamTableRowRefSizeSmall);
			return param;
	...
	unsafe public struct ParamTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsStringHeapRefSizeSmall;
		public readonly int FlagsOffset;
		...
		public readonly int NameOffset;
		public readonly int RowSize;
		public readonly MemoryReader ParamTableMemoryReader;
		public ParamTableReader(uint numberOfRows, int stringHeapRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
			this.IsStringHeapRefSizeSmall = stringHeapRefSize == 2;
			this.FlagsOffset = 0;
		...
		public ParamRow this[uint rowId] {
			//  This is 1 based...
			//^ requires rowId <= this.NumberOfRows;
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
	...
	unsafe public struct InterfaceImplTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsTypeDefTableRowRefSizeSmall;
		public readonly bool IsTypeDefOrRefRefSizeSmall;
		public readonly int ClassOffset;
		public readonly int InterfaceOffset;
		public readonly int RowSize;
		public readonly MemoryReader InterfaceImplTableMemoryReader;
		public InterfaceImplTableReader(uint numberOfRows, int typeDefTableRowRefSize, int typeDefOrRefRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
		...
		#if false
		public InterfaceImplRow this[uint rowId] {
			//  This is 1 based...
			//^ requires rowId <= this.NumberOfRows;
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		#endif
		public uint FindInterfaceImplForType(uint typeDefRowId, out uint interfaceCount)
		{
			interfaceCount = 0;
			int foundRowNumber = this.InterfaceImplTableMemoryReader.BinarySearchReference(this.NumberOfRows, this.RowSize, this.ClassOffset, typeDefRowId, this.IsTypeDefOrRefRefSizeSmall);
			if (foundRowNumber == -1)
				return 0;
			int startRowNumber = foundRowNumber;
			while (startRowNumber > 0 && this.InterfaceImplTableMemoryReader.PeekReference((startRowNumber - 1) * this.RowSize + this.ClassOffset, this.IsTypeDefOrRefRefSizeSmall) == typeDefRowId) {
				startRowNumber--;
			}
			int endRowNumber = foundRowNumber;
			while (endRowNumber + 1 < this.NumberOfRows && this.InterfaceImplTableMemoryReader.PeekReference((endRowNumber + 1) * this.RowSize + this.ClassOffset, this.IsTypeDefOrRefRefSizeSmall) == typeDefRowId) {
				endRowNumber++;
			}
			interfaceCount = (uint)(endRowNumber - startRowNumber + 1);
			return (uint)startRowNumber + 1;
		}
		public uint GetInterface(uint rowId)
		{
			int rowOffset = (int)(rowId - 1) * this.RowSize;
			uint @interface = this.InterfaceImplTableMemoryReader.PeekReference(rowOffset + this.InterfaceOffset, this.IsTypeDefOrRefRefSizeSmall);
			@interface = TypeDefOrRefTag.ConvertToToken(@interface);
	...
	unsafe public struct MemberRefTableReader
	{
		public uint NumberOfRows;
		public readonly bool IsMemberRefParentRefSizeSmall;
		public readonly bool IsStringHeapRefSizeSmall;
		public readonly bool IsBlobHeapRefSizeSmall;
		public readonly int ClassOffset;
		public readonly int NameOffset;
		public readonly int SignatureOffset;
		public int RowSize;
		public MemoryReader MemberRefTableMemoryReader;
		public MemberRefTableReader(uint numberOfRows, int memberRefParentRefSize, int stringHeapRefSize, int blobHeapRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
		...
		public MemberRefRow this[uint rowId] {
			//  This is 1 based...
			//^ requires rowId <= this.NumberOfRows;
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
	...
	unsafe public struct ConstantTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsHasConstantRefSizeSmall;
		public readonly bool IsBlobHeapRefSizeSmall;
		public readonly int TypeOffset;
		public readonly int ParentOffset;
		public readonly int ValueOffset;
		public readonly int RowSize;
		public readonly MemoryReader ConstantTableMemoryReader;
		public ConstantTableReader(uint numberOfRows, int hasConstantRefSize, int blobHeapRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
			this.IsHasConstantRefSizeSmall = hasConstantRefSize == 2;
			this.IsBlobHeapRefSizeSmall = blobHeapRefSize == 2;
			this.TypeOffset = 0;
			this.ParentOffset = this.TypeOffset + sizeof(Byte) + 1;
			//  Alignment here (+1)...
		...
		public ConstantRow this[uint rowId] {
			//  This is 1 based...
			//^ requires rowId <= this.NumberOfRows;
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		public uint GetConstantRowId(uint parentToken)
		{
			int foundRowNumber = this.ConstantTableMemoryReader.BinarySearchReference(this.NumberOfRows, this.RowSize, this.ParentOffset, HasConstantTag.ConvertToTag(parentToken), this.IsHasConstantRefSizeSmall);
			return (uint)(foundRowNumber + 1);
		}
	}

	unsafe public struct CustomAttributeTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsHasCustomAttributeRefSizeSmall;
		public readonly bool IsCustomAttriubuteTypeRefSizeSmall;
		public readonly bool IsBlobHeapRefSizeSmall;
		public readonly int ParentOffset;
		public readonly int TypeOffset;
		public readonly int ValueOffset;
		public readonly int RowSize;
		public readonly MemoryReader CustomAttributeTableMemoryReader;
		public CustomAttributeTableReader(uint numberOfRows, int hasCustomAttributeRefSize, int customAttributeTypeRefSize, int blobHeapRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
		...
		public CustomAttributeRow this[uint rowId] {
			//  This is 1 based...
			//^ requires rowId <= this.NumberOfRows;
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		public uint FindCustomAttributesForToken(uint token, out uint customAttributeCount)
		{
		...
		public uint BinarySearchTag(uint searchCodedTag, ref uint customAttributeCount)
		{
			int foundRowNumber = this.CustomAttributeTableMemoryReader.BinarySearchReference(this.NumberOfRows, this.RowSize, this.ParentOffset, searchCodedTag, this.IsHasCustomAttributeRefSizeSmall);
			if (foundRowNumber == -1)
				return 0;
			int startRowNumber = foundRowNumber;
			while (startRowNumber > 0 && this.CustomAttributeTableMemoryReader.PeekReference((startRowNumber - 1) * this.RowSize + this.ParentOffset, this.IsHasCustomAttributeRefSizeSmall) == searchCodedTag) {
				startRowNumber--;
			}
			int endRowNumber = foundRowNumber;
			while (endRowNumber + 1 < this.NumberOfRows && this.CustomAttributeTableMemoryReader.PeekReference((endRowNumber + 1) * this.RowSize + this.ParentOffset, this.IsHasCustomAttributeRefSizeSmall) == searchCodedTag) {
				endRowNumber++;
			}
	...
	unsafe public struct FieldMarshalTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsHasFieldMarshalRefSizeSmall;
		public readonly bool IsBlobHeapRefSizeSmall;
		public readonly int ParentOffset;
		public readonly int NativeTypeOffset;
		public readonly int RowSize;
		public readonly MemoryReader FieldMarshalTableMemoryReader;
		public FieldMarshalTableReader(uint numberOfRows, int hasFieldMarshalRefSize, int blobHeapRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
		...
		public FieldMarshalRow this[uint rowId] {
			//  This is 1 based...
			//^ requires rowId <= this.NumberOfRows;
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		public uint GetFieldMarshalRowId(uint token)
		{
			int foundRowNumber = this.FieldMarshalTableMemoryReader.BinarySearchReference(this.NumberOfRows, this.RowSize, this.ParentOffset, HasFieldMarshalTag.ConvertToTag(token), this.IsHasFieldMarshalRefSizeSmall);
			return (uint)(foundRowNumber + 1);
		}
	}

	unsafe public struct DeclSecurityTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsHasDeclSecurityRefSizeSmall;
		public readonly bool IsBlobHeapRefSizeSmall;
		public readonly int ActionOffset;
		public readonly int ParentOffset;
		public readonly int PermissionSetOffset;
		public readonly int RowSize;
		public readonly MemoryReader DeclSecurityTableMemoryReader;
		public DeclSecurityTableReader(uint numberOfRows, int hasDeclSecurityRefSize, int blobHeapRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
		...
		public DeclSecurityRow this[uint rowId] {
			//  This is 1 based...
			//^ requires rowId <= this.NumberOfRows;
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		public uint FindSecurityAttributesForToken(uint token, out uint securityAttributeCount)
		{
		...
		public uint BinarySearchTag(uint searchCodedTag, ref uint securityAttributeCount)
		{
			int foundRowNumber = this.DeclSecurityTableMemoryReader.BinarySearchReference(this.NumberOfRows, this.RowSize, this.ParentOffset, searchCodedTag, this.IsHasDeclSecurityRefSizeSmall);
			if (foundRowNumber == -1)
				return 0;
			int startRowNumber = foundRowNumber;
			while (startRowNumber > 0 && this.DeclSecurityTableMemoryReader.PeekReference((startRowNumber - 1) * this.RowSize + this.ParentOffset, this.IsHasDeclSecurityRefSizeSmall) == searchCodedTag) {
				startRowNumber--;
			}
			int endRowNumber = foundRowNumber;
			while (endRowNumber + 1 < this.NumberOfRows && this.DeclSecurityTableMemoryReader.PeekReference((endRowNumber + 1) * this.RowSize + this.ParentOffset, this.IsHasDeclSecurityRefSizeSmall) == searchCodedTag) {
				endRowNumber++;
			}
	...
	unsafe public struct ClassLayoutTableReader
	{
		public uint NumberOfRows;
		public readonly bool IsTypeDefTableRowRefSizeSmall;
		public readonly int PackagingSizeOffset;
		public readonly int ClassSizeOffset;
		public readonly int ParentOffset;
		public int RowSize;
		public MemoryReader ClassLayoutTableMemoryReader;
		public ClassLayoutTableReader(uint numberOfRows, int typeDefTableRowRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
			this.IsTypeDefTableRowRefSizeSmall = typeDefTableRowRefSize == 2;
		...
		#if false
		public ClassLayoutRow this[uint rowId] {
			//  This is 1 based...
			//^ requires rowId <= this.NumberOfRows;
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		#endif
		public ushort GetPackingSize(uint typeRowId)
		{
			int foundRowNumber = this.ClassLayoutTableMemoryReader.BinarySearchReference(this.NumberOfRows, this.RowSize, this.ParentOffset, typeRowId, this.IsTypeDefTableRowRefSizeSmall);
			if (foundRowNumber == -1)
				return 0;
		...
		public uint GetClassSize(uint typeRowId)
		{
			int foundRowNumber = this.ClassLayoutTableMemoryReader.BinarySearchReference(this.NumberOfRows, this.RowSize, this.ParentOffset, typeRowId, this.IsTypeDefTableRowRefSizeSmall);
			if (foundRowNumber == -1)
				return 0;
	...
	unsafe public struct FieldLayoutTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsFieldTableRowRefSizeSmall;
		public readonly int OffsetOffset;
		public readonly int FieldOffset;
		public readonly int RowSize;
		public readonly MemoryReader FieldLayoutTableMemoryReader;
		public FieldLayoutTableReader(uint numberOfRows, int fieldTableRowRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
			this.IsFieldTableRowRefSizeSmall = fieldTableRowRefSize == 2;
			this.OffsetOffset = 0;
		...
		#if false
		public FieldLayoutRow this[uint rowId] {
			//  This is 1 based...
			//^ requires rowId <= this.NumberOfRows;
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		#endif
		public uint GetOffset(uint rowId)
		{
			int foundRowNumber = this.FieldLayoutTableMemoryReader.BinarySearchReference(this.NumberOfRows, this.RowSize, this.FieldOffset, rowId, this.IsFieldTableRowRefSizeSmall);
			if (foundRowNumber == -1)
				return 0;
			int rowOffset = foundRowNumber * this.RowSize;
			uint offset = this.FieldLayoutTableMemoryReader.PeekUInt32(rowOffset + this.OffsetOffset);
	...
	unsafe public struct StandAloneSigTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsBlobHeapRefSizeSmall;
		public readonly int SignatureOffset;
		public readonly int RowSize;
		public readonly MemoryReader StandAloneSigTableMemoryReader;
		public StandAloneSigTableReader(uint numberOfRows, int blobHeapRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
			this.IsBlobHeapRefSizeSmall = blobHeapRefSize == 2;
		...
		public StandAloneSigRow this[uint rowId] {
			//  This is 1 based...
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
	...
	unsafe public struct EventMapTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsTypeDefTableRowRefSizeSmall;
		public readonly bool IsEventRefSizeSmall;
		public readonly int ParentOffset;
		public readonly int EventListOffset;
		public readonly int RowSize;
		public readonly MemoryReader EventMapTableMemoryReader;
		public EventMapTableReader(uint numberOfRows, int typeDefTableRowRefSize, int eventRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
			this.IsTypeDefTableRowRefSizeSmall = typeDefTableRowRefSize == 2;
		...
		#if false
		public EventMapRow this[uint rowId] {
			//  This is 1 based...
			//^ requires rowId <= this.NumberOfRows;
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		#endif
		public uint FindEventMapRowIdFor(uint typeDefRowId)
		{
			//  We do a linear scan here because we dont have these tables sorted
			int rowNumber = this.EventMapTableMemoryReader.LinearSearchReference(this.RowSize, this.ParentOffset, typeDefRowId, this.IsTypeDefTableRowRefSizeSmall);
			return (uint)(rowNumber + 1);
		}
		//^ requires rowId <= this.NumberOfRows;
		public uint GetEventListStartFor(uint rowId)
		{
			int rowOffset = (int)(rowId - 1) * this.RowSize;
			uint eventList = this.EventMapTableMemoryReader.PeekReference(rowOffset + this.EventListOffset, this.IsEventRefSizeSmall);
			return eventList;
	...
	unsafe public struct EventPtrTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsEventTableRowRefSizeSmall;
		public readonly int EventOffset;
		public readonly int RowSize;
		public readonly MemoryReader EventPtrTableMemoryReader;
		public EventPtrTableReader(uint numberOfRows, int eventTableRowRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
		...
		#if false
		public EventPtrRow this[uint rowId] {
			//  This is 1 based...
			//^ requires rowId <= this.NumberOfRows;
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		#endif
		//^ requires rowId <= this.NumberOfRows;
		public uint GetEventFor(uint rowId)
		{
			int rowOffset = (int)(rowId - 1) * this.RowSize;
			uint @event = this.EventPtrTableMemoryReader.PeekReference(rowOffset + this.EventOffset, this.IsEventTableRowRefSizeSmall);
			return @event;
	...
	unsafe public struct EventTableReader
	{
		public uint NumberOfRows;
		public readonly bool IsTypeDefOrRefRefSizeSmall;
		public readonly bool IsStringHeapRefSizeSmall;
		public readonly int FlagsOffset;
		public readonly int NameOffset;
		public readonly int EventTypeOffset;
		public int RowSize;
		public MemoryReader EventTableMemoryReader;
		public EventTableReader(uint numberOfRows, int typeDefOrRefRefSize, int stringHeapRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
			this.IsTypeDefOrRefRefSizeSmall = typeDefOrRefRefSize == 2;
			this.IsStringHeapRefSizeSmall = stringHeapRefSize == 2;
		...
		public EventRow this[uint rowId] {
			//  This is 1 based...
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		//^ requires rowId <= this.NumberOfRows;
		public uint GetEventType(uint rowId)
		{
			int rowOffset = (int)(rowId - 1) * this.RowSize;
			uint eventType = this.EventTableMemoryReader.PeekReference(rowOffset + this.EventTypeOffset, this.IsTypeDefOrRefRefSizeSmall);
			eventType = TypeDefOrRefTag.ConvertToToken(eventType);
	...
	unsafe public struct PropertyMapTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsTypeDefTableRowRefSizeSmall;
		public readonly bool IsPropertyRefSizeSmall;
		public readonly int ParentOffset;
		public readonly int PropertyListOffset;
		public readonly int RowSize;
		public readonly MemoryReader PropertyMapTableMemoryReader;
		public PropertyMapTableReader(uint numberOfRows, int typeDefTableRowRefSize, int propertyRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
			this.IsTypeDefTableRowRefSizeSmall = typeDefTableRowRefSize == 2;
		...
		#if false
		public PropertyMapRow this[uint rowId] {
			//  This is 1 based...
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		#endif
		public uint FindPropertyMapRowIdFor(uint typeDefRowId)
		{
			//  We do a linear scan here because we dont have these tables sorted
			int rowNumber = this.PropertyMapTableMemoryReader.LinearSearchReference(this.RowSize, this.ParentOffset, typeDefRowId, this.IsTypeDefTableRowRefSizeSmall);
			return (uint)(rowNumber + 1);
		}
		//^ requires rowId <= this.NumberOfRows;
		public uint GetPropertyListStartFor(uint rowId)
		{
			int rowOffset = (int)(rowId - 1) * this.RowSize;
			uint propertyList = this.PropertyMapTableMemoryReader.PeekReference(rowOffset + this.PropertyListOffset, this.IsPropertyRefSizeSmall);
			return propertyList;
	...
	unsafe public struct PropertyPtrTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsPropertyTableRowRefSizeSmall;
		public readonly int PropertyOffset;
		public readonly int RowSize;
		public readonly MemoryReader PropertyPtrTableMemoryReader;
		public PropertyPtrTableReader(uint numberOfRows, int propertyTableRowRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
		...
		#if false
		public PropertyPtrRow this[uint rowId] {
			//  This is 1 based...
			//^ requires rowId <= this.NumberOfRows;
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		#endif
		//^ requires rowId <= this.NumberOfRows;
		public uint GetPropertyFor(uint rowId)
		{
			int rowOffset = (int)(rowId - 1) * this.RowSize;
			uint property = this.PropertyPtrTableMemoryReader.PeekReference(rowOffset + this.PropertyOffset, this.IsPropertyTableRowRefSizeSmall);
			return property;
	...
	unsafe public struct PropertyTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsStringHeapRefSizeSmall;
		public readonly bool IsBlobHeapRefSizeSmall;
		...
		public readonly int SignatureOffset;
		public readonly int RowSize;
		public readonly MemoryReader PropertyTableMemoryReader;
		public PropertyTableReader(uint numberOfRows, int stringHeapRefSize, int blobHeapRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
			this.IsStringHeapRefSizeSmall = stringHeapRefSize == 2;
			this.IsBlobHeapRefSizeSmall = blobHeapRefSize == 2;
		...
		public PropertyRow this[uint rowId] {
			//  This is 1 based...
			//^ requires rowId <= this.NumberOfRows;
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
	...
	unsafe public struct MethodSemanticsTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsMethodTableRowRefSizeSmall;
		public readonly bool IsHasSemanticRefSizeSmall;
		public readonly int SemanticsFlagOffset;
		public readonly int MethodOffset;
		public readonly int AssociationOffset;
		public readonly int RowSize;
		public readonly MemoryReader MethodSemanticsTableMemoryReader;
		public MethodSemanticsTableReader(uint numberOfRows, int methodTableRowRefSize, int hasSemanticRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
			this.IsMethodTableRowRefSizeSmall = methodTableRowRefSize == 2;
		...
		public MethodSemanticsRow this[uint rowId] {
			//  This is 1 based...
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		//  returns rowID
		public uint FindSemanticMethodsForEvent(uint eventRowId, out ushort methodCount)
		{
			methodCount = 0;
		...
		public uint FindSemanticMethodsForProperty(uint propertyRowId, out ushort methodCount)
		{
			methodCount = 0;
			uint searchCodedTag = HasSemanticsTag.ConvertPropertyRowIdToTag(propertyRowId);
			return this.BinarySearchTag(searchCodedTag, ref methodCount);
		}
		public uint BinarySearchTag(uint searchCodedTag, ref ushort methodCount)
		{
			int foundRowNumber = this.MethodSemanticsTableMemoryReader.BinarySearchReference(this.NumberOfRows, this.RowSize, this.AssociationOffset, searchCodedTag, this.IsHasSemanticRefSizeSmall);
			if (foundRowNumber == -1)
				return 0;
			int startRowNumber = foundRowNumber;
			while (startRowNumber > 0 && this.MethodSemanticsTableMemoryReader.PeekReference((startRowNumber - 1) * this.RowSize + this.AssociationOffset, this.IsHasSemanticRefSizeSmall) == searchCodedTag) {
				startRowNumber--;
			}
			int endRowNumber = foundRowNumber;
			while (endRowNumber + 1 < this.NumberOfRows && this.MethodSemanticsTableMemoryReader.PeekReference((endRowNumber + 1) * this.RowSize + this.AssociationOffset, this.IsHasSemanticRefSizeSmall) == searchCodedTag) {
				endRowNumber++;
			}
	...
	unsafe public struct MethodImplTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsTypeDefTableRowRefSizeSmall;
		public readonly bool IsMethodDefOrRefRefSizeSmall;
		public readonly int ClassOffset;
		public readonly int MethodBodyOffset;
		public readonly int MethodDeclarationOffset;
		public readonly int RowSize;
		public readonly MemoryReader MethodImplTableMemoryReader;
		public MethodImplTableReader(uint numberOfRows, int typeDefTableRowRefSize, int methodDefOrRefRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
			this.IsTypeDefTableRowRefSizeSmall = typeDefTableRowRefSize == 2;
		...
		public MethodImplRow this[uint rowId] {
			//  This is 1 based...
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		public uint FindMethodsImplForClass(uint typeDefRowId, out ushort methodImplCount)
		{
			methodImplCount = 0;
			int foundRowNumber = this.MethodImplTableMemoryReader.BinarySearchReference(this.NumberOfRows, this.RowSize, this.ClassOffset, typeDefRowId, this.IsTypeDefTableRowRefSizeSmall);
			if (foundRowNumber == -1)
				return 0;
			int startRowNumber = foundRowNumber;
			while (startRowNumber > 0 && this.MethodImplTableMemoryReader.PeekReference((startRowNumber - 1) * this.RowSize + this.ClassOffset, this.IsTypeDefTableRowRefSizeSmall) == typeDefRowId) {
				startRowNumber--;
			}
			int endRowNumber = foundRowNumber;
			while (endRowNumber + 1 < this.NumberOfRows && this.MethodImplTableMemoryReader.PeekReference((endRowNumber + 1) * this.RowSize + this.ClassOffset, this.IsTypeDefTableRowRefSizeSmall) == typeDefRowId) {
				endRowNumber++;
			}
	...
	unsafe public struct ModuleRefTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsStringHeapRefSizeSmall;
		public readonly int NameOffset;
		public readonly int RowSize;
		public readonly MemoryReader ModuleRefTableMemoryReader;
		public ModuleRefTableReader(uint numberOfRows, int stringHeapRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
			this.IsStringHeapRefSizeSmall = stringHeapRefSize == 2;
			this.NameOffset = 0;
		...
		public ModuleRefRow this[uint rowId] {
			//  This is 1 based...
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
	...
	unsafe public struct TypeSpecTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsBlobHeapRefSizeSmall;
		public readonly int SignatureOffset;
		public readonly int RowSize;
		public readonly MemoryReader TypeSpecTableMemoryReader;
		public TypeSpecTableReader(uint numberOfRows, int blobHeapRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
			this.IsBlobHeapRefSizeSmall = blobHeapRefSize == 2;
			this.SignatureOffset = 0;
		...
		#if false
		public TypeSpecRow this[uint rowId] {
			//  This is 1 based...
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
	...
	unsafe public struct ImplMapTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsModuleRefTableRowRefSizeSmall;
		public readonly bool IsMemberForwardRowRefSizeSmall;
		public readonly bool IsStringHeapRefSizeSmall;
		public readonly int FlagsOffset;
		public readonly int MemberForwardedOffset;
		public readonly int ImportNameOffset;
		public readonly int ImportScopeOffset;
		public readonly int RowSize;
		public readonly MemoryReader ImplMapTableMemoryReader;
		public ImplMapTableReader(uint numberOfRows, int moduleRefTableRowRefSize, int memberForwardedRefSize, int stringHeapRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
		...
		public ImplMapRow this[uint rowId] {
			//  This is 1 based...
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		public uint FindImplForMethod(uint methodRowId)
		{
			uint searchCodedTag = MemberForwardedTag.ConvertMethodDefRowIdToTag(methodRowId);
			return this.BinarySearchTag(searchCodedTag);
		}
		#if false
		public uint FindImplForField(uint fieldRowId)
		{
			uint searchCodedTag = MemberForwardedTag.ConvertFieldDefRowIdToTag(fieldRowId);
			return this.BinarySearchTag(searchCodedTag);
		}
		#endif
		public uint BinarySearchTag(uint searchCodedTag)
		{
			int foundRowNumber = this.ImplMapTableMemoryReader.BinarySearchReference(this.NumberOfRows, this.RowSize, this.MemberForwardedOffset, searchCodedTag, this.IsMemberForwardRowRefSizeSmall);
			return (uint)(foundRowNumber + 1);
		}
	}

	unsafe public struct FieldRVATableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsFieldTableRowRefSizeSmall;
		public readonly int RVAOffset;
		public readonly int FieldOffset;
		public readonly int RowSize;
		public readonly MemoryReader FieldRVATableMemoryReader;
		public FieldRVATableReader(uint numberOfRows, int fieldTableRowRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
			this.IsFieldTableRowRefSizeSmall = fieldTableRowRefSize == 2;
			this.RVAOffset = 0;
		...
		#if false
		public FieldRVARow this[uint rowId] {
			//  This is 1 based
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		#endif
		public int GetFieldRVA(uint fieldDefRowId)
		{
			int foundRowNumber = this.FieldRVATableMemoryReader.BinarySearchReference(this.NumberOfRows, this.RowSize, this.FieldOffset, fieldDefRowId, this.IsFieldTableRowRefSizeSmall);
			if (foundRowNumber == -1)
				return -1;
			int rowOffset = foundRowNumber * this.RowSize;
			int rva = this.FieldRVATableMemoryReader.PeekInt32(rowOffset + this.RVAOffset);
	...
	unsafe public struct EnCLogTableReader
	{
		public readonly uint NumberOfRows;
		public readonly int TokenOffset;
		public readonly int FuncCodeOffset;
		public readonly int RowSize;
		public readonly MemoryReader EnCLogTableMemoryReader;
		public EnCLogTableReader(uint numberOfRows, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
			this.TokenOffset = 0;
		...
		#if false
		public EnCLogRow this[uint rowId] {
			//  This is 1 based...
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
	...
	unsafe public struct EnCMapTableReader
	{
		public readonly uint NumberOfRows;
		public readonly int TokenOffset;
		public readonly int RowSize;
		public readonly MemoryReader EnCMapTableMemoryReader;
		public EnCMapTableReader(uint numberOfRows, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
			this.TokenOffset = 0;
		...
		#if false
		public EnCMapRow this[uint rowId] {
			//  This is 1 based...
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
	...
	unsafe public struct AssemblyTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsStringHeapRefSizeSmall;
		public readonly bool IsBlobHeapRefSizeSmall;
		public readonly int HashAlgIdOffset;
		public readonly int MajorVersionOffset;
		public readonly int MinorVersionOffset;
		public readonly int BuildNumberOffset;
		public readonly int RevisionNumberOffset;
		public readonly int FlagsOffset;
		public readonly int PublicKeyOffset;
		public readonly int NameOffset;
		public readonly int CultureOffset;
		public readonly int RowSize;
		public readonly MemoryReader AssemblyTableMemoryReader;
		public AssemblyTableReader(uint numberOfRows, int stringHeapRefSize, int blobHeapRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
			this.IsStringHeapRefSizeSmall = stringHeapRefSize == 2;
			this.IsBlobHeapRefSizeSmall = blobHeapRefSize == 2;
		...
		public AssemblyRow this[uint rowId] {
			//  This is 1 based...
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
	...
	unsafe public struct AssemblyProcessorTableReader
	{
		public readonly uint NumberOfRows;
		public readonly int ProcessorOffset;
		public readonly int RowSize;
		public readonly MemoryReader AssemblyProcessorTableMemoryReader;
		public AssemblyProcessorTableReader(uint numberOfRows, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
		...
		#if false
		public AssemblyProcessorRow this[uint rowId] {
			//  This is 1 based...
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
	...
	unsafe public struct AssemblyOSTableReader
	{
		public readonly uint NumberOfRows;
		public readonly int OSPlatformIdOffset;
		public readonly int OSMajorVersionIdOffset;
		public readonly int OSMinorVersionIdOffset;
		public readonly int RowSize;
		public readonly MemoryReader AssemblyOSTableMemoryReader;
		public AssemblyOSTableReader(uint numberOfRows, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
		...
		#if false
		public AssemblyOSRow this[uint rowId] {
			//  This is 1 based...
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
	...
	unsafe public struct AssemblyRefTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsStringHeapRefSizeSmall;
		public readonly bool IsBlobHeapRefSizeSmall;
		...
		public readonly int RevisionNumberOffset;
		public readonly int FlagsOffset;
		public readonly int PublicKeyOrTokenOffset;
		public readonly int NameOffset;
		public readonly int CultureOffset;
		public readonly int HashValueOffset;
		public readonly int RowSize;
		public readonly MemoryReader AssemblyRefTableMemoryReader;
		public AssemblyRefTableReader(uint numberOfRows, int stringHeapRefSize, int blobHeapRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
			this.IsStringHeapRefSizeSmall = stringHeapRefSize == 2;
			this.IsBlobHeapRefSizeSmall = blobHeapRefSize == 2;
		...
		public AssemblyRefRow this[uint rowId] {
			//  This is 1 based...
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
	...
	unsafe public struct AssemblyRefProcessorTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsAssemblyRefTableRowSizeSmall;
		public readonly int ProcessorOffset;
		public readonly int AssemblyRefOffset;
		public readonly int RowSize;
		public readonly MemoryReader AssemblyRefProcessorTableMemoryReader;
		public AssemblyRefProcessorTableReader(uint numberOfRows, int assembyRefTableRowRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
		...
		#if false
		public AssemblyRefProcessorRow this[uint rowId] {
			//  This is 1 based...
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
	...
	unsafe public struct AssemblyRefOSTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsAssemblyRefTableRowRefSizeSmall;
		public readonly int OSPlatformIdOffset;
		public readonly int OSMajorVersionIdOffset;
		public readonly int OSMinorVersionIdOffset;
		public readonly int AssemblyRefOffset;
		public readonly int RowSize;
		public readonly MemoryReader AssemblyRefOSTableMemoryReader;
		public AssemblyRefOSTableReader(uint numberOfRows, int assembyRefTableRowRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
		...
		#if false
		public AssemblyRefOSRow this[uint rowId] {
			//  This is 1 based...
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
	...
	unsafe public struct FileTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsStringHeapRefSizeSmall;
		public readonly bool IsBlobHeapRefSizeSmall;
		...
		public readonly int HashValueOffset;
		public readonly int RowSize;
		public readonly MemoryReader FileTableMemoryReader;
		public FileTableReader(uint numberOfRows, int stringHeapRefSize, int blobHeapRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
			this.IsStringHeapRefSizeSmall = stringHeapRefSize == 2;
			this.IsBlobHeapRefSizeSmall = blobHeapRefSize == 2;
		...
		public FileRow this[uint rowId] {
			//  This is 1 based...
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		public uint GetHashValue(uint rowId)
		{
			int rowOffset = (int)(rowId - 1) * this.RowSize;
			uint hashValue = this.FileTableMemoryReader.PeekReference(rowOffset + this.HashValueOffset, this.IsBlobHeapRefSizeSmall);
			return hashValue;
	...
	unsafe public struct ExportedTypeTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsImplementationRefSizeSmall;
		public readonly bool IsStringHeapRefSizeSmall;
		public readonly int FlagsOffset;
		public readonly int TypeDefIdOffset;
		public readonly int TypeNameOffset;
		public readonly int TypeNamespaceOffset;
		public readonly int ImplementationOffset;
		public readonly int RowSize;
		public readonly MemoryReader ExportedTypeTableMemoryReader;
		public ExportedTypeTableReader(uint numberOfRows, int implementationRefSize, int stringHeapRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
		...
		public ExportedTypeRow this[uint rowId] {
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
	...
	unsafe public struct ManifestResourceTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsImplementationRefSizeSmall;
		public readonly bool IsStringHeapRefSizeSmall;
		...
		public readonly int ImplementationOffset;
		public readonly int RowSize;
		public readonly MemoryReader ManifestResourceTableMemoryReader;
		public ManifestResourceTableReader(uint numberOfRows, int implementationRefSize, int stringHeapRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
			this.IsImplementationRefSizeSmall = implementationRefSize == 2;
			this.IsStringHeapRefSizeSmall = stringHeapRefSize == 2;
		...
		public ManifestResourceRow this[uint rowId] {
			//  This is 1 based...
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		public uint GetImplementation(uint rowId)
		{
			int rowOffset = (int)(rowId - 1) * this.RowSize;
			uint implementation = this.ManifestResourceTableMemoryReader.PeekReference(rowOffset + this.ImplementationOffset, this.IsImplementationRefSizeSmall);
			implementation = ImplementationTag.ConvertToToken(implementation);
	...
	unsafe public struct NestedClassTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsTypeDefTableRowRefSizeSmall;
		public readonly int NestedClassOffset;
		public readonly int EnclosingClassOffset;
		public readonly int RowSize;
		public readonly MemoryReader NestedClassTableMemoryReader;
		public NestedClassTableReader(uint numberOfRows, int typeDefTableRowRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
			this.IsTypeDefTableRowRefSizeSmall = typeDefTableRowRefSize == 2;
		...
		public NestedClassRow this[uint rowId] {
			//  This is 1 based...
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		public uint FindParentTypeDefRowId(uint nestedTypeRowId)
		{
			int rowNumber = this.NestedClassTableMemoryReader.BinarySearchReference(this.NumberOfRows, this.RowSize, this.NestedClassOffset, nestedTypeRowId, this.IsTypeDefTableRowRefSizeSmall);
			if (rowNumber == -1)
				return 0;
	...
	unsafe public struct GenericParamTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsTypeOrMethodDefRefSizeSmall;
		public readonly bool IsStringHeapRefSizeSmall;
		public readonly int NumberOffset;
		public readonly int FlagsOffset;
		public readonly int OwnerOffset;
		public readonly int NameOffset;
		public readonly int RowSize;
		public readonly MemoryReader GenericParamTableMemoryReader;
		public GenericParamTableReader(uint numberOfRows, int typeOrMethodDefRefSize, int stringHeapRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
		...
		public GenericParamRow this[uint rowId] {
			//  This is 1 based...
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		//  returns rowID
		public uint FindGenericParametersForType(uint typeDefRowId, out ushort genericParamCount)
		{
			genericParamCount = 0;
		...
		public uint FindGenericParametersForMethod(uint typeDefRowId, out ushort genericParamCount)
		{
			genericParamCount = 0;
			uint searchCodedTag = TypeOrMethodDefTag.ConvertMethodDefRowIdToTag(typeDefRowId);
			return this.BinarySearchTag(searchCodedTag, ref genericParamCount);
		}
		public uint BinarySearchTag(uint searchCodedTag, ref ushort genericParamCount)
		{
			int foundRowNumber = this.GenericParamTableMemoryReader.BinarySearchReference(this.NumberOfRows, this.RowSize, this.OwnerOffset, searchCodedTag, this.IsTypeOrMethodDefRefSizeSmall);
			if (foundRowNumber == -1)
				return 0;
			int startRowNumber = foundRowNumber;
			while (startRowNumber > 0 && this.GenericParamTableMemoryReader.PeekReference((startRowNumber - 1) * this.RowSize + this.OwnerOffset, this.IsTypeOrMethodDefRefSizeSmall) == searchCodedTag) {
				startRowNumber--;
			}
			int endRowNumber = foundRowNumber;
			while (endRowNumber + 1 < this.NumberOfRows && this.GenericParamTableMemoryReader.PeekReference((endRowNumber + 1) * this.RowSize + this.OwnerOffset, this.IsTypeOrMethodDefRefSizeSmall) == searchCodedTag) {
				endRowNumber++;
			}
	...
	unsafe public struct MethodSpecTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsMethodDefOrRefRefSizeSmall;
		public readonly bool IsBlobHeapRefSizeSmall;
		public readonly int MethodOffset;
		public readonly int InstantiationOffset;
		public readonly int RowSize;
		public readonly MemoryReader MethodSpecTableMemoryReader;
		public MethodSpecTableReader(uint numberOfRows, int methodDefOrRefRefSize, int blobHeapRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
			this.IsMethodDefOrRefRefSizeSmall = methodDefOrRefRefSize == 2;
			this.IsBlobHeapRefSizeSmall = blobHeapRefSize == 2;
		...
		public MethodSpecRow this[uint rowId] {
			//  This is 1 based...
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
	...
	unsafe public struct GenericParamConstraintTableReader
	{
		public readonly uint NumberOfRows;
		public readonly bool IsGenericParamTableRowRefSizeSmall;
		public readonly bool IsTypeDefOrRefRefSizeSmall;
		public readonly int OwnerOffset;
		public readonly int ConstraintOffset;
		public readonly int RowSize;
		public readonly MemoryReader GenericParamConstraintTableMemoryReader;
		public GenericParamConstraintTableReader(uint numberOfRows, int genericParamTableRowRefSize, int typeDefOrRefRefSize, byte* buffer)
		{
			this.NumberOfRows = numberOfRows;
		...
		#if false
		public GenericParamConstraintRow this[uint rowId] {
			//  This is 1 based...
			get {
				int rowOffset = (int)(rowId - 1) * this.RowSize;
		...
		#endif
		public uint FindConstraintForGenericParam(uint genericParamRowId, out uint genericParamConstraintCount)
		{
			genericParamConstraintCount = 0;
			int foundRowNumber = this.GenericParamConstraintTableMemoryReader.BinarySearchReference(this.NumberOfRows, this.RowSize, this.OwnerOffset, genericParamRowId, this.IsGenericParamTableRowRefSizeSmall);
			if (foundRowNumber == -1)
				return 0;
			int startRowNumber = foundRowNumber;
			while (startRowNumber > 0 && this.GenericParamConstraintTableMemoryReader.PeekReference((startRowNumber - 1) * this.RowSize + this.OwnerOffset, this.IsGenericParamTableRowRefSizeSmall) == genericParamRowId) {
				startRowNumber--;
			}
			int endRowNumber = foundRowNumber;
			while (endRowNumber + 1 < this.NumberOfRows && this.GenericParamConstraintTableMemoryReader.PeekReference((endRowNumber + 1) * this.RowSize + this.OwnerOffset, this.IsGenericParamTableRowRefSizeSmall) == genericParamRowId) {
				endRowNumber++;
			}
			genericParamConstraintCount = (ushort)(endRowNumber - startRowNumber + 1);
			return (uint)(startRowNumber + 1);
		}
		public uint GetConstraint(uint rowId)
		{
			int rowOffset = (int)(rowId - 1) * this.RowSize;
			uint constraint = this.GenericParamConstraintTableMemoryReader.PeekReference(rowOffset + this.ConstraintOffset, this.IsTypeDefOrRefRefSizeSmall);
			constraint = TypeDefOrRefTag.ConvertToToken(constraint);
	...
	unsafe public sealed class PEFileReader
	{
		#region Fields [Inited]
		public ReaderState ReaderState;
		public readonly MetadataErrorContainer ErrorContainer;
...
/*^
    ...
    ^*/
				public PEFileReader(PeReader moduleReadWriteFactory, IBinaryDocumentMemoryBlock binaryDocumentMemoryBlock)
		{
    ...
    ^*/
		...
		public MemoryReader Win32ResourceMemoryReader;
...
//^ requires this.ReaderState >= ReaderState.PEFile;
			get { return this.OptionalHeaderNTAdditionalFields.DllCharacteristics; }
		}
		public uint FileAlignment {
//^ requires this.ReaderState >= ReaderState.PEFile;
			get { return this.OptionalHeaderNTAdditionalFields.FileAlignment; }
		}
		public ulong ImageBase {
//^ requires this.ReaderState >= ReaderState.PEFile;
			get { return this.OptionalHeaderNTAdditionalFields.ImageBase; }
		}
		public bool IsDll {
//^ requires this.ReaderState >= ReaderState.PEFile;
			get { return (this.COFFFileHeader.Characteristics & Characteristics.Dll) != 0; }
		}
		public bool IsExe {
//^ requires this.ReaderState >= ReaderState.PEFile;
			get { return (this.COFFFileHeader.Characteristics & Characteristics.Dll) == 0; }
		...
		public bool IsConsoleApplication {
			get { return this.OptionalHeaderNTAdditionalFields.Subsystem == Subsystem.WindowsCUI; }
		}
		public bool IsUnmanaged {
			get { return this.OptionalHeaderDirectoryEntries.COR20HeaderTableDirectory.Size == 0; }
		}
		public byte LinkerMajorVersion {
//^ requires this.ReaderState >= ReaderState.PEFile;
			get { return this.OptionalHeaderStandardFields.MajorLinkerVersion; }
		}
		public byte LinkerMinorVersion {
//^ requires this.ReaderState >= ReaderState.PEFile;
			get { return this.OptionalHeaderStandardFields.MinorLinkerVersion; }
		}

		public Machine Machine {
			get { return this.COFFFileHeader.Machine; }
		}

		public bool RequiresAmdInstructionSet {
			get { return this.COFFFileHeader.Machine == Microsoft.Cci.Machine.AMD64; }
		}

		public bool RequiresStartupStub {
			get { return this.OptionalHeaderStandardFields.RVAOfEntryPoint != 0; }
		}

		public bool Requires64Bits {
			get { return this.OptionalHeaderStandardFields.PEMagic == PEMagic.PEMagic64 || this.COFFFileHeader.Machine == Microsoft.Cci.Machine.AMD64 || this.COFFFileHeader.Machine == Microsoft.Cci.Machine.IA64; }
		}

		public ulong SizeOfHeapCommit {
//^ requires this.ReaderState >= ReaderState.PEFile;
			get { return this.OptionalHeaderNTAdditionalFields.SizeOfHeapCommit; }
		}
		public ulong SizeOfHeapReserve {
//^ requires this.ReaderState >= ReaderState.PEFile;
			get { return this.OptionalHeaderNTAdditionalFields.SizeOfHeapReserve; }
		}
		public ulong SizeOfStackCommit {
//^ requires this.ReaderState >= ReaderState.PEFile;
			get { return this.OptionalHeaderNTAdditionalFields.SizeOfStackCommit; }
		}
		public ulong SizeOfStackReserve {
//^ requires this.ReaderState >= ReaderState.PEFile;
			get { return this.OptionalHeaderNTAdditionalFields.SizeOfStackReserve; }
		}
		...
		public bool ReadCOFFFileHeader(ref MemoryReader memReader)
		{
		...
		//^ requires this.ReaderState >= ReaderState.Initialized;
		public bool ReadOptionalHeaderStandardFields32(ref MemoryReader memReader)
		{
		...
		//^ requires this.ReaderState >= ReaderState.Initialized;
		public bool ReadOptionalHeaderNTAdditionalFields32(ref MemoryReader memReader)
		{
		...
		//^ requires this.ReaderState >= ReaderState.Initialized;
		public bool ReadOptionalHeaderStandardFields64(ref MemoryReader memReader)
		{
		...
		//^ requires this.ReaderState >= ReaderState.Initialized;
		public bool ReadOptionalHeaderNTAdditionalFields64(ref MemoryReader memReader)
		{
		...
		//^ requires this.ReaderState >= ReaderState.Initialized;
		public bool ReadOptionalHeaderDirectoryEntries(ref MemoryReader memReader)
		{
		...
		//^ requires this.ReaderState >= ReaderState.Initialized;
		public bool ReadSectionHeaders(ref MemoryReader memReader)
		{
		...
		//^ requires this.ReaderState >= ReaderState.Initialized;
		public bool ReadPEFileLevelData()
		{
			...
			switch (magic) {
				case PEMagic.PEMagic32:
					if (!this.ReadOptionalHeaderStandardFields32(ref memReader) || !this.ReadOptionalHeaderNTAdditionalFields32(ref memReader)) {
						return false;
					}
					break;
				case PEMagic.PEMagic64:
					if (!this.ReadOptionalHeaderStandardFields64(ref memReader) || !this.ReadOptionalHeaderNTAdditionalFields64(ref memReader)) {
						return false;
					}
					break;
				default:
		...
		public ResourceDirectory GetResourceDirectoryAt(int offset)
		{
		...
		public ResourceDirectoryEntry GetResourceDirectoryEntryAt(int offset)
		{
		...
		public ResourceDataEntry GetResourceDataEntryAt(int offset)
		{
			int currOffset = offset;
		...
		//^ requires this.ReaderState >= ReaderState.PEFile;
		public MemoryBlock DirectoryToMemoryBlock(DirectoryEntry directory)
		{
			foreach (SectionHeader sectionHeaderIter in this.SectionHeaders) {
				if (sectionHeaderIter.VirtualAddress <= directory.RelativeVirtualAddress && directory.RelativeVirtualAddress < sectionHeaderIter.VirtualAddress + sectionHeaderIter.VirtualSize) {
					...
					MemoryBlock retMemBlock = new MemoryBlock(this.BinaryDocumentMemoryBlock.Pointer + sectionHeaderIter.OffsetToRawData + relativeOffset, directory.Size);
					return retMemBlock;
				}
			}
		...
		//^ requires this.ReaderState >= ReaderState.PEFile;
		public MemoryBlock RVAToMemoryBlockWithSize(int RVA, int size)
		{
			foreach (SectionHeader sectionHeaderIter in this.SectionHeaders) {
				if (sectionHeaderIter.VirtualAddress <= RVA && RVA < sectionHeaderIter.VirtualAddress + sectionHeaderIter.VirtualSize) {
					...
					MemoryBlock retMemBlock = new MemoryBlock(this.BinaryDocumentMemoryBlock.Pointer + sectionHeaderIter.OffsetToRawData + relativeOffset, (int)size);
					return retMemBlock;
				}
			}
			//  Error section not found...
		...
		//^ requires this.ReaderState >= ReaderState.PEFile;
		public MemoryBlock RVAToMemoryBlock(int RVA)
		{
			foreach (SectionHeader sectionHeaderIter in this.SectionHeaders) {
				if (sectionHeaderIter.VirtualAddress <= RVA && RVA < sectionHeaderIter.VirtualAddress + sectionHeaderIter.VirtualSize) {
					int relativeOffset = RVA - sectionHeaderIter.VirtualAddress;
					MemoryBlock retMemBlock = new MemoryBlock(this.BinaryDocumentMemoryBlock.Pointer + sectionHeaderIter.OffsetToRawData + relativeOffset, sectionHeaderIter.VirtualSize - relativeOffset);
					return retMemBlock;
				}
			}
			//  Error section not found...
		...
		//^ requires this.ReaderState >= ReaderState.PEFile;
		public bool RVAsInSameSection(int RVA1, int RVA2)
		{
			foreach (SectionHeader sectionHeaderIter in this.SectionHeaders) {
				if (sectionHeaderIter.VirtualAddress <= RVA1 && RVA1 < sectionHeaderIter.VirtualAddress + sectionHeaderIter.VirtualSize && sectionHeaderIter.VirtualAddress <= RVA2 && RVA2 < sectionHeaderIter.VirtualAddress + sectionHeaderIter.VirtualSize) {
					return true;
				}
			}
			return false;
		}
		public SubSection RVAToSubSection(int RVA, int size)
		{
			foreach (SectionHeader sectionHeaderIter in this.SectionHeaders) {
				if (sectionHeaderIter.VirtualAddress <= RVA && RVA + size <= sectionHeaderIter.VirtualAddress + sectionHeaderIter.VirtualSize) {
					int relativeOffset = RVA - sectionHeaderIter.VirtualAddress;
					MemoryBlock memBlock = new MemoryBlock(this.BinaryDocumentMemoryBlock.Pointer + sectionHeaderIter.OffsetToRawData + relativeOffset, size);
		...
		public string RVAToSubSectionName(int RVA)
		{
			foreach (SectionHeader sectionHeaderIter in this.SectionHeaders) {
				if (sectionHeaderIter.VirtualAddress <= RVA && RVA < sectionHeaderIter.VirtualAddress + sectionHeaderIter.VirtualSize) {
		...
		public int GetSizeOfRemainderOfSectionContaining(int RVA)
		{
			foreach (SectionHeader sectionHeaderIter in this.SectionHeaders) {
				if (sectionHeaderIter.VirtualAddress <= RVA && RVA < sectionHeaderIter.VirtualAddress + sectionHeaderIter.VirtualSize) {
		...
		public StringStreamReader StringStream;
		public BlobStreamReader BlobStream;
		public GUIDStreamReader GUIDStream;
		public UserStringStreamReader UserStringStream;
		public MetadataStreamKind MetadataStreamKind;
		MemoryBlock MetadataTableStream;
		public MemoryReader ResourceMemoryReader;
		public MemoryBlock StrongNameSignature;
		public string MetadataStreamName {
			get {
		...
		//^ requires this.ReaderState >= ReaderState.PEFile;
		public bool ReadMetadataHeader(ref MemoryReader memReader)
		{
		...
		//^ requires this.ReaderState >= ReaderState.PEFile;
		public bool ReadStorageHeader(ref MemoryReader memReader)
		{
		...
		//^ requires this.ReaderState >= ReaderState.PEFile;
		public bool ReadStreamHeaders(ref MemoryReader memReader)
		{
		...
		//^ requires this.ReaderState >= ReaderState.PEFile;
		public bool ProcessAndCacheStreams(ref MemoryBlock metadataRoot)
		{
			foreach (StreamHeader streamHeader in this.StreamHeaders) {
				switch (streamHeader.Name) {
					case COR20Constants.StringStreamName:
						...
						this.StringStream.MemoryReader = new MemoryReader(metadataRoot.Buffer + streamHeader.Offset, streamHeader.Size);
						break;
					case COR20Constants.BlobStreamName:
						...
						this.BlobStream.MemoryReader = new MemoryReader(metadataRoot.Buffer + streamHeader.Offset, streamHeader.Size);
						break;
					case COR20Constants.GUIDStreamName:
						...
						this.GUIDStream.MemoryReader = new MemoryReader(metadataRoot.Buffer + streamHeader.Offset, streamHeader.Size);
						break;
					case COR20Constants.UserStringStreamName:
						...
						this.UserStringStream.MemoryReader = new MemoryReader(metadataRoot.Buffer + streamHeader.Offset, streamHeader.Size);
						break;
					case COR20Constants.CompressedMetadataTableStreamName:
						...
						this.MetadataTableStream = new MemoryBlock(metadataRoot.Buffer + streamHeader.Offset, streamHeader.Size);
						break;
		...
		//^ requires this.ReaderState >= ReaderState.PEFile;
		public bool ReadCORModuleLevelData()
		{
			...
			if (!this.ReadMetadataHeader(ref memReader) || !this.ReadStorageHeader(ref memReader) || !this.ReadStreamHeaders(ref memReader) || !this.ProcessAndCacheStreams(ref metadataRoot)) {
				return false;
			}
		...
		public MethodTableReader MethodTable;
		...
		public AssemblyProcessorTableReader AssemblyProcessorTable;
		public AssemblyOSTableReader AssemblyOSTable;
		public AssemblyRefTableReader AssemblyRefTable;
		public AssemblyRefProcessorTableReader AssemblyRefProcessorTable;
		public AssemblyRefOSTableReader AssemblyRefOSTable;
		public FileTableReader FileTable;
		...
		public Guid ModuleGuidIdentifier {
...
//^ requires this.ReaderState >= ReaderState.Metadata;
		...
		public bool ReadMetadataTableInformation(ref MemoryReader memReader)
		{
		...
		public static int ComputeCodedTokenSize(uint largeRowSize, uint[] rowCountArray, TableMask tablesReferenced)
		{
			...
			for (int tableIndex = 0; tableIndex < (int)TableIndices.Count; tableIndex++) {
				if ((tablesReferencedMask & 0x1uL) != 0) {
		...
		//^ requires this.ReaderState >= ReaderState.CORModule;
		public bool ProcessAndCacheMetadataTableBlocks(MemoryBlock metadataTablesMemoryBlock)
		{
		...
		//^ requires this.ReaderState >= ReaderState.CORModule;
		public bool ReadMetadataLevelData()
		{
			MemoryReader memReader = new MemoryReader(this.MetadataTableStream);
			if (!this.ReadMetadataTableInformation(ref memReader) || !this.ProcessAndCacheMetadataTableBlocks(memReader.RemainingMemoryBlock)) {
				return false;
			}
		...
		//^ requires this.ReaderState >= ReaderState.Metadata;
		public uint GetFieldInformation(uint typeDefRowId, out uint fieldCount)
		{
		...
		//^ requires typeDefRowId <= this.TypeDefTable.NumberOfRows;
		//^ requires this.ReaderState >= ReaderState.Metadata;
		public uint GetMethodInformation(uint typeDefRowId, out uint methodCount)
		{
		...
		//^ requires typeDefRowId <= this.TypeDefTable.NumberOfRows;
		//^ requires this.ReaderState >= ReaderState.Metadata;
		public uint GetEventInformation(uint typeDefRowId, out uint eventCount)
		{
			eventCount = 0;
		...
		//^ requires typeDefRowId <= this.TypeDefTable.NumberOfRows;
		//^ requires this.ReaderState >= ReaderState.Metadata;
		public uint GetPropertyInformation(uint typeDefRowId, out uint propertyCount)
		{
			propertyCount = 0;
		...
		//^ requires this.ReaderState >= ReaderState.Metadata;
		public uint GetParamInformation(uint methodDefRowId, out uint paramRowCount)
		{
		...
		public static SEHTableEntry[] GetSmallSEHEntries(MemoryReader memReader, int numEntries)
		{
		...
		public static SEHTableEntry[] GetFatSEHEntries(MemoryReader memReader, int numEntries)
		{
			SEHTableEntry[] retSEHEntries = new SEHTableEntry[numEntries];
			for (int i = 0; i < numEntries; ++i) {
		...
		public MethodIL GetMethodIL(		/*?*/uint methodDefRowId)
		{
			...
			if ((headByte & CILMethodFlags.ILFormatMask) == CILMethodFlags.ILTinyFormat) {
				...
				return new MethodIL(true, 8, 0x0, memReader.GetMemoryBlockAt(0, size), null);
			...
			return new MethodIL(localVarInited, maxStack, localSignatureToken, ilCodeMemBlock, sehTableEntries);
		}
	}
}
