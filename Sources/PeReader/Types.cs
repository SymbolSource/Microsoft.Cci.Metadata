...
namespace Microsoft.Cci.MetadataReader.ObjectModelImplementation
{
	...
	/// </summary>
	public enum MetadataReaderTypeKind
	{
		Dummy,
		Nominal,
		TypeSpec,
	...
	/// </summary>
	public enum MetadataReaderSignatureTypeCode
	{
		SByte,
		Int16,
		Int32,
	...
	/// </summary>
	public interface IMetadataReaderNamedTypeReference : INamedTypeReference
	{
	...
	/// </summary>
	public sealed class CoreTypeReference : MetadataObject, IMetadataReaderNamedTypeReference, INamespaceTypeReference
	{
		public readonly IMetadataReaderModuleReference moduleReference;
		public readonly NamespaceReference namespaceReference;
		public readonly IName mangledTypeName;
		public readonly IName name;
		public readonly ushort genericParamCount;
		public readonly MetadataReaderSignatureTypeCode signatureTypeCode;
		bool isResolved;
		ITypeDefinition 		/*?*/resolvedModuleTypeDefintion;

		public CoreTypeReference(PEFileToObjectModel peFileToObjectModel, IMetadataReaderModuleReference moduleReference, NamespaceReference namespaceReference, IName typeName, ushort genericParamCount, MetadataReaderSignatureTypeCode signatureTypeCode) : base(peFileToObjectModel)
		{
		...
		public bool IsValueType {
			get {
				switch (this.signatureTypeCode) {
					...
					case MetadataReaderSignatureTypeCode.String:
						return false;
					default:
						return true;
				}
		...
		public INamedTypeDefinition ResolvedType {
			get {
				...
				if (this.resolvedModuleTypeDefintion == null)
	...
	public sealed class ModifiedTypeReference : ITypeReference, IModifiedTypeReference
	{

			/*?*/		public ModifiedTypeReference(PEFileToObjectModel peFileToObjectModel, ITypeReference unmodifiedType, IEnumerable<ICustomModifier> customModifiers		)
		{
	...
	public abstract class NamespaceTypeNameNamespaceReference : IUnitNamespaceReference
	{
		public readonly NamespaceTypeNameTypeReference NamespaceTypeNameTypeReference;

		public NamespaceTypeNameNamespaceReference(NamespaceTypeNameTypeReference namespaceTypeNameTypeReference)
		{
	...
	public sealed class NestedNamespaceTypeNameNamespaceReference : NamespaceTypeNameNamespaceReference, INestedUnitNamespaceReference
	{

		readonly NamespaceName NamespaceName;

		public NestedNamespaceTypeNameNamespaceReference(NamespaceName namespaceName, NamespaceTypeNameTypeReference namespaceTypeNameTypeReference) : base(namespaceTypeNameTypeReference)
		{
	...
	public sealed class RootNamespaceTypeNameNamespaceReference : NamespaceTypeNameNamespaceReference, IRootUnitNamespaceReference
	{

		public RootNamespaceTypeNameNamespaceReference(NamespaceTypeNameTypeReference namespaceTypeNameTypeReference) : base(namespaceTypeNameTypeReference)
		{
		}
	...
	public abstract class TypeNameTypeReference : IMetadataReaderNamedTypeReference
	{

		public readonly IMetadataReaderModuleReference Module;
		public readonly PEFileToObjectModel PEFileToObjectModel;

		public TypeNameTypeReference(IMetadataReaderModuleReference module, PEFileToObjectModel peFileToObjectModel)
		{
			this.Module = module;
			this.PEFileToObjectModel = peFileToObjectModel;
		}
		...
		{
			return null;
			//only type references that have entries in the TypeRef table can be redirected via the ExportedType table.
		}
		...
		public abstract INamedTypeDefinition GetResolvedType();
	...
	public sealed class NamespaceTypeNameTypeReference : TypeNameTypeReference, INamespaceTypeReference
	{

		public readonly NamespaceTypeName NamespaceTypeName;

		public NamespaceTypeNameTypeReference(IMetadataReaderModuleReference module, NamespaceTypeName namespaceTypeName, PEFileToObjectModel peFileToObjectModel) : base(module, peFileToObjectModel)
		{
		...
		public INamedTypeDefinition Resolve()		/*?*/
		{
			if (this.Module != this.PEFileToObjectModel.Module) {
				...
				var retModuleType = assemblyPEFileToObjectModel.ResolveNamespaceTypeDefinition(this.NamespaceFullName, this.MangledTypeName);
		...
		public PrimitiveTypeCode UseNameToResolveTypeCode()
		{
			...
			if (ns.Name.UniqueKey != pe.NameTable.System.UniqueKey)
				return PrimitiveTypeCode.NotPrimitive;
			var rs = ns.ContainingUnitNamespace as IRootUnitNamespaceReference;
			if (rs == null)
				return PrimitiveTypeCode.NotPrimitive;
			var key = this.Name.UniqueKey;
			if (key == pe.PlatformType.SystemBoolean.Name.UniqueKey)
				return PrimitiveTypeCode.Boolean;
			if (key == pe.PlatformType.SystemInt8.Name.UniqueKey)
				return PrimitiveTypeCode.UInt8;
			if (key == pe.PlatformType.SystemChar.Name.UniqueKey)
				return PrimitiveTypeCode.Char;
			if (key == pe.PlatformType.SystemFloat64.Name.UniqueKey)
				return PrimitiveTypeCode.Float64;
			if (key == pe.PlatformType.SystemInt16.Name.UniqueKey)
				return PrimitiveTypeCode.Int16;
			if (key == pe.PlatformType.SystemInt32.Name.UniqueKey)
				return PrimitiveTypeCode.Int32;
			if (key == pe.PlatformType.SystemInt64.Name.UniqueKey)
				return PrimitiveTypeCode.Int64;
			if (key == pe.PlatformType.SystemInt8.Name.UniqueKey)
				return PrimitiveTypeCode.Int8;
			if (key == pe.PlatformType.SystemIntPtr.Name.UniqueKey)
				return PrimitiveTypeCode.IntPtr;
			if (key == pe.PlatformType.SystemFloat32.Name.UniqueKey)
				return PrimitiveTypeCode.Float32;
			if (key == pe.PlatformType.SystemString.Name.UniqueKey)
				return PrimitiveTypeCode.String;
			if (key == pe.PlatformType.SystemUInt16.Name.UniqueKey)
				return PrimitiveTypeCode.UInt16;
			if (key == pe.PlatformType.SystemUInt32.Name.UniqueKey)
				return PrimitiveTypeCode.UInt32;
			if (key == pe.PlatformType.SystemUInt64.Name.UniqueKey)
				return PrimitiveTypeCode.UInt64;
			if (key == pe.PlatformType.SystemUIntPtr.Name.UniqueKey)
				return PrimitiveTypeCode.UIntPtr;
			if (key == pe.PlatformType.SystemVoid.Name.UniqueKey)
		...
		public override INamedTypeDefinition GetResolvedType()
		{
	...
	public sealed class NestedTypeNameTypeReference : TypeNameTypeReference, INestedTypeReference
	{

		public readonly NestedTypeName NestedTypeName;

		public NestedTypeNameTypeReference(IMetadataReaderModuleReference module, NestedTypeName nestedTypeName, PEFileToObjectModel peFileToObjectModel) : base(module, peFileToObjectModel)
		{
	...
	/// </summary>
	public abstract class TypeRefReference : MetadataObject, IMetadataReaderNamedTypeReference
	{
		public readonly uint TypeRefRowId;
		readonly IMetadataReaderModuleReference moduleReference;
		public readonly IName typeName;
		bool isResolved;
		...
		public TypeRefReference(PEFileToObjectModel peFileToObjectModel, IName typeName, uint typeRefRowId, IMetadataReaderModuleReference moduleReference, bool isValueType) : base(peFileToObjectModel)
		{
		...
		public void InitExportedAliasBase()
		{
	...
	public abstract class NamespaceTypeRefReference : TypeRefReference, IMetadataReaderNamedTypeReference, INamespaceTypeReference
	{
		readonly NamespaceReference namespaceReference;

		public NamespaceTypeRefReference(PEFileToObjectModel peFileToObjectModel, IName typeName, uint typeRefRowId, IMetadataReaderModuleReference moduleReference, NamespaceReference namespaceReference, bool isValueType) : base(peFileToObjectModel, typeName, typeRefRowId, moduleReference, isValueType)
		{
			this.namespaceReference = namespaceReference;
		}
	...
	public abstract class NonGenericNamespaceTypeRefReference : NamespaceTypeRefReference
	{

		public NonGenericNamespaceTypeRefReference(PEFileToObjectModel peFileToObjectModel, IName typeName, uint typeRefRowId, IMetadataReaderModuleReference moduleReference, NamespaceReference namespaceReference, bool isValueType) : base(peFileToObjectModel, typeName, typeRefRowId, moduleReference, namespaceReference, isValueType)
		{
		}
		...
		public override sealed bool MangleName {
			get { return false; }
		}
	...
	public sealed class GenericNamespaceTypeRefReference : NamespaceTypeRefReference
	{
		readonly IName mangledTypeName;
		readonly ushort genericParamCount;

		public GenericNamespaceTypeRefReference(PEFileToObjectModel peFileToObjectModel, IName typeName, uint typeRefRowId, IMetadataReaderModuleReference moduleReference, NamespaceReference namespaceReference, IName mangledTypeName, ushort genericParamCount, bool isValueType) : base(peFileToObjectModel, typeName, typeRefRowId, moduleReference, namespaceReference, isValueType)
		{
	...
	public sealed class NamespaceTypeRefReferenceWithoutPrimitiveTypeCode : NonGenericNamespaceTypeRefReference
	{
		public NamespaceTypeRefReferenceWithoutPrimitiveTypeCode(PEFileToObjectModel peFileToObjectModel, IName typeName, uint typeRefRowId, IMetadataReaderModuleReference moduleReference, NamespaceReference namespaceReference, bool isValueType) : base(peFileToObjectModel, typeName, typeRefRowId, moduleReference, namespaceReference, isValueType)
		{
		}

	}

	public sealed class NamespaceTypeRefReferenceWithPrimitiveTypeCode : NonGenericNamespaceTypeRefReference
	{
		readonly MetadataReaderSignatureTypeCode signatureTypeCode;

		public NamespaceTypeRefReferenceWithPrimitiveTypeCode(PEFileToObjectModel peFileToObjectModel, IName typeName, uint typeRefRowId, IMetadataReaderModuleReference moduleReference, NamespaceReference namespaceReference, MetadataReaderSignatureTypeCode signatureTypeCode) : base(peFileToObjectModel, typeName, typeRefRowId, moduleReference, namespaceReference, signatureTypeCode == MetadataReaderSignatureTypeCode.ValueType)
		{
			this.signatureTypeCode = signatureTypeCode;
	...
	public abstract class NestedTypeRefReference : TypeRefReference, INestedTypeReference
	{
		readonly IMetadataReaderNamedTypeReference parentTypeReference;

		public NestedTypeRefReference(PEFileToObjectModel peFileToObjectModel, IName typeName, uint typeRefRowId, IMetadataReaderModuleReference moduleReference, IMetadataReaderNamedTypeReference parentTypeReference, bool isValueType) : base(peFileToObjectModel, typeName, typeRefRowId, moduleReference, isValueType)
		{
	...
	public sealed class NonGenericNestedTypeRefReference : NestedTypeRefReference
	{

		public NonGenericNestedTypeRefReference(PEFileToObjectModel peFileToObjectModel, IName typeName, uint typeRefRowId, IMetadataReaderModuleReference moduleReference, IMetadataReaderNamedTypeReference parentTypeReference, bool isValueType) : base(peFileToObjectModel, typeName, typeRefRowId, moduleReference, parentTypeReference, isValueType)
		{
		}
	...
	public sealed class GenericNestedTypeRefReference : NestedTypeRefReference
	{
		readonly IName mangledTypeName;
		readonly ushort genericParamCount;

		public GenericNestedTypeRefReference(PEFileToObjectModel peFileToObjectModel, IName typeName, uint typeRefRowId, IMetadataReaderModuleReference moduleReference, IMetadataReaderNamedTypeReference parentTypeReference, IName mangledTypeName, ushort genericParamCount, bool isValueType) : base(peFileToObjectModel, typeName, typeRefRowId, moduleReference, parentTypeReference, isValueType)
		{
			this.mangledTypeName = mangledTypeName;
			this.genericParamCount = genericParamCount;
		}
		...
		public override bool MangleName {
			get { return this.typeName.UniqueKey != this.mangledTypeName.UniqueKey; }
		}
	}

	public sealed class TypeSpecReference : MetadataObject, ITypeReference
	{
		public readonly uint TypeSpecRowId;
		public readonly MetadataObject TypeSpecOwner;
		bool underlyingTypeInited;
		ITypeReference 		/*?*/underlyingModuleTypeReference;

		public TypeSpecReference(PEFileToObjectModel peFileToObjectModel, uint typeSpecRowId, MetadataObject typeSpecOwner) : base(peFileToObjectModel)
		{
		...
		public ITypeReference UnderlyingModuleTypeReference {
			/*?*/			get {
		...
		public bool IsValueType {
			get {
				...
				if (underlyingModuleTypeReference == null)
					return false;
	...
	public sealed class MethodImplementation : IMethodImplementation
	{
		...
		public MethodImplementation(ITypeDefinition containingType, IMethodReference methodDeclaration, IMethodReference methodBody)
		{
	...
	public abstract class TypeBase : ScopedContainerMetadataObject<ITypeDefinitionMember, ITypeDefinitionMember, ITypeDefinition>, IMetadataReaderNamedTypeReference, INamedTypeDefinition
	{
		public readonly IName TypeName;
		public readonly uint TypeDefRowId;
		public readonly TypeDefFlags TypeDefFlags;
		public ITypeReference 		/*?*/baseTypeReference;
		uint interfaceRowIdStart;
		uint interfaceRowIdEnd;
		public byte initFlags;
		public const byte BaseInitFlag = 0x1;
		public const byte EnumInited = 0x2;

		public TypeBase(PEFileToObjectModel peFileToObjectModel, IName typeName, uint typeDefRowId, TypeDefFlags typeDefFlags) : base(peFileToObjectModel)
		{
			this.TypeName = typeName;
			this.TypeDefRowId = typeDefRowId;
			this.interfaceRowIdStart = 0xffffffffu;
		...
		public IEnumerable<INestedTypeDefinition> nestedTypes = Enumerable<INestedTypeDefinition>.Empty;
		...
		public uint InterfaceRowIdStart {
			get {
				if (this.interfaceRowIdStart == 0xffffffffu) {
		...
		public ushort Alignment {
			get { return this.PEFileToObjectModel.GetAlignment(this); }
		}
		...
		public bool IsAbstract {
			get { return (this.TypeDefFlags & TypeDefFlags.AbstractSemantics) == TypeDefFlags.AbstractSemantics; }
		}
		...
		public bool IsDelegate {
			get { return TypeHelper.TypesAreEquivalent(this.BaseTypeReference, this.PEFileToObjectModel.SystemMulticastDelegate); }
		}

		public bool IsEnum {
			get { return TypeHelper.TypesAreEquivalent(this.BaseTypeReference, this.PEFileToObjectModel.SystemEnum) && this.IsSealed && !this.IsGeneric; }
		}
		...
		public bool IsValueType {
			get { return (TypeHelper.TypesAreEquivalent(this.BaseTypeReference, this.PEFileToObjectModel.SystemValueType) || TypeHelper.TypesAreEquivalent(this.BaseTypeReference, this.PEFileToObjectModel.SystemEnum)) && this.IsSealed; }
		}
		...
		public abstract ITypeReference UnderlyingType { get; }
	...
	public abstract class NamespaceType : TypeBase, IMetadataReaderNamedTypeReference, INamespaceTypeDefinition
	{
		readonly Namespace ParentModuleNamespace;

		public NamespaceType(PEFileToObjectModel peFileToObjectModel, IName typeName, uint typeDefRowId, TypeDefFlags typeDefFlags, Namespace parentModuleNamespace) : base(peFileToObjectModel, typeName, typeDefRowId, typeDefFlags)
		{
		...
		public IEnumerable<ICustomAttribute> AttributesFor(ITypeReference implementedInterface)
		{
			...
			for (uint interfaceIter = this.InterfaceRowIdStart; interfaceIter < ifaceRowIdEnd; ++interfaceIter) {
				ITypeReference 				/*?*/typeRef = this.PEFileToObjectModel.GetInterfaceForInterfaceRowId(this, interfaceIter);
				if (typeRef == null || typeRef.InternedKey != implementedInterface.InternedKey)
					continue;
				uint count = 0;
	...
	public abstract class NonGenericNamespaceType : NamespaceType
	{
		ITypeReference 		/*?*/enumUnderlyingType;
		public NonGenericNamespaceType(PEFileToObjectModel peFileToObjectModel, IName memberName, uint typeDefRowId, TypeDefFlags typeDefFlags, Namespace parentModuleNamespace) : base(peFileToObjectModel, memberName, typeDefRowId, typeDefFlags, parentModuleNamespace)
		{
		}
	...
	public sealed class NonGenericNamespaceTypeWithoutPrimitiveType : NonGenericNamespaceType
	{
		public NonGenericNamespaceTypeWithoutPrimitiveType(PEFileToObjectModel peFileToObjectModel, IName memberName, uint typeDefRowId, TypeDefFlags typeDefFlags, Namespace parentModuleNamespace) : base(peFileToObjectModel, memberName, typeDefRowId, typeDefFlags, parentModuleNamespace)
		{
		}
	...
	public sealed class _Module_Type : NonGenericNamespaceType
	{
		public _Module_Type(PEFileToObjectModel peFileToObjectModel, IName memberName, uint typeDefRowId, TypeDefFlags typeDefFlags, Namespace parentModuleNamespace) : base(peFileToObjectModel, memberName, typeDefRowId, typeDefFlags, parentModuleNamespace)
		{
		}
	...
	public sealed class NonGenericNamespaceTypeWithPrimitiveType : NonGenericNamespaceType
	{
		MetadataReaderSignatureTypeCode signatureTypeCode;
		public NonGenericNamespaceTypeWithPrimitiveType(PEFileToObjectModel peFileToObjectModel, IName memberName, uint typeDefRowId, TypeDefFlags typeDefFlags, Namespace parentModuleNamespace, MetadataReaderSignatureTypeCode signatureTypeCode) : base(peFileToObjectModel, memberName, typeDefRowId, typeDefFlags, parentModuleNamespace)
		{
			this.signatureTypeCode = signatureTypeCode;
		}
		...
		{
			switch (this.signatureTypeCode) {
				case MetadataReaderSignatureTypeCode.Boolean:
					return "System.Boolean";
				case MetadataReaderSignatureTypeCode.Byte:
					return "System.Byte";
				case MetadataReaderSignatureTypeCode.Char:
					return "System.Char";
				case MetadataReaderSignatureTypeCode.Double:
					return "System.Double";
				case MetadataReaderSignatureTypeCode.Int16:
					return "System.Int16";
				case MetadataReaderSignatureTypeCode.Int32:
					return "System.Int32";
				case MetadataReaderSignatureTypeCode.Int64:
					return "System.Int64";
				case MetadataReaderSignatureTypeCode.IntPtr:
					return "System.IntPtr";
				case MetadataReaderSignatureTypeCode.Object:
					return "System.Object";
				case MetadataReaderSignatureTypeCode.SByte:
					return "System.SByte";
				case MetadataReaderSignatureTypeCode.Single:
					return "System.Single";
				case MetadataReaderSignatureTypeCode.String:
					return "System.String";
				case MetadataReaderSignatureTypeCode.TypedReference:
					return "System.TypedReference";
				case MetadataReaderSignatureTypeCode.UInt16:
					return "System.UInt16";
				case MetadataReaderSignatureTypeCode.UInt32:
					return "System.UInt32";
				case MetadataReaderSignatureTypeCode.UInt64:
					return "System.UInt64";
				case MetadataReaderSignatureTypeCode.UIntPtr:
					return "System.UIntPtr";
				case MetadataReaderSignatureTypeCode.Void:
					return "System.Void";
			}
	...
	public sealed class GenericNamespaceType : NamespaceType
	{
		...
		public GenericNamespaceType(PEFileToObjectModel peFileToObjectModel, IName unmangledName, uint typeDefRowId, TypeDefFlags typeDefFlags, Namespace parentModuleNamespace, IName mangledName, uint genericParamRowIdStart, uint genericParamRowIdEnd) : base(peFileToObjectModel, unmangledName, typeDefRowId, typeDefFlags, parentModuleNamespace)
		{
	...
	public abstract class NestedType : TypeBase, INestedTypeDefinition
	{
		public readonly TypeBase OwningModuleType;
		ITypeReference 		/*?*/enumUnderlyingType;
		public NestedType(PEFileToObjectModel peFileToObjectModel, IName typeName, uint typeDefRowId, TypeDefFlags typeDefFlags, TypeBase parentModuleType) : base(peFileToObjectModel, typeName, typeDefRowId, typeDefFlags)
		{
	...
	public sealed class NonGenericNestedType : NestedType
	{

		public NonGenericNestedType(PEFileToObjectModel peFileToObjectModel, IName memberName, uint typeDefRowId, TypeDefFlags typeDefFlags, TypeBase parentModuleType) : base(peFileToObjectModel, memberName, typeDefRowId, typeDefFlags, parentModuleType)
		{
		}
	...
	public sealed class GenericNestedType : NestedType
	{
		readonly IName MangledName;
		public readonly uint GenericParamRowIdStart;
		public readonly uint GenericParamRowIdEnd;
		IGenericTypeInstanceReference 		/*?*/genericTypeInstance;

		public GenericNestedType(PEFileToObjectModel peFileToObjectModel, IName unmangledName, uint typeDefRowId, TypeDefFlags typeDefFlags, TypeBase parentModuleType, IName mangledName, uint genericParamRowIdStart, uint genericParamRowIdEnd) : base(peFileToObjectModel, unmangledName, typeDefRowId, typeDefFlags, parentModuleType)
		{
			this.MangledName = mangledName;
			this.GenericParamRowIdStart = genericParamRowIdStart;
			this.GenericParamRowIdEnd = genericParamRowIdEnd;
		...
		public override ushort GenericParameterCount {
			get { return (ushort)(this.GenericParamRowIdEnd - this.GenericParamRowIdStart - this.OwningModuleType.GenericTypeParameterCardinality); }
		}
		...
		public ITypeReference GetSpecializedTypeReference(INamedTypeReference nominalType, out int argumentsUsed, bool outer)
		{
			argumentsUsed = 0;
	...
	public abstract class SignatureGenericParameter : IGenericParameterReference
	{
		public readonly PEFileToObjectModel PEFileToObjectModel;

		public SignatureGenericParameter(PEFileToObjectModel peFileToObjectModel)
		{
			this.PEFileToObjectModel = peFileToObjectModel;
		}
	...
	public sealed class SignatureGenericTypeParameter : SignatureGenericParameter, IGenericTypeParameterReference
	{
		readonly INamedTypeReference TypeReference;
		readonly ushort GenericParameterIndex;

		public SignatureGenericTypeParameter(PEFileToObjectModel peFileToObjectModel, ITypeReference typeReference, ushort genericParameterOrdinality) : base(peFileToObjectModel)
		{
			...
			var nestedType = this.TypeReference as INestedTypeReference;
			//Fully unspecialized at this point, so no more generic instances to worry about
			while (nestedType != null) {
				var namespaceContainer = nestedType.ContainingType as INamespaceTypeReference;
				if (namespaceContainer != null) {
					parentGenericParameterCount += namespaceContainer.GenericParameterCount;
					break;
				}
		...
		public INamedTypeReference Unspecialize(ITypeReference typeReference)
		{
		...
		public override IName Name {
			get {
				if (this.name == null) {
					...
					if (genericInst != null)
						definingType = genericInst.GenericType.ResolvedType;
					if (definingType.GenericParameterCount <= this.GenericParameterIndex)
						...
						foreach (IGenericTypeParameter par in definingType.GenericParameters) {
							if (i++ < this.GenericParameterIndex)
								continue;
							this.name = par.Name;
							break;
						}
		...
		public IGenericTypeParameter Resolve()
		{
			ITypeDefinition definingType = this.DefiningType;
	...
	public sealed class SignatureGenericMethodParameter : SignatureGenericParameter, IGenericMethodParameterReference
	{
		readonly IMethodReference ModuleMethodReference;
		readonly ushort GenericParameterOrdinality;

		public SignatureGenericMethodParameter(PEFileToObjectModel peFileToObjectModel, IMethodReference moduleMethodReference, ushort genericParameterOrdinality) : base(peFileToObjectModel)
		{
		...
		public override IName Name {
			get {
				if (this.name == null) {
					...
					if (genericInst != null)
						definingMethod = genericInst.GenericMethod.ResolvedMethod;
					if (definingMethod.GenericParameterCount <= this.GenericParameterOrdinality)
						...
						foreach (IGenericMethodParameter par in definingMethod.GenericParameters) {
							if (i++ < this.GenericParameterOrdinality)
								continue;
							this.name = par.Name;
							break;
						}
		...
		public void Resolve()
		{
			...
			if (!definingMethod.IsGeneric || this.Index >= definingMethod.GenericParameterCount)
				return;
			foreach (var genMethPar in definingMethod.GenericParameters) {
				if (genMethPar.Index == this.Index) {
					this.resolvedType = genMethPar;
					return;
				}
			}
		}
	...
	public abstract class SimpleStructuralType : MetadataDefinitionObject, ITypeDefinition
	{
		uint TypeSpecToken;

		public SimpleStructuralType(PEFileToObjectModel peFileToObjectModel, uint typeSpecToken) : base(peFileToObjectModel)
		{
		...
		public void UpdateTypeSpecToken(uint typeSpecToken)
		{
			this.TypeSpecToken = typeSpecToken;
		}
	...
	public abstract class GenericParameter : SimpleStructuralType, IGenericParameter
	{
		public readonly ushort GenericParameterOrdinality;
		public readonly GenericParamFlags GenericParameterFlags;
		public readonly IName GenericParameterName;
		public readonly uint GenericParameterRowId;
		uint genericParamConstraintRowIDStart;
		uint genericParamConstraintRowIDEnd;

		public GenericParameter(PEFileToObjectModel peFileToObjectModel, ushort genericParameterOrdinality, GenericParamFlags genericParamFlags, IName genericParamName, uint genericParameterRowId) : base(peFileToObjectModel, TokenTypeIds.GenericParam | genericParameterRowId)
		{
			this.GenericParameterOrdinality = genericParameterOrdinality;
			...
			this.genericParamConstraintRowIDStart = 0xffffffffu;
			this.genericParamConstraintRowIDEnd = 0xffffffffu;
		}

		public uint GenericParamConstraintRowIDStart {
			get {
				if (this.genericParamConstraintRowIDStart == 0xffffffffu) {
		...
		public uint GenericParamConstraintRowIDEnd {
			get {
				if (this.genericParamConstraintRowIDStart == 0xffffffffu) {
					this.PEFileToObjectModel.GetConstraintInfoForGenericParam(this, out this.genericParamConstraintRowIDStart, out this.genericParamConstraintRowIDEnd);
				}
		...
		public uint GenericParamConstraintCount {
			get {
				if (this.genericParamConstraintRowIDStart == 0xffffffffu) {
					this.PEFileToObjectModel.GetConstraintInfoForGenericParam(this, out this.genericParamConstraintRowIDStart, out this.genericParamConstraintRowIDEnd);
				}
		...
		public override bool IsReferenceType {
			get {
				...
				for (uint genParamIter = this.GenericParamConstraintRowIDStart; genParamIter < genParamRowIdEnd; ++genParamIter) {
					...
					if (modTypeRef == null || TypeHelper.TypesAreEquivalent(modTypeRef, this.PEFileToObjectModel.SystemEnum) || TypeHelper.TypesAreEquivalent(modTypeRef, this.PEFileToObjectModel.PlatformType.SystemObject) || TypeHelper.TypesAreEquivalent(modTypeRef, this.PEFileToObjectModel.SystemValueType) || modTypeRef.ResolvedType.IsInterface) {
						continue;
					}
	...
	public sealed class GenericTypeParameter : GenericParameter, IGenericTypeParameter
	{
		public readonly TypeBase OwningGenericType;

		public GenericTypeParameter(PEFileToObjectModel peFileToObjectModel, ushort genericParameterOrdinality, GenericParamFlags genericParamFlags, IName genericParamName, uint genericParameterRowId, TypeBase owningGenericType) : base(peFileToObjectModel, genericParameterOrdinality, genericParamFlags, genericParamName, genericParameterRowId)
		{
	...
	public sealed class GenericMethodParameter : GenericParameter, IGenericMethodParameter
	{
		public readonly GenericMethod OwningGenericMethod;

		public GenericMethodParameter(PEFileToObjectModel peFileToObjectModel, ushort genericParameterOrdinality, GenericParamFlags genericParamFlags, IName genericParamName, uint genericParameterRowId, GenericMethod owningGenericMethod) : base(peFileToObjectModel, genericParameterOrdinality, genericParamFlags, genericParamName, genericParameterRowId)
		{
	...
	public sealed class PointerTypeWithToken : PointerType, IMetadataObjectWithToken
	{

		public PointerTypeWithToken(uint tokenValue, ITypeReference targetType, IInternFactory internFactory) : base(targetType, internFactory)
		{
	...
	public sealed class ManagedPointerTypeWithToken : ManagedPointerType, IMetadataObjectWithToken
	{

		public ManagedPointerTypeWithToken(uint tokenValue, ITypeReference targetType, IInternFactory internFactory) : base(targetType, internFactory)
		{
			this.tokenValue = tokenValue;
		}
	...
	public sealed class VectorWithToken : Vector, IMetadataObjectWithToken
	{

		public VectorWithToken(uint tokenValue, ITypeReference elementType, IInternFactory internFactory) : base(elementType, internFactory)
		{
			this.tokenValue = tokenValue;
		}
	...
	public sealed class MatrixWithToken : Matrix, IMetadataObjectWithToken
	{

			/*?*/			/*?*/		public MatrixWithToken(uint tokenValue, ITypeReference elementType, uint rank, IEnumerable<int> lowerBounds		, IEnumerable<ulong> sizes		, IInternFactory internFactory) : base(elementType, rank, lowerBounds, sizes, internFactory)
		{
			this.tokenValue = tokenValue;
		}
	...
	public sealed class FunctionPointerTypeWithToken : FunctionPointerType, IMetadataObjectWithToken
	{

			/*?*/			/*?*/		public FunctionPointerTypeWithToken(uint tokenValue, CallingConvention callingConvention, bool returnValueIsByRef, ITypeReference type, IEnumerable<ICustomModifier> returnValueCustomModifiers		, IEnumerable<IParameterTypeInformation> parameters, IEnumerable<IParameterTypeInformation> extraArgumentTypes		, IInternFactory internFactory) : base(callingConvention, returnValueIsByRef, type, returnValueCustomModifiers, parameters, extraArgumentTypes, internFactory)
		{
			this.tokenValue = tokenValue;
		}
	...
	public sealed class GenericTypeInstanceReferenceWithToken : GenericTypeInstanceReference, IMetadataObjectWithToken, ITypeReference
	{

		public GenericTypeInstanceReferenceWithToken(uint tokenValue, INamedTypeReference genericType, IEnumerable<ITypeReference> genericArguments, IInternFactory internFactory) : base(genericType, genericArguments, internFactory)
		{
	...
	public abstract class ExportedTypeAliasBase : ScopedContainerMetadataObject<IAliasMember, IAliasMember, IAliasForType>, IAliasForType
	{
		public readonly IName TypeName;
		public readonly uint ExportedTypeRowId;
		public readonly TypeDefFlags TypeDefFlags;
		INamedTypeReference 		/*?*/aliasTypeReference;

		public ExportedTypeAliasBase(PEFileToObjectModel peFileToObjectModel, IName typeName, uint exportedTypeDefRowId, TypeDefFlags typeDefFlags) : base(peFileToObjectModel)
		{
			this.TypeName = typeName;
	...
	public sealed class ExportedTypeNamespaceAlias : ExportedTypeAliasBase, INamespaceAliasForType
	{
		readonly Namespace ParentModuleNamespace;

		public ExportedTypeNamespaceAlias(PEFileToObjectModel peFileToObjectModel, IName typeName, uint exportedTypeDefRowId, TypeDefFlags typeDefFlags, Namespace parentModuleNamespace) : base(peFileToObjectModel, typeName, exportedTypeDefRowId, typeDefFlags)
		{
			this.ParentModuleNamespace = parentModuleNamespace;
		}
	...
	public sealed class ExportedTypeNestedAlias : ExportedTypeAliasBase, INestedAliasForType
	{
		readonly ExportedTypeAliasBase ParentExportedTypeAlias;

		public ExportedTypeNestedAlias(PEFileToObjectModel peFileToObjectModel, IName typeName, uint exportedTypeDefRowId, TypeDefFlags typeDefFlags, ExportedTypeAliasBase parentExportedTypeAlias) : base(peFileToObjectModel, typeName, exportedTypeDefRowId, typeDefFlags)
		{
	...
	public sealed class CustomModifier : ICustomModifier
	{
		public readonly bool IsOptional;
		public readonly ITypeReference Modifier;
	...
	public abstract class Parameter : MetadataDefinitionObject, IParameterDefinition
	{

			/*?*/			/*?*/		public Parameter(PEFileToObjectModel peFileToObjectModel, int index, IEnumerable<ICustomModifier> customModifiers		, ITypeReference type		, ISignature containingSignature) : base(peFileToObjectModel)
		{
	...
	public sealed class ParameterInfo : MetadataObject, IParameterTypeInformation
	{

			/*?*/			/*?*/		public ParameterInfo(PEFileToObjectModel peFileToObjectModel, int parameterIndex, IEnumerable<ICustomModifier> moduleCustomModifiers		, ITypeReference typeReference		, ISignature containingSignatureDefinition, bool isByReference) : base(peFileToObjectModel)
		{
	...
	public sealed class ParameterWithMetadata : Parameter
	{
		ParamFlags ParameterFlags;
		IName ParameterName;
		uint ParamRowId;

			/*?*/			/*?*/		//  Means that this is last parameter && type is array...
		public ParameterWithMetadata(PEFileToObjectModel peFileToObjectModel, int parameterIndex, IEnumerable<ICustomModifier> moduleCustomModifiers		, ITypeReference typeReference		, ISignature containingSignatureDefinition, bool isByReference, bool possibleParamArray, uint paramRowId, IName parameterName, ParamFlags parameterFlags) : base(peFileToObjectModel, parameterIndex, moduleCustomModifiers, typeReference, containingSignatureDefinition)
		{
	...
	public sealed class ParameterWithoutMetadata : Parameter
	{

			/*?*/			/*?*/		public ParameterWithoutMetadata(PEFileToObjectModel peFileToObjectModel, int index, IEnumerable<ICustomModifier> moduleCustomModifiers		, ITypeReference typeReference		, ISignature containingSignature, bool isByReference) : base(peFileToObjectModel, index, moduleCustomModifiers, typeReference, containingSignature)
		{
			this.isByReference = isByReference;
		}
	...
	public sealed class SpecializedParameter : IParameterDefinition
	{
		public readonly IParameterDefinition RawTemplateParameter;
		public readonly ISignature ContainingSignatureDefinition;
		public readonly ITypeReference 		/*?*/TypeReference;

			/*?*/		public SpecializedParameter(IParameterDefinition rawTemplateParameter, ISignature containingSignatureDefinition, ITypeReference typeReference		)
		{
	...
	public sealed class SpecializedParameterInfo : IParameterTypeInformation
	{
		public readonly IParameterTypeInformation RawTemplateParameterInfo;
		public readonly ISignature ContainingSignatureDefinition;
		public readonly ITypeReference 		/*?*/TypeReference;

			/*?*/		public SpecializedParameterInfo(IParameterTypeInformation rawTemplateParameterInfo, ISignature containingSignatureDefinition, ITypeReference typeReference		)
		{
	...
	public sealed class TypeCache
	{
		...
		public static PrimitiveTypeCode[] PrimitiveTypeCodeConv = {
		...
		public TypeCache(PEFileToObjectModel peFileToObjectModel)
		{
			this.PEFileToObjectModel = peFileToObjectModel;
			this.ModuleTypeHashTable = new Hashtable<ITypeReference>();
		}

		public CoreTypeReference CreateCoreTypeReference(AssemblyReference coreAssemblyReference, NamespaceReference namespaceReference, IName typeName, MetadataReaderSignatureTypeCode signatureTypeCode)
		{
		...
		public CoreTypeReference CreateCoreTypeReference(AssemblyReference coreAssemblyReference, NamespaceReference namespaceReference, IName typeName, ushort genericParameterCount, MetadataReaderSignatureTypeCode signatureTypeCode)
		{
		...
		static TypeMemberVisibility[,] LUB = {
			...
			//  Family
			{
				...
				TypeMemberVisibility.Assembly,
				TypeMemberVisibility.Family,
				TypeMemberVisibility.FamilyAndAssembly,
				TypeMemberVisibility.FamilyOrAssembly,
				TypeMemberVisibility.FamilyAndAssembly,
				TypeMemberVisibility.FamilyAndAssembly,
				TypeMemberVisibility.Public
		...
		/// <returns></returns>
		public static TypeMemberVisibility LeastUpperBound(TypeMemberVisibility left, TypeMemberVisibility right)
		{
			return TypeCache.LUB[(int)left, (int)right];
		}

		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
		public static void SplitMangledTypeName(string mangledTypeName, out string typeName, out ushort genericParamCount)
		{
			...
			#if COMPACTFX
			try {
				genericParamCount = ushort.Parse(mangledTypeName.Substring(index + 1, mangledTypeName.Length - index - 1), System.Globalization.NumberStyles.Integer, System.Globalization.CultureInfo.InvariantCulture);
			} catch {
			}
			#else
			ushort.TryParse(mangledTypeName.Substring(index + 1, mangledTypeName.Length - index - 1), System.Globalization.NumberStyles.Integer, System.Globalization.CultureInfo.InvariantCulture, out genericParamCount);
			#endif
		}

		public static INamedTypeReference Unspecialize(ITypeReference typeReference)
		{
			var genericTypeInstance = typeReference as IGenericTypeInstanceReference;
			if (genericTypeInstance != null) {
				var genericType = genericTypeInstance.GenericType;
