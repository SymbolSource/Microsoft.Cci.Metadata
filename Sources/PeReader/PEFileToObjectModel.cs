...
namespace Microsoft.Cci.MetadataReader
{
	...
	public sealed partial class PEFileToObjectModel
	{
		public readonly PeReader ModuleReader;
		public readonly Assembly 		/*?*/ContainingAssembly;
		public readonly IInternFactory InternFactory;
		public readonly PEFileReader PEFileReader;
		...
		public readonly _Module_Type _Module_;

		public CoreTypes CoreTypes {
			get {
		...
		public IMetadataReaderNamedTypeReference SystemEnum {
			get { return this.CoreTypes.SystemEnum; }
		}
		public IMetadataReaderNamedTypeReference SystemValueType {
			get { return this.CoreTypes.SystemValueType; }
		}
		public IMetadataReaderNamedTypeReference SystemMulticastDelegate {
			get { return this.CoreTypes.SystemMulticastDelegate; }
		}
		public IMetadataReaderNamedTypeReference SystemType {
			get { return this.CoreTypes.SystemType; }
		}
		public IMetadataReaderNamedTypeReference SystemParamArrayAttribute {
    ...
    ^*/
		...
		public AssemblyIdentity GetContractAssemblySymbolicIdentity()
		{
			lock (GlobalLock.LockingObject) {
				...
				for (uint i = 1; i <= trTable.NumberOfRows; i++) {
					...
					if (nsName.UniqueKey != systemDiagnosticsContractsKey)
						continue;
					int tKey = this.GetNameFromOffset(tr.Name).UniqueKey;
					if (tKey != codeContractKey)
						continue;
		...
		public AssemblyIdentity GetCoreAssemblySymbolicIdentity()
		{
			lock (GlobalLock.LockingObject) {
				INameTable nameTable = this.NameTable;
				PeReader peReader = this.ModuleReader;
		...
		public IName GetNameFromOffset(uint offset)
		{
		...
		//  Caller should lock this.
		public IName GetUnmangledNameFromOffset(uint offset)
		{
		...
		/// </summary>
		public AssemblyReference[] AssemblyReferenceArray;
		/// <summary>
		...
		public byte MetadataFormatMajorVersion {
			get { return this.PEFileReader.MetadataTableHeader.MajorVersion; }
		}

		public byte MetadataFormatMinorVersion {
			get { return this.PEFileReader.MetadataTableHeader.MinorVersion; }
		}

		public Machine Machine {
			get { return this.PEFileReader.Machine; }
		}

		public bool RequiresAmdInstructionSet {
			get { return this.PEFileReader.RequiresAmdInstructionSet; }
		}

		public bool RequiresStartupStub {
			get { return this.PEFileReader.RequiresStartupStub; }
		}

		public bool Requires64Bits {
			get { return this.PEFileReader.Requires64Bits; }
		}

		public Guid ModuleGuidIdentifier {
			get { return this.PEFileReader.ModuleGuidIdentifier; }
		}

		public string TargetRuntimeVersion {
			get { return this.PEFileReader.MetadataHeader.VersionString; }
		}
		...
		public void LoadModuleReferences()
		{
		...
		public AssemblyReference GetAssemblyReferenceAt(		/*?*/uint assemRefRowId)
		{
		...
		public ModuleReference GetModuleReferenceAt(		/*?*/uint moduleRefRowId)
		{
		...
		public IEnumerable<IAssemblyReference> GetAssemblyReferences()
		{
			if (this.AssemblyReferences == null) {
				...
				for (int i = 0; i < numberOfAssemblyReferences; i++)
					arefArray[i] = this.AssemblyReferenceArray[i + 1];
		...
		public IEnumerable<IModuleReference> GetModuleReferences()
		{
		...
		//  Caller should lock this.
		public Assembly ResolveAssemblyRefReference(		/*?*/AssemblyReference assemblyReference)
		{
		...
		//  Caller should lock this.
		public IModule ResolveModuleRefReference(		/*?*/ModuleReference moduleReference)
		{
		...
		/// <returns></returns>
		public AssemblyReference FindAssemblyReference(		/*?*/AssemblyIdentity assemblyIdentity)
		{
		...
		public IEnumerable<IPESection> GetUninterpretedPESections()
		{
		...
		public string GetWin32ResourceName(int idOrName)
		{
			if (idOrName >= 0)
				return string.Empty;
			int numBytes;
		...
		public EnumerableMemoryBlockWrapper GetWin32ResourceBytes(int dataRVA, int size)
		{
			return new EnumerableMemoryBlockWrapper(this.PEFileReader.RVAToMemoryBlockWithSize(dataRVA, size));
		}

		public EnumerableMemoryBlockWrapper GetWin32ResourceBytes(uint dataRVA, uint size)
		{
			return new EnumerableMemoryBlockWrapper(this.PEFileReader.RVAToMemoryBlockWithSize((int)dataRVA, (int)size));
		}

		public IEnumerable<IWin32Resource> GetWin32Resources()
		{
		...
		public EnumerableMemoryBlockWrapper GetFileHash(uint fileRowId)
		{
		...
		public void InitFileReferenceArray()
		{
			lock (GlobalLock.LockingObject) {
		...
		public FileReference GetFileReferenceAt(		/*?*/uint fileRefRowId)
		{
			if (this.FileReferenceArray == null) {
		...
		public IEnumerable<IFileReference> GetFiles()
		{
			if (this.FileReferenceArray == null) {
				this.InitFileReferenceArray();
			}
		...
		public void InitResourceReferenceArray()
		{
			lock (GlobalLock.LockingObject) {
		...
		public ResourceReference LookupResourceReference(		/*?*/IName name)
		{
			if (this.ResourceReferenceArray == null) {
		...
		public IResource ResolveResource(ResourceReference resourceReference, ResourceReference originalReference)
		{
		...
		public IFileReference GetExternalFileForResource(uint resourceRowId)
		{
		...
		public IEnumerable<byte> GetResourceData(Resource resource)
		{
		...
		public IEnumerable<IResourceReference> GetResources()
		{
			if (this.ResourceReferenceArray == null) {
				this.InitResourceReferenceArray();
			}
		...
		public string GetDebugInformationLocation()
		{
		...
		public IMethodReference GetEntryPointMethod()
		{
		...
		public readonly RootNamespace RootModuleNamespace;
		...
		public Namespace GetNamespaceForString(string namespaceFullName)
		{
		...
		public void BuildNamespaceForNameOffset(uint namespaceNameOffset, Hashtable<Namespace> namespaceOffsetHashtable)
		{
		...
		public Namespace GetNamespaceForNameOffset(uint namespaceNameOffset)
		{
		...
		public NamespaceReference GetNamespaceReferenceForString(IMetadataReaderModuleReference moduleReference, IName iNamespaceFullName)
		{
		...
		public void PreLoadTypeDefTableLookup()
		{
			uint numberOfTypeDefs = this.PEFileReader.TypeDefTable.NumberOfRows;
			for (uint i = 1; i <= numberOfTypeDefs; ++i) {
		...
		public NamespaceType CreateModuleNamespaceType(uint typeDefRowId, TypeDefRow typeDefRow, Namespace moduleNamespace, MetadataReaderSignatureTypeCode signatureTypeCode)
		{
			IName typeName = this.GetNameFromOffset(typeDefRow.Name);
		...
		public NestedType CreateModuleNestedType(uint typeDefRowId, TypeDefRow typeDefRow, TypeBase parentModuleType)
		{
			IName typeName = this.GetNameFromOffset(typeDefRow.Name);
		...
		public ExportedTypeNamespaceAlias CreateExportedNamespaceType(uint exportedTypeRowId, ExportedTypeRow exportedTypeRow, Namespace moduleNamespace)
		{
		...
		public ExportedTypeNestedAlias CreateExportedNestedType(uint exportedTypeRowId, ExportedTypeRow exportedTypeRow, ExportedTypeAliasBase parentExportedType)
		{
			IName typeName = this.GetNameFromOffset(exportedTypeRow.TypeName);
		...
		public void LoadTypesInNamespace(Namespace moduleNamespace)
		{
			CoreTypes dummy = this.CoreTypes;
			//force core types to be initialized
			uint namespaceNameOffset = moduleNamespace.NamespaceNameOffset;
			Debug.Assert(namespaceNameOffset != 0xffffffffu);
			uint numberOfTypeDefs = this.PEFileReader.TypeDefTable.NumberOfRows;
		...
		public TypeBase GetPredefinedTypeDefinitionAtRowWorker(uint typeDefRowId, MetadataReaderSignatureTypeCode signatureTypeCode)
		{
			if (this.ModuleTypeDefLoadState[typeDefRowId] == LoadState.Uninitialized) {
				...
				Debug.Assert(!typeDefRow.IsNested);
				//  TODO: MD Error if this happens
		...
		public _Module_Type Create_Module_Type()		/*?*/		//^ ensures this.ModuleTypeDefLoadState[typeDefRowId] == LoadState.Loaded;
		...
		public TypeBase GetTypeDefinitionAtRowWorker(		/*?*/		//^ ensures this.ModuleTypeDefLoadState[typeDefRowId] == LoadState.Loaded;
uint typeDefRowId)
		{
			...
			if (this.ModuleTypeDefLoadState[typeDefRowId] == LoadState.Uninitialized) {
				...
				if (typeDefRow.IsNested) {
					...
					Namespace parentNamespace = this.GetNamespaceForNameOffset(typeDefRow.Namespace);
					type = this.CreateModuleNamespaceType(typeDefRowId, typeDefRow, parentNamespace, MetadataReaderSignatureTypeCode.NotModulePrimitive);
				}
		...
		public TypeBase GetTypeDefinitionAtRow(		/*?*/uint typeDefRowId)
		{
			if (typeDefRowId == 0 || typeDefRowId > this.PEFileReader.TypeDefTable.NumberOfRows) {
				return null;
			}
		...
		public ExportedTypeAliasBase GetExportedTypeAtRowWorker(		/*?*/		//^ ensures this.ExportedTypeLoadState[exportedTypeRowId] == LoadState.Loaded;
uint exportedTypeRowId)
		...
		public ExportedTypeAliasBase GetExportedTypeAtRow(		/*?*/uint exportedTypeRowId)
		{
			if (exportedTypeRowId == 0 || exportedTypeRowId > this.PEFileReader.ExportedTypeTable.NumberOfRows) {
				return null;
			}
		...
		public IEnumerable<IAliasForType> GetEnumberableForExportedTypes()
		{
			uint numberOfExportedTypes = this.PEFileReader.ExportedTypeTable.NumberOfRows;
			for (uint i = 1; i <= numberOfExportedTypes; ++i) {
		...
		public void LoadNestedExportedTypesOfAlias(ExportedTypeAliasBase exportedType)
		{
		...
		/// </summary>
		public INamedTypeDefinition ResolveNamespaceTypeDefinition(		/*?*/IName namespaceName, IName mangledTypeName)
		{
			...
			if (tokenType == TokenTypeIds.ExportedType) {
				...
				if (alias != null)
					return alias.AliasedType.ResolvedType;
			}
			return null;
		}
		...
		/// <returns></returns>
		public INamedTypeDefinition ResolveNestedTypeDefinition(		/*?*/INamedTypeDefinition parentType, IName typeName)
		{
		...
		/// </summary>
		public ExportedTypeAliasBase TryToResolveAsNamespaceTypeAlias(		/*?*/IName namespaceName, IName mangledTypeName)
		{
		...
		/// <param name="typeName"></param>
		/// <returns></returns>
		public ExportedTypeAliasBase ResolveExportedNestedType(		/*?*/ExportedTypeAliasBase parentType, IName typeName)
		{
		...
		public void GetGenericParamInfoForType(uint typeDefRowId, out uint genericParamRowIdStart, out uint genericParamRowIdEnd)
		{
			ushort genericParamCount;
		...
		public ITypeReference GetBaseTypeForType(		/*?*/TypeBase moduleType)
		{
		...
		public void GetInterfaceInfoForType(TypeBase moduleType, out uint interfaceRowIdStart, out uint interfaceRowIdEnd)
		{
			uint interfaceCount;
		...
		public void GetMethodImplInfoForType(TypeBase moduleType, out uint methodImplRowIdStart, out uint methodImplRowIdEnd)
		{
		...
		public void GetConstraintInfoForGenericParam(GenericParameter genericParam, out uint genericParamConstraintRowIdStart, out uint genericParamConstraintRowIdEnd)
		{
		...
		public ITypeReference GetInterfaceForInterfaceRowId(		/*?*/TypeBase moduleType, uint interfaceRowId)
		{
		...
		public MethodImplementation GetMethodImplementation(TypeBase moduleType, uint methodImplRowId)
		{
		...
		public ITypeReference GetTypeReferenceForGenericConstraintRowId(		/*?*/GenericParameter genParam, uint interfaceRowId)
		{
		...
		public ITypeReference GetSerializedTypeNameAsTypeReference(		/*?*/TypeName typeName)
		{
		...
		public ITypeReference GetSerializedTypeNameAsTypeReference(		/*?*/string serializedTypeName)
		{
		...
		public ushort GetAlignment(TypeBase type)
		{
			return this.PEFileReader.ClassLayoutTable.GetPackingSize(type.TypeDefRowId);
		}
		public uint GetClassSize(TypeBase type)
		{
		...
		public GenericTypeParameter GetGenericTypeParamAtRow(		/*?*/		//^ requires genericParamRowId >= 1;
uint genericParamRowId, TypeBase moduleTypeOwner)
		{
		...
		public GenericMethodParameter GetGenericMethodParamAtRow(		/*?*/		//^ requires genericParamRowId >= 1;
uint genericParamRowId, GenericMethod moduleMethodOwner)
		{
			if (this.ModuleGenericParamArray[genericParamRowId] == null) {
				lock (GlobalLock.LockingObject) {
					if (this.ModuleGenericParamArray[genericParamRowId] == null) {
		...
		//^ invariant this.PEFileReader.TypeSpecTable.NumberOfRows >= 1 ==> this.ModuleTypeSpecHashtable != null;
			...
			/*?*/		public TypeRefReference CreateTypeRefReference(uint typeRefRowId, TypeRefRow typeRefRow, IMetadataReaderNamedTypeReference parentModuleTypeReference		, IMetadataReaderModuleReference moduleReference, MetadataReaderSignatureTypeCode signatureTypeCode)
		{
			...
			if (parentModuleTypeReference == null) {
				...
				if (genericParamCount == 0) {
					if (signatureTypeCode == MetadataReaderSignatureTypeCode.NotModulePrimitive) {
						moduleTypeRefReference = new NamespaceTypeRefReferenceWithoutPrimitiveTypeCode(this, mangledTypeName, typeRefRowId, moduleReference, namespaceReference, signatureTypeCode == MetadataReaderSignatureTypeCode.ValueType);
					} else {
						moduleTypeRefReference = new NamespaceTypeRefReferenceWithPrimitiveTypeCode(this, mangledTypeName, typeRefRowId, moduleReference, namespaceReference, signatureTypeCode);
					}
				} else {
					IName iTypeName = this.NameTable.GetNameFor(typeName);
					moduleTypeRefReference = new GenericNamespaceTypeRefReference(this, iTypeName, typeRefRowId, moduleReference, namespaceReference, mangledTypeName, genericParamCount, signatureTypeCode == MetadataReaderSignatureTypeCode.ValueType);
				}
			} else {
				if (genericParamCount == 0) {
					moduleTypeRefReference = new NonGenericNestedTypeRefReference(this, mangledTypeName, typeRefRowId, moduleReference, parentModuleTypeReference, signatureTypeCode == MetadataReaderSignatureTypeCode.ValueType);
				} else {
					IName iTypeName = this.NameTable.GetNameFor(typeName);
					moduleTypeRefReference = new GenericNestedTypeRefReference(this, iTypeName, typeRefRowId, moduleReference, parentModuleTypeReference, mangledTypeName, genericParamCount, signatureTypeCode == MetadataReaderSignatureTypeCode.ValueType);
				}
			}
			return moduleTypeRefReference;
		}

		public IMetadataReaderNamedTypeReference GetPredefinedTypeRefReferenceAtRowWorker(uint typeRefRowId, MetadataReaderSignatureTypeCode signatureTypeCode)
		{
			Debug.Assert(typeRefRowId > 0 && typeRefRowId <= this.PEFileReader.TypeRefTable.NumberOfRows);
			Debug.Assert(this.ModuleTypeRefReferenceLoadState[typeRefRowId] == LoadState.Uninitialized && this.ModuleTypeRefReferenceArray[typeRefRowId] == null);
			...
			Debug.Assert(resolutionScopeKind == TokenTypeIds.AssemblyRef);
			//  TODO: MD Error
		...
		public IMetadataReaderNamedTypeReference GetTypeRefReferenceAtRowWorker(		/*?*/uint typeRefRowId)
		{
			return this.GetTypeRefReferenceAtRowWorker(typeRefRowId, false);
		}
		public IMetadataReaderNamedTypeReference GetTypeRefReferenceAtRowWorker(		/*?*/uint typeRefRowId, bool mustBeStruct)
		{
			...
			if (this.ModuleTypeRefReferenceLoadState[typeRefRowId] == LoadState.Uninitialized) {
				...
				if (resolutionScopeKind == TokenTypeIds.TypeRef) {
					...
					typeRefReference = this.CreateTypeRefReference(typeRefRowId, typeRefRow, parentModuleTypeReference, parentModuleTypeReference.ModuleReference, mustBeStruct ? MetadataReaderSignatureTypeCode.ValueType : MetadataReaderSignatureTypeCode.NotModulePrimitive);
				} else {
					...
					typeRefReference = this.CreateTypeRefReference(typeRefRowId, typeRefRow, null, moduleReference, mustBeStruct ? MetadataReaderSignatureTypeCode.ValueType : MetadataReaderSignatureTypeCode.NotModulePrimitive);
				}
		...
		public IEnumerable<ITypeMemberReference> GetMemberReferences()
		{
		...
		public INamedTypeReference GetTypeRefReferenceAtRow(		/*?*/		//^ requires typeRefRowId >=1;
uint typeRefRowId)
		{
			return this.GetTypeRefReferenceAtRow(typeRefRowId, false);
		}
		public IMetadataReaderNamedTypeReference GetTypeRefReferenceAtRow(		/*?*/		//^ requires typeRefRowId >=1;
uint typeRefRowId, bool mustBeStruct)
		{
			if (typeRefRowId > this.PEFileReader.TypeRefTable.NumberOfRows || typeRefRowId == 0) {
				return null;
			}
			...
			if (mustBeStruct && typeRefReference != null)
				typeRefReference.isValueType = true;
			return this.ModuleTypeRefReferenceArray[typeRefRowId];
		}
		public TypeSpecReference GetTypeSpecReferenceAtRow(		/*?*/		//^ requires this.PEFileReader.TypeSpecTable.NumberOfRows >= 1;
		//^ requires typeSpecRowId >= 1 && typeSpecRowId <= this.PEFileReader.TypeSpecTable.NumberOfRows;
MetadataObject owningObject, uint typeSpecRowId)
		{
		...
		public ITypeReference GetTypeReferenceForToken(		/*?*/MetadataObject owningObject, uint token)
		{
			return this.GetTypeReferenceForToken(owningObject, token, false);
		}
		public ITypeReference GetTypeReferenceForToken(		/*?*/MetadataObject owningObject, uint token, bool mustBeStruct)
		{
			...
			switch (tokenType) {
				case TokenTypeIds.TypeDef:
					
					{
						...
						return this.ModuleReader.metadataReaderHost.Redirect(this.Module, this.GetTypeDefinitionAtRow(rowId));
					}
				...
				case TokenTypeIds.TypeRef:
					
					{
						...
						return this.ModuleReader.metadataReaderHost.Redirect(this.Module, this.GetTypeRefReferenceAtRow(rowId, mustBeStruct));
					}
		...
		/// <returns></returns>
		public INamedTypeDefinition ResolveModuleTypeRefReference(		/*?*/IMetadataReaderNamedTypeReference namedTypeReference)
		{
			var moduleTypeRefReference = namedTypeReference as TypeRefReference;
			if (moduleTypeRefReference == null)
				return namedTypeReference.ResolvedType;
		...
		public ExportedTypeAliasBase TryToResolveNamespaceTypeReferenceAsExportedType(		/*?*/NamespaceTypeRefReference namespaceTypeReference)
		{
			...
			if (resolutionScope == 0)
				//The reference is to something in this module
		...
		/// </summary>
		public INamedTypeReference GetReferenceToAliasedType(		/*?*/ExportedTypeAliasBase alias)
		{
				...
				case TokenTypeIds.AssemblyRef:
					
					{
						...
						if (internalAssembly != null) {
							...
							if (aliasType != null && aliasType != alias)
								return assemblyPEFileToObjectModel.GetReferenceToAliasedType(aliasType);
						...
						if (namespaceName.Value.Length > 0)
							fullTypeName = namespaceName.Value + "." + fullTypeName;
		...
		public ITypeReference UnderlyingModuleTypeSpecReference(		/*?*/		//^ requires moduleTypeSpecReference.TypeSpecRowId >= 1;
TypeSpecReference moduleTypeSpecReference)
		...
		public TypeBase FindCoreTypeReference(CoreTypeReference coreTypeReference)
		{
		...
		public FieldDefinition CreateField(uint fieldDefRowId, TypeBase parentModuleType)
		{
		...
		public IMethodDefinition CreateMethod(uint methodDefRowId, TypeBase parentModuleType)
		{
		...
		public EventDefinition CreateEvent(uint eventDefRowId, TypeBase parentModuleType)
		{
		...
		public PropertyDefinition CreateProperty(uint propertyDefRowId, TypeBase parentModuleType)
		{
		...
		public void LoadNestedTypesOfType(TypeBase moduleType)
		{
			...
			for (uint i = 1; i <= numberOfNestedClassRows; ++i) {
				...
				if (nestedClassRow.EnclosingClass != currentClassRowId)
					continue;
				if (firstNestedClassRow == 0)
					firstNestedClassRow = i;
				nestedClassCounter++;
				//  Check if its already created by someone else
		...
		public void LoadFieldsOfType(TypeBase moduleType)
		{
			uint fieldCount;
		...
		public IEnumerable<IFieldDefinition> GetFieldsOfType(TypeBase moduleType)
		{
			uint fieldCount;
			uint fieldStart = this.PEFileReader.GetFieldInformation(moduleType.TypeDefRowId, out fieldCount);
			uint fieldEnd = fieldStart + fieldCount;
		...
		public void LoadMethodsOfType(TypeBase moduleType)
		{
			uint methodCount;
		...
		public IEnumerable<IMethodDefinition> GetMethodsOfType(TypeBase moduleType)
		{
			uint methodCount;
			uint methodStart = this.PEFileReader.GetMethodInformation(moduleType.TypeDefRowId, out methodCount);
			uint methodEnd = methodStart + methodCount;
		...
		public void LoadEventsOfType(TypeBase moduleType)
		{
			uint eventCount;
		...
		public IEnumerable<IEventDefinition> GetEventsOfType(TypeBase moduleType)
		{
			uint eventCount;
			uint eventStart = this.PEFileReader.GetEventInformation(moduleType.TypeDefRowId, out eventCount);
			uint eventEnd = eventStart + eventCount;
		...
		public void LoadPropertiesOfType(TypeBase moduleType)
		{
			uint propertyCount;
		...
		public IEnumerable<IPropertyDefinition> GetPropertiesOfType(TypeBase moduleType)
		{
			uint propertyCount;
			uint propertyStart = this.PEFileReader.GetPropertyInformation(moduleType.TypeDefRowId, out propertyCount);
			uint propertyEnd = propertyStart + propertyCount;
		...
		public void LoadMembersOfType(TypeBase moduleType)
		{
		...
		public IMethodDefinition GetMethodDefAtRow(		/*?*/uint methodDefRowId)
		{
		...
		public FieldDefinition GetFieldDefAtRow(		/*?*/uint fieldDefRowId)
		{
		...
		public FieldDefinition CreateGlobalField(uint fieldDefRowId)
		{
			Debug.Assert(fieldDefRowId > 0 && fieldDefRowId <= this.PEFileReader.FieldTable.NumberOfRows);
			FieldRow fieldRow = this.PEFileReader.FieldTable[fieldDefRowId];
		...
		public MethodDefinition CreateGlobalMethod(uint methodDefRowId)
		{
			Debug.Assert(methodDefRowId > 0 && methodDefRowId <= this.PEFileReader.MethodTable.NumberOfRows);
			MethodRow methodRow = this.PEFileReader.MethodTable[methodDefRowId];
		...
		public void LoadMembersOf_Module_Type()
		{
		...
		public void GetGenericParamInfoForMethod(uint methodDefRowId, out uint genericParamRowIdStart, out uint genericParamRowIdEnd)
		{
			ushort genericParamCount;
		...
		public FieldSignatureConverter GetFieldSignature(FieldDefinition moduleField)
		{
		...
		public PropertySignatureConverter GetPropertySignature(PropertyDefinition moduleProperty)
		{
		...
		public MethodDefSignatureConverter GetMethodSignature(MethodDefinition moduleMethod)
		{
		...
		public ushort GetMethodParameterCount(MethodDefinition moduleMethod)
		{
			uint signatureBlobOffset = this.PEFileReader.MethodTable.GetSignature(moduleMethod.MethodDefRowId);
			//  TODO: error checking offset in range
			MemoryBlock signatureMemoryBlock = this.PEFileReader.BlobStream.GetMemoryBlockAt(signatureBlobOffset);
		...
		public ITypeReference GetEventType(		/*?*/EventDefinition moduleEvent)
		{
		...
		public int GetFieldSequenceNumber(FieldDefinition fieldDefinition)
		{
			uint fieldCount;
		...
		public ISectionBlock GetFieldMapping(FieldDefinition fieldDefinition)
		{
			...
			switch (this.PEFileReader.RVAToSubSectionName(rva)) {
				case ".text":
					sectionKind = PESectionKind.Text;
					break;
				case ".sdata":
					sectionKind = PESectionKind.StaticData;
					break;
				case ".tls":
					sectionKind = PESectionKind.ThreadLocalStorage;
					break;
				case ".rdata":
					sectionKind = PESectionKind.ConstantData;
					break;
				case ".cover":
					sectionKind = PESectionKind.CoverageData;
					break;
				case ".datax":
					sectionKind = PESectionKind.ExtendedData;
					break;
			}
		...
		public uint GetFieldSizeIfPossibleToDoSoWithoutResolving(ITypeReference typeReference)
		{
			...
			if (typeDefinition != null)
				return TypeHelper.SizeOfType(typeDefinition);
			return 0;
		}
		public void GetSemanticInfoForProperty(uint propertyRowId, out uint methodSemanticRowIdStart, out uint methodSemanticRowIdEnd)
		{
			ushort methodCount;
		...
		public void GetSemanticInfoForEvent(uint eventRowId, out uint methodSemanticRowIdStart, out uint methodSemanticRowIdEnd)
		{
			ushort methodCount;
			methodSemanticRowIdStart = this.PEFileReader.MethodSemanticsTable.FindSemanticMethodsForEvent(eventRowId, out methodCount);
			methodSemanticRowIdEnd = methodSemanticRowIdStart + methodCount;
		}
		public IMethodDefinition GetPropertyGetterOrSetterMethod(		/*?*/PropertyDefinition propertyDefinition, MethodSemanticsFlags getterOrSetterFlag)
		{
		...
		public IEnumerable<IMethodReference> GetPropertyAccessorMethods(PropertyDefinition propertyDefinition)
		{
			uint methodSemanticRowIdStart;
			uint methodSemanticRowIdEnd;
			this.GetSemanticInfoForProperty(propertyDefinition.PropertyRowId, out methodSemanticRowIdStart, out methodSemanticRowIdEnd);
		...
		public IMethodDefinition GetEventAddOrRemoveOrFireMethod(		/*?*/EventDefinition eventDefinition, MethodSemanticsFlags addOrRemoveOrFireFlag)
		{
			uint methodSemanticRowIdStart;
			uint methodSemanticRowIdEnd;
		...
		public IEnumerable<IMethodReference> GetEventAccessorMethods(EventDefinition eventDefinition)
		{
			uint methodSemanticRowIdStart;
			uint methodSemanticRowIdEnd;
			this.GetSemanticInfoForEvent(eventDefinition.EventRowId, out methodSemanticRowIdStart, out methodSemanticRowIdEnd);
		...
		public IMetadataConstant GetDefaultValue(MetadataObject metadataObject)
		{
		...
		public IMarshallingInformation GetMarshallingInformation(MetadataObject metadataObject)
		{
			...
			if (memoryReader.NotEndOfBytes) {
				if (unmanagedType == System.Runtime.InteropServices.UnmanagedType.ByValArray) {
					...
					if (marshaller == null)
						marshaller = Dummy.TypeReference;
					...
					if (memoryReader.NotEndOfBytes) {
						...
						if (flag == 0) {
							...
							paramIndex = -1;
							//paramIndex is just a place holder so that numElements can be present
						}
					}
					...
					if (subTypeRef == null)
						subTypeRef = Dummy.TypeReference;
		...
		public IPlatformInvokeInformation GetPlatformInvokeInformation(MethodDefinition methodDefinition)
		{
		...
		public IMethodBody GetMethodBody(MethodDefinition methodDefinition)
		{
		...
		public ITypeMemberReference GetModuleMemberReferenceAtRowWorker(		/*?*/MetadataObject owningObject, uint memberRefRowId)
		{
			...
			if (this.ModuleMemberReferenceArray[memberRefRowId] == null) {
				...
				switch (classTokenType) {
					case TokenTypeIds.TypeDef:
						parentTypeReference = this.ModuleReader.metadataReaderHost.Redirect(this.Module, this.GetTypeDefinitionAtRowWorker(classRowId));
						break;
					case TokenTypeIds.TypeRef:
						parentTypeReference = this.ModuleReader.metadataReaderHost.Redirect(this.Module, this.GetTypeRefReferenceAtRowWorker(classRowId));
						break;
					case TokenTypeIds.TypeSpec:
		...
		public ITypeMemberReference GetModuleMemberReferenceAtRow(		/*?*/MetadataObject owningObject, uint memberRefRowId)
		{
			if (memberRefRowId == 0 || memberRefRowId > this.PEFileReader.MemberRefTable.NumberOfRows) {
				return null;
			}
		...
		public MethodRefSignatureConverter GetMethodRefSignature(MethodReference moduleMethodReference)
		{
		...
		public int GetMethodRefParameterCount(MethodReference moduleMethodReference)
		{
			uint signatureBlobOffset = this.PEFileReader.MemberRefTable.GetSignature(moduleMethodReference.MemberRefRowId);
			//  TODO: error checking offset in range
			MemoryBlock signatureMemoryBlock = this.PEFileReader.BlobStream.GetMemoryBlockAt(signatureBlobOffset);
		...
		public int GetMethodRefGenericParameterCount(MethodReference moduleMethodReference)
		{
			uint signatureBlobOffset = this.PEFileReader.MemberRefTable.GetSignature(moduleMethodReference.MemberRefRowId);
			//  TODO: error checking offset in range
			MemoryBlock signatureMemoryBlock = this.PEFileReader.BlobStream.GetMemoryBlockAt(signatureBlobOffset);
		...
		public FieldSignatureConverter GetFieldRefSignature(FieldReference moduleFieldReference)
		{
		...
		public IMethodReference GetMethodSpecAtRow(		/*?*/MetadataObject owningObject, uint methodSpecRowId)
		{
			...
			if (methodSpecReference == null) {
				lock (GlobalLock.LockingObject) {
					...
					if (methodSpecReference == null) {
						...
						methodSpecReference = new GenericMethodInstanceReferenceWithToken(moduleMethod, methodSpecSigConv.GenericTypeArguments, this.InternFactory, methodSpecRowId | TokenTypeIds.MethodSpec);
		...
		//  Caller should lock this...
		public IMethodReference GetMethodReferenceForToken(MetadataObject owningObject, uint methodRefToken)
		{
		...
		//  Caller should lock this...
		public IFieldReference GetFieldReferenceForToken(MetadataObject owningObject, uint fieldRefToken)
		{
		...
		public ITypeReference GetTypeReferenceFromStandaloneSignatureToken(		/*?*/MethodDefinition owningObject, uint token)
		{
		...
		//  Caller must lock this...
		public object GetReferenceForToken(		/*?*/MetadataObject owningObject, uint token)
		{
			uint tokenKind = token & TokenTypeIds.TokenTypeMask;
			uint rowId = token & TokenTypeIds.RIDMask;
			switch (tokenKind) {
...
/*?*/				ICustomAttribute[] CustomAttributeArray;
		...
		public void GetCustomAttributeInfo(MetadataObject metadataObject, out uint customAttributeRowIdStart, out uint customAttributeRowIdEnd)
		{
			customAttributeRowIdStart = 0;
			customAttributeRowIdEnd = 0;
			if (metadataObject.TokenValue == 0xffffffffu)
				return;
		...
		public ICustomAttribute GetCustomAttributeAtRow(MetadataObject owningObject, uint token, uint customAttributeRowId)
		{
					...
					if (this.CustomAttributeArray[customAttributeRowId] == null) {
						...
						if (customAttribute.Parent == token || (customAttribute.Parent == 1 && token == TokenTypeIds.Assembly + 1)) {
							...
							if (customAttribute.Value == 0) {
								this.CustomAttributeArray[customAttributeRowId] = this.ModuleReader.metadataReaderHost.Rewrite(this.Module, new CustomAttribute(this, customAttributeRowId, moduleMethodReference, null, null));
							} else {
		...
		public IEnumerable<ICustomAttribute> GetModuleCustomAttributes()
		{
			uint customAttributeCount;
			uint customAttributeRowIdStart = this.PEFileReader.CustomAttributeTable.FindCustomAttributesForToken(TokenTypeIds.Module | (uint)0x1, out customAttributeCount);
		...
		public IEnumerable<ICustomAttribute> GetAssemblyCustomAttributes()
		{
			uint customAttributeCount;
			uint customAttributeRowIdStart = this.PEFileReader.CustomAttributeTable.FindCustomAttributesForToken(TokenTypeIds.Assembly | (uint)0x1, out customAttributeCount);
			uint customAttributeRowIdEnd = customAttributeRowIdStart + customAttributeCount;
			for (uint customAttributeIter = customAttributeRowIdStart; customAttributeIter < customAttributeRowIdEnd; ++customAttributeIter) {
				yield return this.GetCustomAttributeAtRow(this.Module, this.Module.TokenValue, customAttributeIter);
			}
		}
		public void GetSecurityAttributeInfo(MetadataObject metadataObject, out uint securityAttributeRowIdStart, out uint securityAttributeRowIdEnd)
		{
		...
		public ISecurityAttribute GetSecurityAttributeAtRow(MetadataObject owningObject, uint securityAttributeRowId)
		{
		...
		public IEnumerable<ICustomAttribute> GetSecurityAttributeData(SecurityAttribute securityAttribute)
		{
	...
	public abstract class SignatureConverter
	{
		public readonly PEFileToObjectModel PEFileToObjectModel;
		public readonly MetadataObject MetadataOwnerObject;
		public readonly TypeBase 		/*?*/ModuleGenericType;
		public readonly GenericMethod 		/*?*/ModuleGenericMethod;
		public readonly IMethodReference 		/*?*/ModuleMethodReference;
		public readonly ITypeMemberReference 		/*?*/ModuleMemberReference;
		public MemoryReader SignatureMemoryReader;
		//^ requires signatureMemoryReader.Length > 0;
		public SignatureConverter(PEFileToObjectModel peFileToObjectModel, MemoryReader signatureMemoryReader, MetadataObject metadataOwnerObject)
		{
		...
		public IEnumerable<ICustomModifier> GetCustomModifiers(		/*?*/out bool isPinned)
		{
			isPinned = false;
			...
			while (this.SignatureMemoryReader.NotEndOfBytes) {
				...
				if (tokenType == TokenTypeIds.TypeDef)
					typeRef = this.PEFileToObjectModel.GetTypeDefinitionAtRow(typeRID); else if (tokenType == TokenTypeIds.TypeRef)
		...
		public ITypeReference GetModuleGenericTypeInstanceReference(		/*?*/uint typeSpecToken)
		{
		...
		public ITypeReference Specialize(uint typeSpecToken, INamedTypeReference namedTypeReference, ref ushort genericArgumentCount, bool outer)
		{
			...
			if (nestedTypeReference != null) {
				...
				//the type reference comes from the metadata, which is always fully unspecialized
			...
			if (genericParametersCount == 0) {
				if (genericArgumentCount == 0 || !outer)
					return namedTypeReference;
		...
		public ManagedPointerType GetModuleManagedPointerType(		/*?*/uint typeSpecToken)
		{
		...
		public Matrix GetModuleMatrixType(		/*?*/uint typeSpecToken)
		{
		...
		public Vector GetModuleVectorType(		/*?*/uint typeSpecToken)
		{
		...
		public FunctionPointerType GetModuleFuntionPointer(		/*?*/uint typeSpecToken)
		{
		...
		public ITypeReference GetTypeReference()		/*?*/
		{
			...
			switch (headByte) {
				...
				case ElementType.ByReference:
					return this.GetModuleManagedPointerType(0xffffffffu);
				...
				case ElementType.Array:
					return this.GetModuleMatrixType(0xffffffffu);
				...
				case ElementType.GenericTypeInstance:
					return this.GetModuleGenericTypeInstanceReference(0xffffffffu);
				case ElementType.FunctionPointer:
					return this.GetModuleFuntionPointer(0xffffffffu);
		...
		{
			public readonly uint ParamRowId;
			public readonly uint ParamSequence;
			public readonly IName ParamName;
			public readonly ParamFlags ParamFlags;
			public ParamInfo(uint paramRowId, uint paramSequence, IName paramName, ParamFlags paramFlags)
			{
		...
		public virtual ParamInfo? GetParamInfo(int paramSequence)
		{
			return null;
		}

		public IParameterDefinition[] GetModuleParameters(bool useParamInfo, ISignature signatureDefinition, int paramCount)
		{
			...
			while (paramIndex < paramCount) {
				...
				if (currByte == ElementType.Sentinel) {
					...
					for (int i = 0; i < paramIndex; i++)
						requiredParameters[i] = parameters[i];
				...
				if (paramInfo.HasValue) {
					...
					moduleParameter = new ParameterWithMetadata(this.PEFileToObjectModel, paramIndex, customModifiers, typeReference, moduleMethod, isByReference, (paramIndex == paramCount - 1) && paramArrayType != null && paramArrayType.IsVector, paramInfo.Value.ParamRowId, paramInfo.Value.ParamName, paramInfo.Value.ParamFlags);
				} else
		...
		public IParameterTypeInformation[] GetModuleParameterTypeInformations(ISignature signature, int paramCount)
		{
			...
			for (var index = 0; index < paramCount; index++) {
				...
				if (currByte == ElementType.Sentinel) {
					this.SignatureMemoryReader.SkipBytes(1);
					if (index < paramCount)
						Array.Resize(ref parameterTypes, index);
					break;
				}
				bool isByReference = false;
				ITypeReference 				/*?*/typeReference;
	...
	public sealed class FieldSignatureConverter : SignatureConverter
	{

		public FieldSignatureConverter(PEFileToObjectModel peFileToObjectModel, MetadataObject moduleField, MemoryReader signatureMemoryReader) : base(peFileToObjectModel, signatureMemoryReader, moduleField)
		{
			//^ base;
		...
		public readonly IEnumerable<ICustomModifier> 		/*?*/customModifiers;
	}

	public sealed class PropertySignatureConverter : SignatureConverter
	{

		public PropertySignatureConverter(PEFileToObjectModel peFileToObjectModel, PropertyDefinition moduleProperty, MemoryReader signatureMemoryReader) : base(peFileToObjectModel, signatureMemoryReader, moduleProperty)
		{
			...
			if (paramCount > 0) {
				...
				if (moduleParamArr.Length > 0)
					this.parameters = IteratorHelper.GetReadonly(moduleParamArr);
			}
		}

		public readonly byte firstByte;
		public readonly IEnumerable<ICustomModifier> 		/*?*/returnCustomModifiers;
		public readonly bool returnValueIsByReference;
		public readonly ITypeReference 		/*?*/type;
		public readonly IEnumerable<IParameterDefinition> parameters;

	}

	public sealed class MethodDefSignatureConverter : SignatureConverter
	{
		public readonly byte FirstByte;
		...
		public readonly IParameterDefinition[] 		/*?*/Parameters;
		public readonly ReturnParameter ReturnParameter;
		readonly ParamInfo[] ParamInfoArray;

		public MethodDefSignatureConverter(PEFileToObjectModel peFileToObjectModel, MethodDefinition moduleMethod, MemoryReader signatureMemoryReader) : base(peFileToObjectModel, signatureMemoryReader, moduleMethod)
		{
			//  TODO: Check minimum required size of the signature...
			this.FirstByte = this.SignatureMemoryReader.ReadByte();
			...
			if (this.paramCount > 0) {
				...
				if (this.paramCount > 0)
					this.Parameters = moduleParamArr;
			}
		}
		public override ParamInfo? GetParamInfo(int paramSequence)
		{
	...
	public sealed class TypeSpecSignatureConverter : SignatureConverter
	{
		public readonly ITypeReference 		/*?*/TypeReference;
		//^ [NotDelayed]
		public TypeSpecSignatureConverter(PEFileToObjectModel peFileToObjectModel, TypeSpecReference moduleTypeSpecReference, MemoryReader signatureMemoryReader) : base(peFileToObjectModel, signatureMemoryReader, moduleTypeSpecReference.TypeSpecOwner)
		{
			//^ base;
			//^ this.SignatureMemoryReader = signatureMemoryReader; //TODO: Spec# bug. This assignment should not be necessary.
			byte firstByte = this.SignatureMemoryReader.ReadByte();
	...
	public sealed class MethodRefSignatureConverter : SignatureConverter
	{
		...
		public readonly IParameterTypeInformation[] 		/*?*/RequiredParameters;
		public readonly IParameterTypeInformation[] 		/*?*/VarArgParameters;

		public MethodRefSignatureConverter(PEFileToObjectModel peFileToObjectModel, MethodReference moduleMethodRef, MemoryReader signatureMemoryReader) : base(peFileToObjectModel, signatureMemoryReader, moduleMethodRef)
		{
			//  TODO: Check minimum required size of the signature...
			byte firstByte = this.SignatureMemoryReader.ReadByte();
			if (SignatureHeader.IsGeneric(firstByte)) {
	...
	public sealed class MethodSpecSignatureConverter : SignatureConverter
	{
		public readonly EnumerableArrayWrapper<ITypeReference, 		/*?*/ITypeReference> GenericTypeArguments;
		//^ [NotDelayed]
		public MethodSpecSignatureConverter(PEFileToObjectModel peFileToObjectModel, MetadataObject owningObject, MemoryReader signatureMemoryReader) : base(peFileToObjectModel, signatureMemoryReader, owningObject)
		{
